...
std::string FastWriter::write(const Value& root, bool noNewLine)
{
    document_ = "";
    writeValue(root);
    if (!noNewLine)
...
std::string StyledWriter::write(const Value& root, bool noNewLine)
{
    document_ = "";
...
void StyledStreamWriter::write(std::ostream& out, const Value& root, bool noNewLine)
{
    document_ = &out;
    addChildValues_ = false;
    indentString_ = "";
