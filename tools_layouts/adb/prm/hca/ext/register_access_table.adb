...
<node name="MRFV_CVB_ext" descr="" size="0x4.0" >
	<field name="cvb_data_index" descr="CVB Data\;Process Sigma = -4 + 0.5 * cvb_data_index\;cvb_data_index valid values 0 .. 15\;For ArcusE\;Process Sigma &lt;-&gt; DVDD (mV)\;-4.0: 856.00\;-3.5: 847.75\;-3.0: 839.50\;-2.5: 831.25\;-2.0: 823.00\;-1.5: 814.75\;-1.0: 806.50\;-0.5: 798.25\;0 (nominal): 790.00\;0.5: 781.75\;1.0: 773.50\;1.5: 765.25\;2.0: 757.00\;2.5: 748.75\;3.0: 740.50\;3.5: 732.25\;4.0: 724.00" access="RO" offset="0x0.0" size="0x0.5" />
</node>
...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2473, &quot;MRFV entry - CVB Layout,&quot; on page 2816\;See Table 2475, &quot;MRFV entry - ULT Layout,&quot; on page 2817\;See Table 2477, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 2818\;See Table 2479, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 2819\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2283, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2665" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2517, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2849\;Table 2519, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2849\;Table 2521, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2850\;Table 2523, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2850\;Table 2525, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2851\;Table 2527, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2851\;\;Table 2529, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2852" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 342, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 631 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2416, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2774" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcgi_ext" descr="" size="0x34.0" >
	...
	<field name="switch_tray_index" descr="Switch Tray Index\;Info provided from the chassis EEPROM (FRU) if exists. \;In Oberon, valid values 0-8" access="RO" offset="0x0.16" size="0x0.8" />
	<field name="cfiv" descr="Chassis Info Valid bit\;0: Info is not valid\;1: Info is valid" access="RO" offset="0x0.31" size="0x0.1" />
	<field name="chassis_rack_id" descr="Chassis Rack Id" access="RW" high_bound="3" low_bound="0" offset="0x10.0" size="0x10.0" />
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2416, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2774\;VERSION - See Table 2418, &quot;MCQI VERSION Info Layout,&quot; on page 2776\;ACTIVATION_METHOD - See Table 2422, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 2778\;LINKX_PROPERTIES - See Table 2424, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 2779\;CLOCK_SOURCE_PROPERTIES - See Table 2426, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 2781" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2420, &quot;Date-Time Layout,&quot; on page 2777" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2420, &quot;Date-Time Layout,&quot; on page 2777" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2440, &quot;Hardware Info Layout,&quot; on page 2793" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2443, &quot;Firmware Info Layout,&quot; on page 2796" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2445, &quot;Software Info Layout,&quot; on page 2799\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2449, &quot;Development Info Layout,&quot; on page 2803" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2442, &quot;Device HW Revision Descriptions,&quot; on page 2795" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2271, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2658" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2515, &quot;Configuration Item Header Layout,&quot; on page 2845)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2517, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2849\;Table 2519, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2849\;Table 2521, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2850\;Table 2523, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2850\;Table 2525, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2851\;Table 2527, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2851\;\;Table 2529, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2852" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_counter_set_auto_ext" descr="" attr_is_union="1" size="0xf8.0" >
	...
	<field name="pcie_physical_layer_ext" descr="" subnode="pcie_physical_layer_ext" offset="0x0.0" selected_by="PCIE_performance_counters" size="0x4.0" />
</node>
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 563, &quot;PCIe Performance Counters Data Layout,&quot; on page 864\;Table 569, &quot;PCIE Physical Layer Indication Layout,&quot; on page 870" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x20.0" >
	<field name="error_type" descr="Error type selector.\;See at Table 581, &quot;MPEINJ Error List and Params,&quot; on page 881 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table 581, &quot;MPEINJ Error List and Params,&quot; on page 881.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_params_0" descr="Error specific parameters according to Table 581, &quot;MPEINJ Error List and Params,&quot; on page 881." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table 581, &quot;MPEINJ Error List and Params,&quot; on page 881." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table 581, &quot;MPEINJ Error List and Params,&quot; on page 881." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table 581, &quot;MPEINJ Error List and Params,&quot; on page 881." access="RW" offset="0x1C.0" size="0x4.0" />
</node>
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 26.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1668\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1536, &quot;DPA_CAP Capability Layout,&quot; on page 1829" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="shared_headroom_pool" descr="Configuring shared haeadroom pool parameters. Using the same layout as in BufferX, for details see Table 2054, &quot;bufferX Register Layout,&quot; on page 2439.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit)." subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX, for details see Table 2054, &quot;bufferX Register Layout,&quot; on page 2439.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM." subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table 1805, &quot;PDDR - Phy manager link enabled IB layout,&quot; on page 2146\;For Ethernet: Table 1807, &quot;PDDR - Phy manager link enabled Eth layout,&quot; on page 2146\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table 1809, &quot;PDDR - core2phy link enabled IB layout,&quot; on page 2147\;For Ethernet: Table 1811, &quot;PDDR - Core2Phy link enabled Eth layout,&quot; on page 2148" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table 1813, &quot;PDDR - cable cap IB layout,&quot; on page 2149\;For Ethernet: Table 1815, &quot;PDDR - cable cap Eth layout,&quot; on page 2150\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table 1817, &quot;PDDR - Link Active IB layout,&quot; on page 2151\;For Ethernet: Table 1819, &quot;PDDR - Link Active Eth layout,&quot; on page 2151" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table 1803, &quot;Operation Info Page Layout,&quot; on page 2136\;Table 1839, &quot;Troubleshooting info Page layout,&quot; on page 2189\;Table 1837, &quot;Module Info Page Layout,&quot; on page 2176\;Table 1833, &quot;Link Down Info Page layout,&quot; on page 2170\;Table 1851, &quot;Module Latched Flag Info Page Layout,&quot; on page 2207\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table 1841, &quot;PDDR - Monitor opcodes layout,&quot; on page 2190" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table 1991, &quot;SNR Samples page - Layout,&quot; on page 2367" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pipg_reg_ext" descr="" size="0x8.0" >
	...
	<field name="ipg_oper" descr="Inter Packet Gap operational value in ipg_res_cap Bytes units.\;\;For example, in case of &apos;ipg_oper&apos; =3 and &apos;ipg_res_cap&apos;=0: 4 Bytes- the IPG operational size is 12 Bytes (3*4).\;\;If there is a miss-match between the operational IPG capabilities and the &apos;ipg&apos; field, &apos;ipg_oper&apos; will be 12 Bytes." access="RO" offset="0x0.2" size="0x0.8" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pmmp_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table 1655, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page 1983\;Table 1659, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page 1988" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table 1657, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page 1986" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1567, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page 1876\;Table 1569, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page 1881\;Table 1571, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page 1884\;Table 1573, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page 1889\;Table 1575, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page 1893\;Table 1578, &quot;Ethernet Discard Counter Group Fields,&quot; on page 1898\;Table 1579, &quot;Ethernet Per Priority Group Data Layout,&quot; on page 1900\;Table 1583, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page 1908\;Table 1595, &quot;Physical Layer Counters Data Layout,&quot; on page 1919\;Table 1585, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page 1909\;Table 1599, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page 1929\;Table 1591, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page 1913\;Table 1593, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page 1915\;Table 1601, &quot;PLR Counters Data Layout,&quot; on page 1934 \;Table 1603, &quot;RS-Histograms Data Layout,&quot; on page 1936\;Table 1605, &quot;InfiniBand Packets Counters Data Layout,&quot; on page 1937\;Table 1607, &quot;InfiniBand General Counters Data Layout,&quot; on page 1940" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1887, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 2267" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table 1633, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page 1969" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table 1627, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page 1965\;Table 1629, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page 1966" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qetcr_ext" descr="" size="0x50.0" >
	...
	<field name="tc_configuration" descr="Per-tclass configuration. For details, refer to Table 980, &quot;ETS tcN Configuration Register Layout&quot;." subnode="ets_ext" access="RW" high_bound="7" low_bound="0" offset="0x8.0" size="0x40.0" />
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 982, &quot;ETS Global Configuration Register Layout&quot;.\;Reserved for NICs" subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  976, &quot;qpdpm_dscp Layout,&quot; on page  1276" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 982, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 26.10, &quot;Resource Dump&quot;, on page 1706." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sbsr_ext" descr="" size="0xfc.0" >
	...
	<field name="shared_buffer_status" descr="Shared Buffer Properties, see Table 2176, &quot;Shared Buffer Status Fields,&quot; on page 2578\;This field is a collection of all the statuses of the requested quotas, while i=0..min{requested quotas, cap_sbsr_stat_size-1}\;The ith status refers a quota as follows;\;The occurrences of the masked ingress quotas are written before the masked egress quotas.\;All the occurrences associated to port are written together from the smallest masked port index. In each port, the occurrences of the masked priority groups/ traffic classes are written from the lowest to the highest." subnode="shared_buffer_status_ext" access="RO" high_bound="19" low_bound="0" offset="0x5C.0" size="0xa0.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table 1925, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for info page,&quot; on page 2311\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table 1927, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page 2313\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_all_lanes_5nm_ext" descr="" size="0x14.0" >
	<field name="fom_mode" descr="FOM type measurement\;0: SNR - nit scale of 1/256 dB.\;The SNR value represents the electrical signal-to-noise ratio on an optical lane, and is defined as the minimum of the three individual eye SNR values." access="OP" offset="0x0.0" size="0x0.4" />
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1739, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2090\;Table 1741, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 16nm,&quot; on page 2092\;Table 1743, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 7nm and 5nm,&quot; on page 2093\;Table 1751, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2097" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="slrg_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x24.0" >
	...
	<field name="slrg_7nm_ext" descr="" subnode="slrg_7nm_ext" condition="($(parent).port_type == Network_Port | $(parent).port_type == NearEnd_Port  | $(parent).port_type == FarEnd_Port) AND (($(parent).version == prod_7nm) || ($(parent).version == prod_5nm))" offset="0x0.0" size="0x18.0" />
...
<node name="sltp_5nm_ext" descr="" size="0x48.0" >
	...
	<field name="tap0" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x4.0" size="0x0.8" />
	<field name="tap1" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x4.8" size="0x0.8" />
	<field name="tap2" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x4.16" size="0x0.8" />
	<field name="tap3" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x4.24" size="0x0.8" />
	<field name="tap4" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x8.0" size="0x0.8" />
	<field name="tap5" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x8.8" size="0x0.8" />
	<field name="tap6" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x8.16" size="0x0.8" />
	<field name="tap7" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0x8.24" size="0x0.8" />
	<field name="tap8" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0xC.0" size="0x0.8" />
	<field name="tap9" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0xC.8" size="0x0.8" />
	<field name="tap10" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0xC.16" size="0x0.8" />
	<field name="tap11" descr="Signed value for TX FIR taps.\;tap scaling = fir_tap/63.\;For 200G per lane 12 taps. taps0-3 -&gt; pre; taps4 -&gt; main tap; \;taps5-11 -&gt; post\;\;Valid values for taps:\;main [32,63]\;pre [-8,8]\;post [-8,8]\;\;for 100G per lane 5 taps (tap0 (pre3), tap1(pre2), tap2(pre1), tap3(main), tap4(post1) )\;For 50G per lane 4 taps are used (no pre3)\;For 25G per lane 3 taps are used (no pre3,pre2)\;Valid values for taps:\;fir_main [34,63]\;fir_pre1 [-23,0]\;fir_pre2 [0,8]\;fir_pre3 [-5,0]\;fir_post1 [-21,0]\;\;Need to guarantee that the sum of the coefficient magnitude equals sum |c(i)| &lt;= 63. And Also:\;|tap0| + | tap1| &lt;8\;|tap6| + | tap7| + | tap8|&lt;8\;|tap9| + | tap10| + | tap11| &lt;8\;NRZ speeds must guarantee sum|c(i)| = 63\;Note: Configured taps may get effective value of +/-1 from the value that has been set." access="RW" offset="0xC.24" size="0x0.8" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table 1721, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page 2075\;Table 1723, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 16nm,&quot; on page 2076\;Table 1727, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 7nm,&quot; on page 2078\;Table 1731, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 5nm,&quot; on page 2083" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltp_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x48.0" >
	...
	<field name="sltp_5nm_ext" descr="" subnode="sltp_5nm_ext" condition="($(parent).port_type == Network_Port | $(parent).port_type == Internal_IC_LR_Port) AND ($(parent).version == prod_5nm)" offset="0x0.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table 1735, &quot;SLTPv2 - Serdes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page 2088" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>

<node name="sltpv2_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x108.0" >
	<field name="sltpv2_lut_5nm_ext" descr="" subnode="sltpv2_lut_5nm_ext" condition="($(parent).port_type == Network_Port | $(parent).port_type == Internal_IC_LR_Port) AND ($(parent).version == prod_5nm)" offset="0x0.0" size="0x108.0" />
</node>
