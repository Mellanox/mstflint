...
<node name="MRFV_CVB_ext" descr="" size="0x8.0" >
	...
	<field name="tav_cvb_voltage_msb" descr="[DWIP]\;MSB bits of the TAV voltage" access="RO" offset="0x0.26" size="0x0.4" />
	...
	<field name="voltage_type" descr="[DWIP]\;The voltage type of the cvb_voltage\;0: DVDD\;1: AVDD\;2: VDD" access="INDEX" offset="0x4.16" size="0x0.3" />
...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2947, &quot;MRFV entry - CVB Layout,&quot; on page 3286\;See Table 2949, &quot;MRFV entry - ULT Layout,&quot; on page 3288\;See Table 2951, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 3289\;See Table 2953, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 3290\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2731, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 3111" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="access_reg_summary_ext" descr="" attr_is_union="1" size="0x300" >
	...
	<field name="ptasv2_reg" descr="" subnode="ptasv2_reg_ext" capability="0" offset="0x0.0" selected_by="PTASv2" size="0x40" />
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 3021, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3336\;Table 3023, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3336\;Table 3025, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3337\;Table 3027, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3337\;Table 3029, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3338\;Table 3031, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3338\;\;Table 3033, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 3339\;Table 3035, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3340" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="eth_discard_cntrs_grp_ext" descr="" size="0xf8.0" >
	...
	<field name="ingress_no_tx_high" descr="[Draft] Number of packets dropped at ingress for lack of TX list.\;Triggered by DISCARD_LOOKUP_SWITCH or more specifically DISCARD_LOOKUP_SWITCH_UC, DISCARD_LOOKUP_SWITCH_MC_NULL or DISCARD_LOOKUP_SWITCH_NO_PORTS. See Section  2.8.3.12, &quot;Discard Extended Trap IDs,&quot; on page  594.\;Supported on switches only from Spectrum-4." access="RO" offset="0x80.0" size="0x4.0" />
	<field name="ingress_no_tx_low" descr="[Draft] Number of packets dropped at ingress for lack of TX list.\;Triggered by DISCARD_LOOKUP_SWITCH or more specifically DISCARD_LOOKUP_SWITCH_UC, DISCARD_LOOKUP_SWITCH_MC_NULL or DISCARD_LOOKUP_SWITCH_NO_PORTS. See Section  2.8.3.12, &quot;Discard Extended Trap IDs,&quot; on page  594.\;Supported on switches only from Spectrum-4." access="RO" offset="0x84.0" size="0x4.0" />
</node>
...
<node name="hst_link_nvlink_enabled_ext" descr="" size="0x4.0" >
	<field name="link_nvlink_active" descr="NVLink protocols active\;See: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2140" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 410, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 804 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 1092." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2882, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3238" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 1095." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_dpa_apps_info_ext" descr="" size="0x70.0" >
	...
	<field name="dpa_app_metadata" descr="DPA metadata, see Table 2896, &quot;MCQI DPA_APP_METADATA Layout,&quot; on page 3247" subnode="mcqi_dpa_metadata_ext" access="RO" offset="0x8.0" size="0x68.0" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2882, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3238\;VERSION - See Table 2884, &quot;MCQI VERSION Info Layout,&quot; on page 3240\;ACTIVATION_METHOD - See Table 2888, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 3242\;LINKX_PROPERTIES - See Table 2890, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 3243\;CLOCK_SOURCE_PROPERTIES - See Table 2892, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 3245\;DPA_APPS_INFO - See Table 2894, &quot;MCQI DPA_APPS_INFO Layout,&quot; on page 3246" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2886, &quot;Date-Time Layout,&quot; on page 3241" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2886, &quot;Date-Time Layout,&quot; on page 3241" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mdps_reg_ext" descr="" size="0x10.0" >
	...
	<field name="stressors_params" descr="Layout is according to stressor_type value:\;For over voltage seeTable 2991, &quot;Over Voltage Stressor Parameters Layout,&quot; on page 3315\;For under voltage seeTable 2993, &quot;Under Voltage Stressor Parameters Layout,&quot; on page 3315\;" subnode="mdps_reg_stressors_params_auto_ext" access="RW" offset="0x8.0" size="0x8.0" />
</node>
...
<node name="mdtr_reg_ext" descr="" size="0xb0.0" >
	...
	<field name="event_params" descr="event parameters - layout is according to event_id value:\;See Table 2987, &quot;Event_params cvb_config_error Layout,&quot; on page 3313" subnode="mdtr_reg_event_params_auto_ext" access="RW" offset="0x10.0" size="0xa0.0" union_selector="$(parent).event_id" />
</node>
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2910, &quot;Hardware Info Layout,&quot; on page 3260" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2913, &quot;Firmware Info Layout,&quot; on page 3263" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2915, &quot;Software Info Layout,&quot; on page 3266\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2919, &quot;Development Info Layout,&quot; on page 3270" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2912, &quot;Device HW Revision Descriptions,&quot; on page 3262" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  1095\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2719, &quot;JTAG Transaction Set Byte Layout,&quot; on page 3104" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 3019, &quot;Configuration Item Header Layout,&quot; on page 3332)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 3021, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3336\;Table 3023, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3336\;Table 3025, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3337\;Table 3027, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3337\;Table 3029, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3338\;Table 3031, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3338\;\;Table 3035, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3340" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 31, &quot;PCIe Performance Counters Data Layout,&quot; on page 371\;Table 37, &quot;PCIE Physical Layer Indication Layout,&quot; on page 378\;Table 39, &quot;PCIe Performance Counters 2 Data Layout,&quot; on page 379" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpegc_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="seg_valid" descr="when set the segment base is valid, when clear the segment base is invalid\;the value here will be reflected in the MPIR seg_valid\;reserved when pcie_segment is not set in MPCAM" access="RW" offset="0x8.24" size="0x0.1" />
...
<node name="mpeinj_reg_ext" descr="" size="0x40.0" >
	<field name="error_type" descr="Error type selector.\;See at Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="DPNv" descr="DPN version\;0: multi_topology_unaware_sw\;1: multi_topology_aware_sw" access="INDEX" enum="multi_topology_unaware_sw=0x0,multi_topology_aware_sw=0x1" offset="0x0.30" size="0x0.1" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_param3_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.16" size="0x0.4" />
	<field name="error_param2_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.20" size="0x0.4" />
	<field name="error_param1_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.24" size="0x0.4" />
	<field name="error_param0_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.28" size="0x0.4" />
	<field name="error_params_0" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  395." access="RW" offset="0x1C.0" size="0x4.0" />
...
<node name="mpir_ext" descr="" size="0x10.0" >
	...
	<field name="segment_base" descr="if segment valid is set this field has the segment number of the PCIe hierarchy of the link. \;seg_cap = 1 : segment base that was captured in Flit mode\;seg_cap = 0 : segment base that was set by software\;reserved when pcie_segment is not set in MPCAM" access="RO" offset="0x4.16" size="0x0.8" />
	<field name="seg_valid" descr="when set segment base is valid, else it is invalid\;must be set if seg_cap is set.\;reserved when pcie_segment is not set in MPCAM" access="RO" offset="0x4.24" size="0x0.1" />
	<field name="seg_cap" descr="segment number (base) was captured in Flit mode. \;reserved when pcie_segment is not set in MPCAM" access="RO" offset="0x4.25" size="0x0.1" />
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 29.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1926\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table  1802, &quot;DPA_CAP Capability Layout,&quot; on page  2100" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="buffer" descr="Configuring per-buffer parameters. i=0..9.\;See Table 2512, &quot;BufferX Register Layout,&quot; on page 2901" subnode="bufferx_reg_ext" access="RW" high_bound="9" low_bound="0" offset="0xC.0" size="0x50.0" />
	<field name="shared_headroom_pool" descr="Configuring shared headroom pool parameters. Using the same layout as in BufferX.\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit).\;See Table 2512, &quot;BufferX Register Layout,&quot; on page 2901" subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX.\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM.\;See Table 2512, &quot;BufferX Register Layout,&quot; on page 2901" subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>

<node name="pbsr_reg_ext" descr="" size="0x64.0" >
	<field name="buffer_type" descr="Valid only for 8x port setting (see Table 1940, &quot;PMLP - Ports Module to Local Port Register Fields,&quot; on page 2288)\;1: Main buffer\;2: Secondary buffer\;Reserved in Spectrum-5" access="INDEX" offset="0x0.0" size="0x0.2" />
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pddr_c2p_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="core_to_phy_link_nvlink_enabled" descr="NVLink protocols admin state\;see: Table  1841, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2141" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_cable_cap_nvlink_ext" descr="" size="0x4.0" >
	<field name="cable_nvlink_proto_cap" descr="Cable NVLink protocols cap:\;See: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2140" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  2119, &quot;PDDR - Phy Manager Link Enabled IB Layout,&quot; on page  2494\;For Ethernet: Table  2121, &quot;PDDR - Phy Manager Link Enabled Eth Layout,&quot; on page  2495\;For NVLink: Table  2123, &quot;PDDR - Phy Manager Link Enable NVLink Layout,&quot; on page  2495" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  2125, &quot;PDDR - Core2phy Link Enabled IB Layout,&quot; on page  2496\;For Ethernet: Table  2127, &quot;PDDR - Core2phy Link Enabled Eth Layout,&quot; on page  2497\;For NVLink: Table  2129, &quot;PDDR - Core2phy Link Enabled NVLink Layout,&quot; on page  2497" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="cable_proto_cap" descr="For IB: Table  2131, &quot;PDDR - Cable Cap IB Layout,&quot; on page  2498\;For Ethernet: Table  2133, &quot;PDDR - Cable Cap Eth Layout,&quot; on page  2499\;For NVLink: Table  2135, &quot;PDDR - Cable Cap NVLink Layout,&quot; on page  2499" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="link_active" descr="For IB: Table  2137, &quot;PDDR - Link Active IB Layout,&quot; on page  2500\;For Ethernet: Table  2139, &quot;PDDR - Link Active Eth Layout,&quot; on page  2500\;For NVLink: Table  2141, &quot;PDDR - Link Active NVLink Layout,&quot; on page  2501" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="pd_link_enabled" descr="For IB: Table  2143, &quot;PDDR - Parallel Detect Link Enabled IB Layout,&quot; on page  2502\;For Ethernet: Table  2145, &quot;PDDR - Parallel Detect Link Enabled Eth Layout,&quot; on page  2502" subnode="pddr_operation_info_page_pd_link_enabled_auto_ext" access="RO" offset="0x24.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="phy_hst_link_enabled" descr="For IB: Table  2147, &quot;PDDR - HST Link Enabled IB Layout,&quot; on page  2503\;For Ethernet: Table  2149, &quot;PDDR - HST Link Enabled Eth Layout,&quot; on page  2504\;For NVLink: Table  2151, &quot;PDDR - HST Link Enabled NVLink Layout,&quot; on page  2504" subnode="pddr_operation_info_page_phy_hst_link_enabled_auto_ext" access="RO" offset="0x28.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="eth_an_link_enabled" descr="Table  2153, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2505" access="RO" offset="0x2C.0" size="0x4.0" />
	<field name="test_mode_fsm_state" descr="Test mode FSM state exposure is supported only if PCAM.feature_cap_mask bit 120 is set.\;Mode B links test mode FSM\;0: Disable - this state is shared by Mode A links and Mode B links test mode FSM\;1: Open_lane\;2: Idle\;3: Close_lane\;- Mode A links test mode FSM\;4: Receiver_detect\;5: Idle_mode_a\;6: Signal_detect\;7: Auto_fix_reversal_polarity\;8: Tuning" access="RO" enum="Disable=0x0,Open_lane=0x1,Idle=0x2,Close_lane=0x3,Receiver_detect=0x4,Idle_mode_a=0x5,Signal_detect=0x6,Auto_fix_reversal_polarity=0x7,Tuning=0x8" offset="0x38.24" size="0x0.8" />
...
<node name="pddr_phy_manager_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="phy_manager_link_nvlink_enabled" descr="NVLink protocols admin state: \;see: Table  1841, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2141" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  2117, &quot;Operation Info Page Layout,&quot; on page  2484\;Table  2163, &quot;Troubleshooting info Page layout,&quot; on page  2545\;Table  2155, &quot;Phy Info Page Layout,&quot; on page  2506\;Table  2161, &quot;Module Info Page Layout,&quot; on page  2528\;Table  2157, &quot;Link Down Info Page Layout,&quot; on page  2522\;Table  2173, &quot;Link Up Info Page Layout,&quot; on page  2558\;Table  2175, &quot;Module Latched Flag Info Page Layout,&quot; on page  2562\;Table 2185, &quot;Link Partner Info Page Layout,&quot; on page 2580\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  2165, &quot;PDDR - Monitor opcodes layout,&quot; on page  2546" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table  2353, &quot;Module Status Samples Page- Layout,&quot; on page  2767\;Table  2355, &quot;SNR Samples page - Layout,&quot; on page  2769\;Table  2357, &quot;Laser Monitors Samples page - Layout,&quot; on page  2770\;Table  2361, &quot;Pre-FEC BER Samples Page - Layout,&quot; on page  2776\;Table  2367, &quot;Laser Source Module Essential Samples Page - Layout,&quot; on page  2779\;Table 2369, &quot;Laser Source Module Advanced Samples Page - Layout,&quot; on page 2781\;Table 2371, &quot;Optical Engine Debug Parameters Samples Page - Layout,&quot; on page 2784\;Table 2393, &quot;Laser Source Module Status Samples page - Layout,&quot; on page 2801\;Table  2373, &quot;Module Status Properties Page - Layout,&quot; on page  2788\;Table  2375, &quot;SNR Properties Page - Layout,&quot; on page  2791\;Table  2377, &quot;Laser Monitors Properties Page - Layout,&quot; on page  2792\;Table  2381, &quot;Pre-FEC BER Properties Page - Layout,&quot; on page  2795\;Table  2387, &quot;Laser Source Module Essential Properties page - Layout,&quot; on page  2798\;Table 2389, &quot;Laser Source Module Advanced Properties page - Layout,&quot; on page 2800\;Table 2391, &quot;Optical Engine Debug Parameters Properties page - Layout,&quot; on page 2801\;Table 2395, &quot;Laser Source Module Status Properties page - Layout,&quot; on page 2802" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="plcc_reg_ext" descr="" size="0x10.0" >
	...
	<field name="page_data" descr="Table  2481, &quot;High symbol error rate configuration Page Layout,&quot; on page  2865\;Table  2483, &quot;High bit error rate configuration Page Layout,&quot; on page  2865" subnode="plcc_reg_page_data_auto_ext" access="RW" offset="0x8.0" size="0x8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x40.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1957, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  2303\;Table  1961, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  2307" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1959, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  2306" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppbmp_reg_ext" descr="" size="0x30.0" >
	...
	<field name="monitor_parameters" descr="Table 2235, &quot;PPBMP - BER Monitor Parameters Layout,&quot; on page 2655" subnode="ppbmp_reg_monitor_parameters_auto_ext" access="RW" condition="$(parent).monitor_group" offset="0x4.0" size="0x8.0" />
	<field name="time_window" descr="The time frame which the events are grouped. \;This is a tumbling window (not a sliding window), means that each window is uncorrelated to the adjacent windows events. \;For BER features the time window derived from \;the lowest threshold.\;Units of sampling_rate.\;Value of zero is means the BER monitor is not active or time window is unknown\;\;time window is adjustable only for Estimated Effective BER, UCR monitors type, Tx_BW_loss and Total_recovery_time, Otherwise ignored.\;\;Note: changing the &apos;time_window&apos; field value for one port will affect all the device ports window." access="RW" offset="0xC.0" size="0x0.24" />
	...
	<field name="monitor_parameters_cap" descr="The configured Monitor Parameters shall be within the ranges defined by this field.\;The returned value is according to the monitor_group index and the device capabilities.\;See Table 2239, &quot;PPBMP - Monitor Parameters Capabilities Layout,&quot; on page 2658" subnode="ppbmp_monitor_params_cap_ext" access="RO" offset="0x14.0" size="0x4.0" />
</node>
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1849, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  2155\;Table  1851, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  2159\;Table  1853, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  2162\;Table  1855, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  2167\;Table  1857, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  2171\;Table  1860, &quot;Ethernet Discard Counter Group Fields,&quot; on page  2176\;Table  1861, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  2178\;Table  1865, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  2186\;Table  1877, &quot;Physical Layer Counters Data Layout,&quot; on page  2197\;Table  1867, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  2187\;Table  1881, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  2206\;Table  1873, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  2191\;Table  1875, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  2193\;Table  1883, &quot;PLR Counters Data Layout,&quot; on page  2212 \;Table  1885, &quot;RS-Histograms Data Layout,&quot; on page  2214\;Table  1889, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  2216\;Table  1891, &quot;InfiniBand General Counters Data Layout,&quot; on page  2219\;Table  1909, &quot;Physical Layer Recovery Counters Group Data Layout,&quot; on page  2251\;Table  1911, &quot;NVLink Reduction Counters Group Layout,&quot; on page  2255" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x5c.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table  2213, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page  2628" subnode="pphcr_bin_range_ext" access="RW" high_bound="18" low_bound="0" offset="0x10.0" size="0x4c.0" />
</node>
...
<node name="pplm_reg_ext" descr="" size="0x80.0" >
	...
	<field name="fec_page_data" descr="Table  2007, &quot;PPLM - NVL6 Rates FEC Override Layout,&quot; on page  2384" subnode="pplm_reg_fec_page_data_auto_ext" access="RW" offset="0x68.0" size="0x18.0" union_selector="$(parent).fec_generation" />
</node>
...
<node name="pprm_reg_ext" descr="" size="0x94.0" >
	...
	<field name="param_page_data" descr="recovery parameters for read / write functionality\;see Table  1933, &quot;PPRM phy recovery steps params,&quot; on page  2278" subnode="pprm_reg_param_page_data_auto_ext" access="RW" offset="0x2C.0" size="0x68.0" union_selector="$(parent).param_select" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1929, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  2271" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="ptasv2_7nm_ext" descr="" size="0x38.0" >
...
<node name="ptasv2_reg_ext" descr="" size="0x40.0" >
	...
	<field name="page_data" descr="Table  2075, &quot;PTASv2 - Phy Tuning Algorithm Settings Register Layout for 7nm and 5nm,&quot; on page  2448" subnode="ptasv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x8.0" size="0x38.0" />
</node>

<node name="ptasv2_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x38.0" >
	<field name="ptasv2_7nm_ext" descr="" subnode="ptasv2_7nm_ext" condition="($(parent).version == products_7nm) | ($(parent).version == products_5nm)" offset="0x0.0" size="0x38.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1923, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  2268\;Table  1925, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  2269" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="ptys_ext_proto_nvlink_admin_ext" descr="" size="0x4.0" >
	<field name="ext_proto_nvlink" descr="NVLink bitmask:\;Bit 0: 200G_1x (200G_1x_Simplex NVL5/6 XDR_1x) - Mode A\;Bit 1: 400G_2x (400G_2x_Simplex NVL5/6 XDR_2x) - Mode A\;Bit 2: 375G_2x (375G_2x_Bidi NVL6) - Mode B\;Bit 3: 337p5G_2x (337p5G_2x_Bidi NVL6) - Mode B\;Bit 4: 307p5G_2x (307p5G_2x_Bidi NVL6) - Mode B\;Bit 5: Reserved\;Bit 6: 200G_2x (200G_2x_Simplex XDR_2x_Slow) - Mode A" access="RW" offset="0x0.0" size="0x4.0" />
</node>

<node name="ptys_ext_proto_nvlink_cap_oper_ext" descr="" size="0x4.0" >
	<field name="ext_proto_nvlink" descr="NVLink bitmask:\;Bit 0: 200G_1x (200G_1x_Simplex NVL5/6 XDR_1x) - Mode A\;Bit 1: 400G_2x (400G_2x_Simplex NVL5/6 XDR_2x) - Mode A\;Bit 2: 375G_2x (375G_2x_Bidi NVL6) - Mode B\;Bit 3: 337p5G_2x (337p5G_2x_Bidi NVL6) - Mode B\;Bit 4: 307p5G_2x (307p5G_2x_Bidi NVL6) - Mode B\;Bit 5: Reserved\;Bit 6: 200G_2x (200G_2x_Simplex XDR_2x_Slow) - Mode A" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="ptys_reg_ext" descr="" size="0x44.0" >
	...
	<field name="ext_ib_proto_cap" descr="IB/NVlink port supported protocols and widths bit-mask.\;Valid if PCAM.feature_cap_mask bit 90 is set OR mask &lt;&gt;0.\;\;For IB: Table  1835, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2139\;For NVLink: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2140" subnode="ptys_reg_ext_ib_proto_cap_auto_ext" access="RO" offset="0x38.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_admin" descr="IB/NVLink port protocols admin values.\;\;For IB: Table  1837, &quot;PTYS - Extended Protocol IB - admin Layout,&quot; on page  2139\;For NVLink: Table  1841, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2141\;\;NOTE: This field and &quot;ib_proto_admin&quot;, &quot;ib_link_width_admin&quot; are mutual exclusive, meaning that only one of the field can be set on write command." subnode="ptys_reg_ext_ib_proto_admin_auto_ext" access="RW" offset="0x3C.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_oper" descr="IB/NVLink port operational protocol.\;For IB: Table  1835, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2139\;For NVLink: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2140" subnode="ptys_reg_ext_ib_proto_oper_auto_ext" access="RO" offset="0x40.0" size="0x4.0" union_selector="$(parent).proto_mask" />
</node>
...
<node name="qeec_ext" descr="" size="0x20.0" >
	...
	<field name="dwrr" descr="DWRR or strict priority on the link going down from the ETS element:\;0: strict priority\;1: DWRR\;Reserved for QM switches." access="RW" offset="0x18.15" size="0x0.1" />
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  1195, &quot;qpdpm_dscp Layout,&quot; on page  1546" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1201, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section  29.11, &quot;Resource Dump,&quot; on page  1971." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sllm_reg_ext" descr="" size="0x30.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2287, &quot;SLLM - SerDes Lane Link Maintenance Register Layout for 5nm and Serdes_gen_8,&quot; on page  2719" subnode="sllm_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x2c.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  2275, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2711\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  2277, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2713\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2053, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page  2431\;Section  2055, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page  2432\;Section  2057, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page  2434\;Section  2059, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page  2436\;Section  2067, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page  2440\;Section  2069, &quot;SLRG - SerDes Lane Receive Grade Register Layout for Serdes_gen_8,&quot; on page  2441\;Section  2071, &quot;SLRG Measurements Thresholds for 5nm- Layout,&quot; on page  2444" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).port_type AND $(parent).version AND $(parent).all_lanes AND $(parent).measurements_thresholds" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="slsir_reg_ext" descr="" size="0x94.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 2311, &quot;SLSIR - SerDes Lane Status Info Register Layout for 7nm,&quot; on page 2733\;Table 2313, &quot;SLSIR - SerDes Lane Status Info Register Layout for 5nm,&quot; on page 2738\;Table 2315, &quot;SLSIR - SerDes Lane Status Info Register Layout for Serdes_gen_8,&quot; on page 2740" subnode="slsir_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x90.0" union_selector="$(parent).version" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="conf_mod" descr="Set configuration mode for 7nm/5nm product.\;0: tx_linear - when set, tx taps are configured from\;for 7nm\;Table  2037, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2412\;For 5nm\;Table  2041, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2417\;LUT table fields are ignored\;1: tx_lut - when set, tx taps are configured from\;Table  2039, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2413\;7nm_fir_taps page fields are ignored." access="OP" enum="tx_linear=0x0,tx_lut=0x1" offset="0x0.12" size="0x0.1" />
	...
	<field name="page_data" descr="Table  2031, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2409\;Table  2033, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2410\;Table  2037, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2412\;Table  2039, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2413\;Table  2041, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2417\;Table  2043, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for Serdes_gen_8,&quot; on page  2420" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  2047, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2425\;Table  2049, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT Serdes_gen_8,&quot; on page  2427" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x108.0" />
</node>
