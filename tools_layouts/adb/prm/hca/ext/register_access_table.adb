...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2229, &quot;MRFV entry - PVS Layout,&quot; on page 2472\;See Table 2231, &quot;MRFV entry - ULT Layout,&quot; on page 2473\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2059, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2342" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="access_reg_summary_ext" descr="" attr_is_union="1" size="0x300" >
	...
	<field name="mcc_reg" descr="" subnode="mcc_reg_ext" capability="0" offset="0x0.0" selected_by="MCC" size="0x1c" />
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2267, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2502\;Table 2269, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2502\;Table 2271, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2503\;Table 2273, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2503\;Table 2275, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2504\;Table 2277, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2504\;\;Table 2279, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2505" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 366, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 617 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x1c.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 834." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2176, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2434" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcion_ext" descr="" size="0x10.0" >
	...
	<field name="module_inputs" descr="[DWIP][SwitchOnly]\;Module inputs: \;Bit 0: ResetL - low polarity\;Bit 1: LPMode\;Bit 2: Power Enable\;[DWIP] Bit 3: ModSel\;Reserved when module is controlled by FW" access="RW" offset="0xC.0" size="0x0.4" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 837." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2176, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2434\;VERSION - See Table 2178, &quot;MCQI VERSION Info Layout,&quot; on page 2436\;ACTIVATION_METHOD - See Table 2182, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 2438\;LINKX_PROPERTIES - See Table 2184, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 2439\;CLOCK_SOURCE_PROPERTIES - See Table 2186, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 2441" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2180, &quot;Date-Time Layout,&quot; on page 2437" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2180, &quot;Date-Time Layout,&quot; on page 2437" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2200, &quot;Hardware Info Layout,&quot; on page 2453" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2203, &quot;Firmware Info Layout,&quot; on page 2456" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2205, &quot;Software Info Layout,&quot; on page 2459\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2209, &quot;Development Info Layout,&quot; on page 2462" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2202, &quot;Device HW Revision Descriptions,&quot; on page 2455" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  837\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2047, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2335" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2265, &quot;Configuration Item Header Layout,&quot; on page 2498)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2267, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2502\;Table 2269, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2502\;Table 2271, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2503\;Table 2273, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2503\;Table 2275, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2504\;Table 2277, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2504\;\;Table 2279, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2505" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 20, &quot;PCIe Performance Counters Data Layout,&quot; on page 209" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x20.0" >
	<field name="error_type" descr="Error type selector.\;See at Table 38, &quot;MPEINJ error list and params,&quot; on page 226 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table 38, &quot;MPEINJ error list and params,&quot; on page 226.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_params_0" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 226." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 226." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 226." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 226." access="RW" offset="0x1C.0" size="0x4.0" />
</node>
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 24.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1396\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1326, &quot;DPA_CAP Capability Layout,&quot; on page 1526" access="RW" high_bound="27" low_bound="0" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="shared_headroom_pool" descr="Configuring shared haeadroom pool parameters. Using the same layout as in BufferX, for details see Table 1834, &quot;bufferX Register Layout,&quot; on page 2127.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit)." subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX, for details see Table 1834, &quot;bufferX Register Layout,&quot; on page 2127.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM." subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table 1597, &quot;PDDR - Phy manager link enabled IB layout,&quot; on page 1845\;For Ethernet: Table 1599, &quot;PDDR - Phy manager link enabled Eth layout,&quot; on page 1845\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table 1601, &quot;PDDR - core2phy link enabled IB layout,&quot; on page 1846\;For Ethernet: Table 1603, &quot;PDDR - Core2Phy link enabled Eth layout,&quot; on page 1847" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table 1605, &quot;PDDR - cable cap IB layout,&quot; on page 1848\;For Ethernet: Table 1607, &quot;PDDR - cable cap Eth layout,&quot; on page 1849\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table 1609, &quot;PDDR - Link Active IB layout,&quot; on page 1850\;For Ethernet: Table 1611, &quot;PDDR - Link Active Eth layout,&quot; on page 1850" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table 1595, &quot;Operation Info Page Layout,&quot; on page 1835\;Table 1631, &quot;Troubleshooting info Page layout,&quot; on page 1887\;Table 1629, &quot;Module Info Page Layout,&quot; on page 1874\;Table 1625, &quot;Link Down Info Page layout,&quot; on page 1869\;Table 1643, &quot;Module Latched Flag Info Page Layout,&quot; on page 1905\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table 1633, &quot;PDDR - Monitor opcodes layout,&quot; on page 1888" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table 1781, &quot;SNR Samples page - Layout,&quot; on page 2059" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pipg_reg_ext" descr="" size="0x8.0" >
	...
	<field name="all_lp" descr="Local Port global variable.\;Relevant only for SPC-1 and only for disable_1g_short_ipg field.\;0: local_port index\;1: all local ports" access="OP" offset="0x0.1" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pmmp_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table 1461, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page 1689\;Table 1465, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page 1694" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table 1463, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page 1692" access="RW" high_bound="2" low_bound="0" offset="0x14.0" size="0xc.0" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1357, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page 1573\;Table 1359, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page 1578\;Table 1361, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page 1581\;Table 1363, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page 1586\;Table 1365, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page 1590\;Table 1368, &quot;Ethernet Discard Counter Group Fields,&quot; on page 1595\;Table 1369, &quot;Ethernet Per Priority Group Data Layout,&quot; on page 1597\;Table 1373, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page 1605\;Table 1385, &quot;Physical Layer Counters Data Layout,&quot; on page 1616\;Table 1375, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page 1606\;Table 1389, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page 1626\;Table 1381, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page 1610\;Table 1383, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page 1612\;Table 1391, &quot;PLR Counters Data Layout,&quot; on page 1631 \;Table 1393, &quot;RS-Histograms Data Layout,&quot; on page 1633\;Table 1395, &quot;InfiniBand Packets Counters Data Layout,&quot; on page 1634\;Table 1397, &quot;InfiniBand General Counters Data Layout,&quot; on page 1636" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1677, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 1960" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table 1429, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page 1666" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table 1423, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page 1662\;Table 1425, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page 1663" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qetcr_ext" descr="" size="0x50.0" >
	...
	<field name="tc_configuration" descr="Per-tclass configuration. For details, refer to Table 970, &quot;ETS tcN Configuration Register Layout&quot;." subnode="ets_ext" access="RW" high_bound="7" low_bound="0" offset="0x8.0" size="0x40.0" />
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 972, &quot;ETS Global Configuration Register Layout&quot;.\;Reserved for NICs" subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  966, &quot;qpdpm_dscp Layout,&quot; on page  1171" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 972, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 24.10, &quot;Resource Dump&quot;, on page 1407." access="RW" offset="0x0.0" size="0x0.16" />
...
<node name="sbsr_ext" descr="" size="0xfc.0" >
	...
	<field name="shared_buffer_status" descr="Shared Buffer Properties, see Table 1952, &quot;Shared Buffer Status Fields,&quot; on page 2259\;This field is a collection of all the statuses of the requested quotas, while i=0..min{requested quotas, cap_sbsr_stat_size-1}\;The ith status refers a quota as follows;\;The occurrences of the masked ingress quotas are written before the masked egress quotas.\;All the occurrences associated to port are written together from the smallest masked port index. In each port, the occurrences of the masked priority groups/ traffic classes are written from the lowest to the highest." subnode="shared_buffer_status_ext" access="RO" high_bound="19" low_bound="0" offset="0x5C.0" size="0xa0.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table 1715, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for info page,&quot; on page 2003\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table 1717, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page 2005\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1543, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 1796\;Table 1545, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 16nm,&quot; on page 1797\;Table 1547, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 7nm and 5nm,&quot; on page 1799" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).version" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table 1527, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page 1782\;Table 1529, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 16nm,&quot; on page 1783\;Table 1533, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 7nm,&quot; on page 1785" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
