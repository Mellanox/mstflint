...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2504, &quot;MRFV entry - CVB Layout,&quot; on page 2798\;See Table 2506, &quot;MRFV entry - ULT Layout,&quot; on page 2799\;See Table 2508, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 2800\;See Table 2510, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 2801\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2312, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2643" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2550, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2834\;Table 2552, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2834\;Table 2554, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2835\;Table 2556, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2835\;Table 2558, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2836\;Table 2560, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2836\;\;Table 2562, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2837\;Table 2564, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 2838" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 344, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 624 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 882." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2447, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2755" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 885." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2447, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2755\;VERSION - See Table 2449, &quot;MCQI VERSION Info Layout,&quot; on page 2757\;ACTIVATION_METHOD - See Table 2453, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 2759\;LINKX_PROPERTIES - See Table 2455, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 2760\;CLOCK_SOURCE_PROPERTIES - See Table 2457, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 2762" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2451, &quot;Date-Time Layout,&quot; on page 2758" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2451, &quot;Date-Time Layout,&quot; on page 2758" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2471, &quot;Hardware Info Layout,&quot; on page 2775" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2474, &quot;Firmware Info Layout,&quot; on page 2778" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2476, &quot;Software Info Layout,&quot; on page 2781\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2480, &quot;Development Info Layout,&quot; on page 2785" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2473, &quot;Device HW Revision Descriptions,&quot; on page 2777" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  885\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2300, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2636" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2548, &quot;Configuration Item Header Layout,&quot; on page 2830)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2550, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2834\;Table 2552, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2834\;Table 2554, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2835\;Table 2556, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2835\;Table 2558, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2836\;Table 2560, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2836\;\;Table 2564, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 2838" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 568, &quot;PCIe Performance Counters Data Layout,&quot; on page 860\;Table 574, &quot;PCIE Physical Layer Indication Layout,&quot; on page 866" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x20.0" >
	<field name="error_type" descr="Error type selector.\;See at Table 586, &quot;MPEINJ Error List and Params,&quot; on page 877 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table 586, &quot;MPEINJ Error List and Params,&quot; on page 877.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_params_0" descr="Error specific parameters according to Table 586, &quot;MPEINJ Error List and Params,&quot; on page 877." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table 586, &quot;MPEINJ Error List and Params,&quot; on page 877." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table 586, &quot;MPEINJ Error List and Params,&quot; on page 877." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table 586, &quot;MPEINJ Error List and Params,&quot; on page 877." access="RW" offset="0x1C.0" size="0x4.0" />
</node>
...
<node name="mtmp_ext" descr="" size="0x20.0" >
	...
	<field name="i" descr="Used to query the internal diodes of the switch ASIC; for i=1, sensor_index is the index of the ASIC diode. Those sensors are not available externally and should only be used for debug." access="INDEX" offset="0x0.31" size="0x0.1" />
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 26.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1636\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="mvcr_ext" descr="" size="0x18.0" >
	<field name="sensor_index" descr="Sensors:\;- 0..max_system_sensors-1 are ambient sensors on the system (max_system_sensors from INI)\;\;255: Total Power Consumption" access="INDEX" offset="0x0.0" size="0x0.8" />
	<field name="slot_index" descr="Slot index\;0: Main board" access="INDEX" offset="0x0.16" size="0x0.4" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1558, &quot;DPA_CAP Capability Layout,&quot; on page 1801" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="shared_headroom_pool" descr="Configuring shared haeadroom pool parameters. Using the same layout as in BufferX, for details see Table 2075, &quot;bufferX Register Layout,&quot; on page 2415.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit)." subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX, for details see Table 2075, &quot;bufferX Register Layout,&quot; on page 2415.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM." subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>
...
<node name="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" descr="" attr_is_union="1" size="0x4.0" >
	<field name="pddr_c2p_link_enabled_ib_ext" descr="" subnode="pddr_c2p_link_enabled_ib_ext" offset="0x0.0" size="0x4.0" />
	<field name="pddr_c2p_link_enabled_eth_ext" descr="" subnode="pddr_c2p_link_enabled_eth_ext" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  1823, &quot;PDDR - Phy Manager Link Enabled IB layout,&quot; on page  2119\;For Ethernet: Table  1825, &quot;PDDR - Phy Manager Link Enabled Eth layout,&quot; on page  2119\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  1827, &quot;PDDR - Core2phy Link Enabled IB layout,&quot; on page  2120\;For Ethernet: Table  1829, &quot;PDDR - Core2phy Link Enabled Eth layout,&quot; on page  2121" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table  1831, &quot;PDDR - Cable Cap IB layout,&quot; on page  2122\;For Ethernet: Table  1833, &quot;PDDR - Cable Cap Eth layout,&quot; on page  2123\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table  1835, &quot;PDDR - Link Active IB layout,&quot; on page  2124\;For Ethernet: Table  1837, &quot;PDDR - Link Active Eth layout,&quot; on page  2124" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="eth_an_link_enabled" descr="For IB: Table  1847, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2127" access="RO" offset="0x2C.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" descr="" attr_is_union="1" size="0x4.0" >
	<field name="pddr_phy_manager_link_enabled_ib_ext" descr="" subnode="pddr_phy_manager_link_enabled_ib_ext" offset="0x0.0" size="0x4.0" />
	<field name="pddr_phy_manager_link_enabled_eth_ext" descr="" subnode="pddr_phy_manager_link_enabled_eth_ext" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  1821, &quot;Operation Info Page Layout,&quot; on page  2111\;Table  1857, &quot;Troubleshooting info Page layout,&quot; on page  2162\;Table  1849, &quot;Phy Info Page Layout,&quot; on page  2128\;Table  1855, &quot;Module Info Page Layout,&quot; on page  2149\;Table  1851, &quot;Link Down Info Page layout,&quot; on page  2143\;Table  1867, &quot;Link Up Info Page Layout,&quot; on page  2177\;Table  1869, &quot;Module Latched Flag Info Page Layout,&quot; on page  2180\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  1859, &quot;PDDR - Monitor opcodes layout,&quot; on page  2163" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table  2012, &quot;SNR Samples page - Layout,&quot; on page  2340" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1681, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  1959\;Table  1685, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  1964" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1683, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  1962" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="pmtm_reg_ext" descr="" size="0x10.0" >
	<field name="module" descr="module number" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="slot_index" descr="Reserved for HCA\;Slot_index \;Slot_index = 0 represent the onboard (motherboard). \;In case of non modular system only slot_index = 0 is available." access="INDEX" offset="0x0.24" size="0x0.4" />
	<field name="module_type" descr="module_type: \;0: Backplane_with_4_lanes\;1: QSFP\;2: SFP\;3: No_Cage\;4: Backplane_with_single_lane\;8: Backplane_with_two_lanes\;10: Chip2Chip4x\;11: Chip2Chip2x \;12: Chip2Chip1x\;14: QSFP_DD \;15: OSFP\;16: SFP_DD\;17: DSFP \;18: Chip2Chip8x\;19: Twisted_Pair\;20: Backplane_with_8_lanes\;21: Loopback" access="RW" enum="Backplane_with_4_lanes=0x0,QSFP=0x1,SFP=0x2,No_Cage=0x3,Backplane_with_single_lane=0x4,Backplane_with_two_lanes=0x8,Chip2Chip4x=0xa,Chip2Chip2x=0xb,Chip2Chip1x=0xc,QSFP_DD=0xe,OSFP=0xf,SFP_DD=0x10,DSFP=0x11,Chip2Chip8x=0x12,Twisted_Pair=0x13,Backplane_with_8_lanes=0x14,Loopback=0x15" offset="0x4.0" size="0x0.5" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1593, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  1849\;Table  1595, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  1854\;Table  1597, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  1857\;Table  1599, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  1862\;Table  1601, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  1866\;Table  1604, &quot;Ethernet Discard Counter Group Fields,&quot; on page  1871\;Table  1605, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  1873\;Table  1609, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  1881\;Table  1621, &quot;Physical Layer Counters Data Layout,&quot; on page  1892\;Table  1611, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  1882\;Table  1625, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  1902\;Table  1617, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  1886\;Table  1619, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  1888\;Table  1627, &quot;PLR Counters Data Layout,&quot; on page  1907 \;Table  1629, &quot;RS-Histograms Data Layout,&quot; on page  1909\;Table  1631, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  1910\;Table  1633, &quot;InfiniBand General Counters Data Layout,&quot; on page  1913" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1905, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 2241" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1659, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  1945" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1653, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  1941\;Table  1655, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  1942" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="ptys_ext_proto_ib_ext" descr="" size="0x4.0" >
...
<node name="ptys_reg_ext" descr="" size="0x44.0" >
	...
	<field name="ext_ib_proto_cap" descr="Valid if PCAM.feature_cap_mask bit 90 is set OR mask &lt;&gt;0\;Bitmask of supported extended IB/NVlink protocols and widths.\;Reserved for ETH.\;For IB: Table  1583, &quot;PTYS - Extended Protocol IB layout,&quot; on page  1836" subnode="ptys_reg_ext_ib_proto_cap_auto_ext" access="RO" offset="0x38.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_admin" descr="IB/NVLink port extended protocols bitmask\;NOTE: This field and &quot;ib_proto_admin&quot;, &quot;ib_link_width_admin&quot; are mutual exclusive, meaning that only one of the field can be set on write command.\;same mask as ext_ib_proto_cap\;For IB: Table  1583, &quot;PTYS - Extended Protocol IB layout,&quot; on page  1836" subnode="ptys_reg_ext_ib_proto_admin_auto_ext" access="RW" offset="0x3C.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_oper" descr="IB//NVLink port extended protocols operational bitmask.\;same mask as ext_ib_proto_cap\;For IB: Table  1583, &quot;PTYS - Extended Protocol IB layout,&quot; on page  1836" subnode="ptys_reg_ext_ib_proto_oper_auto_ext" access="RO" offset="0x40.0" size="0x4.0" union_selector="$(parent).proto_mask" />
</node>

<node name="ptys_reg_ext_ib_proto_admin_auto_ext" descr="" attr_is_union="1" size="0x4.0" >
	<field name="ptys_ext_proto_ib_ext" descr="" subnode="ptys_ext_proto_ib_ext" offset="0x0.0" selected_by="InfiniBand" size="0x4.0" />
</node>
...
<node name="qetcr_ext" descr="" size="0x50.0" >
	...
	<field name="tc_configuration" descr="Per-tclass configuration. For details, refer to Table 993, &quot;ETS tcN Configuration Register Layout&quot;." subnode="ets_ext" access="RW" high_bound="7" low_bound="0" offset="0x8.0" size="0x40.0" />
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 995, &quot;ETS Global Configuration Register Layout&quot;.\;Reserved for NICs" subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  989, &quot;qpdpm_dscp Layout,&quot; on page  1278" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 995, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 26.11, &quot;Resource Dump&quot;, on page 1677." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  1946, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2287\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  1948, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2288\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1765, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2069\;Table 1767, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page 2071\;Table 1769, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page 2073\;Table 1771, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page 2074\;Table 1779, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2078" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table  1747, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2053\;Table  1749, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2054\;Table  1753, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2056\;Table  1757, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2061" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  1761, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2066" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>
