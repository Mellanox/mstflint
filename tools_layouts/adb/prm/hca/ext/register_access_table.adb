...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2992, &quot;MRFV entry - CVB Layout,&quot; on page 3416\;See Table 2994, &quot;MRFV entry - ULT Layout,&quot; on page 3418\;See Table 2996, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 3419\;See Table 2998, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 3420\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2774, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 3239" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="access_reg_summary_ext" descr="" attr_is_union="1" size="0x300" >
	...
	<field name="pfldc_reg" descr="" subnode="pfldc_reg_ext" capability="0" offset="0x0.0" selected_by="PFLDC" size="0xc" />
...
<node name="bufferx_lossy_thresholds_ext" descr="" size="0x4.0" >
	<field name="drop_over_max" descr="[Switch Only]\;Additional buffer, in cells, that is temporarily allowed above the configured buffer threshold for a lossy buffer. \;The value 0 means drop threshold at headroom.\;Default value: 100KB in cells.\;Reserved on Write when drop_over_max_margin_mask=0. Always valid on Query for lossy buffers.\;size - drop_over_max should not exceed cap_max_headroom_size." access="RW" offset="0x0.0" size="0x0.16" />
</node>
...
<node name="bufferx_reg_ext" descr="" size="0x8.0" >
	...
	<field name="thresholds" descr="For lossless (lossy=0) see Table 2547, &quot;BufferX Lossless Thresholds Layout,&quot; on page 2972.\;[DWIP] For lossy (lossy=1) see Table 2549, &quot;BufferX Lossy Thresholds Layout,&quot; on page 2973" subnode="bufferx_reg_thresholds_auto_ext" access="RW" offset="0x4.00" size="0x4.0" union_selector="$(parent).lossy" />
</node>
...
<node name="bufferx_reg_thresholds_auto_ext" descr="" attr_is_union="1" size="0x4.0" >
	...
	<field name="bufferx_lossy_thresholds_ext" descr="" subnode="bufferx_lossy_thresholds_ext" offset="0x0.0" selected_by="Lossy" size="0x4.0" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 3066, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3466\;Table 3068, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3466\;Table 3070, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3467\;Table 3072, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3467\;Table 3074, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3468\;Table 3076, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3468\;\;Table 3078, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 3469\;Table 3080, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3470" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="eth_discard_cntrs_grp_ext" descr="" size="0xf8.0" >
	...
	<field name="ingress_no_tx_high" descr="[Draft] Number of packets dropped at ingress for lack of TX list.\;Triggered by DISCARD_LOOKUP_SWITCH or more specifically DISCARD_LOOKUP_SWITCH_UC, DISCARD_LOOKUP_SWITCH_MC_NULL or DISCARD_LOOKUP_SWITCH_NO_PORTS. See Section  2.8.3.12, &quot;Discard Extended Trap IDs,&quot; on page  607.\;Supported on switches only from Spectrum-4." access="RO" offset="0x80.0" size="0x4.0" />
	<field name="ingress_no_tx_low" descr="[Draft] Number of packets dropped at ingress for lack of TX list.\;Triggered by DISCARD_LOOKUP_SWITCH or more specifically DISCARD_LOOKUP_SWITCH_UC, DISCARD_LOOKUP_SWITCH_MC_NULL or DISCARD_LOOKUP_SWITCH_NO_PORTS. See Section  2.8.3.12, &quot;Discard Extended Trap IDs,&quot; on page  607.\;Supported on switches only from Spectrum-4." access="RO" offset="0x84.0" size="0x4.0" />
</node>
...
<node name="hst_link_nvlink_enabled_ext" descr="" size="0x4.0" >
	<field name="link_nvlink_active" descr="NVLink protocols active\;See: Table  1864, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2187" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 414, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 811 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 1093." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2927, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3368" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 1096." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_dpa_apps_info_ext" descr="" size="0x70.0" >
	...
	<field name="dpa_app_metadata" descr="DPA metadata, see Table 2941, &quot;MCQI DPA_APP_METADATA Layout,&quot; on page 3377" subnode="mcqi_dpa_metadata_ext" access="RO" offset="0x8.0" size="0x68.0" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2927, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3368\;VERSION - See Table 2929, &quot;MCQI VERSION Info Layout,&quot; on page 3370\;ACTIVATION_METHOD - See Table 2933, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 3372\;LINKX_PROPERTIES - See Table 2935, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 3373\;CLOCK_SOURCE_PROPERTIES - See Table 2937, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 3375\;DPA_APPS_INFO - See Table 2939, &quot;MCQI DPA_APPS_INFO Layout,&quot; on page 3376" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2931, &quot;Date-Time Layout,&quot; on page 3371" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2931, &quot;Date-Time Layout,&quot; on page 3371" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mcqs_reg_ext" descr="" size="0x10.0" >
	...
	<field name="identifier" descr="This field uniquely identifies a specific component type. \;0x1: BOOT_IMG\;0x4: OEM_NVCONFIG\;0x5: MLNX_NVCONFIG\;0x6: CS_TOKEN\;0x7: DBG_TOKEN\;0xA: Gearbox\;0xB: CC_ALGO - Congestion Control Algorithm\;0xC: LINKX_IMG\;0xD: CRYPTO_TO_COMMISSIONING\;0xE: RMCS_TOKEN\;0xF: RMDT_TOKEN\;0x10: CRCS_TOKEN \;0x11: CRDT_TOKEN \;0x12: CLOCK_SYNC_EEPROM  \;0x15: DIGITAL_CACERT - Certificate to be trusted by the device0x17: DIGITAL_CACERT_REMOVAL\;\;Other values are reserved\;[DWIP]: 0x1A: LINKX_FW_ELS\;\;0x1C: DPA_COMPONENT\;0x1D: DPA_COMPONENT_REMOVAL\;\;0x1E: MTDT_TOKEN\;\;0x20: PSC_TOKEN" access="RO" enum="BOOT_IMG=0x1,OEM_NVCONFIG=0x4,MLNX_NVCONFIG=0x5,CS_TOKEN=0x6,DBG_TOKEN=0x7,Gearbox=0xa,CC_ALGO=0xb,LINKX_IMG=0xc,CRYPTO_TO_COMMISSIONING=0xd,RMCS_TOKEN=0xe,RMDT_TOKEN=0xf,CRCS_TOKEN=0x10,CRDT_TOKEN=0x11,CLOCK_SYNC_EEPROM=0x12,DIGITAL_CACERT=0x15,DPA_COMPONENT=0x1c,DPA_COMPONENT_REMOVAL=0x1d,MTDT_TOKEN=0x1e,PSC_TOKEN=0x20" offset="0x4.0" size="0x0.16" />
	<field name="component_update_state" descr="Component state in update flow, see Section  10.2.1, &quot;Component Update State,&quot; on page  1093:\;0x0: IDLE\;0x1: IN_PROGRESS\;0x2: APPLIED\;0x3: ACTIVE \;0x4: ACTIVE_PENDING_RESET\;0x5: FAILED\;0x6: CANCELED\;0x7: BUSY\;\;Other values are reserved" access="RO" enum="IDLE=0x0,IN_PROGRESS=0x1,APPLIED=0x2,ACTIVE=0x3,ACTIVE_PENDING_RESET=0x4,FAILED=0x5,CANCELED=0x6,BUSY=0x7" offset="0x8.0" size="0x0.4" />
...
<node name="mdps_reg_ext" descr="" size="0x10.0" >
	...
	<field name="stressors_params" descr="Layout is according to stressor_type value:\;For over voltage seeTable 3036, &quot;Over Voltage Stressor Parameters Layout,&quot; on page 3445\;For under voltage seeTable 3038, &quot;Under Voltage Stressor Parameters Layout,&quot; on page 3445\;" subnode="mdps_reg_stressors_params_auto_ext" access="RW" offset="0x8.0" size="0x8.0" />
</node>
...
<node name="mdsr_reg_ext" descr="" size="0x30.0" >
	...
	<field name="type_of_token" descr="0: CS token \;1: Debug FW token \;2: FRC token \;3: RMCS token\;4: RMDT token \;5: CRCS token \;6: CRDT token\;\;8: MTFA token" access="INDEX" offset="0x0.24" size="0x0.8" />
...
<node name="mdtr_reg_ext" descr="" size="0xb0.0" >
	...
	<field name="event_params" descr="event parameters - layout is according to event_id value:\;See Table 3032, &quot;Event_params cvb_config_error Layout,&quot; on page 3443" subnode="mdtr_reg_event_params_auto_ext" access="RW" offset="0x10.0" size="0xa0.0" union_selector="$(parent).event_id" />
</node>
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2955, &quot;Hardware Info Layout,&quot; on page 3390" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2958, &quot;Firmware Info Layout,&quot; on page 3393" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2960, &quot;Software Info Layout,&quot; on page 3396\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2964, &quot;Development Info Layout,&quot; on page 3400" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2957, &quot;Device HW Revision Descriptions,&quot; on page 3392" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  1096\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2762, &quot;JTAG Transaction Set Byte Layout,&quot; on page 3232" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 3064, &quot;Configuration Item Header Layout,&quot; on page 3462)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 3066, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3466\;Table 3068, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3466\;Table 3070, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3467\;Table 3072, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3467\;Table 3074, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3468\;Table 3076, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3468\;\;Table 3080, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3470" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 31, &quot;PCIe Performance Counters Data Layout,&quot; on page 376\;Table 37, &quot;PCIE Physical Layer Indication Layout,&quot; on page 383\;Table 39, &quot;PCIe Performance Counters 2 Data Layout,&quot; on page 384" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x40.0" >
	<field name="error_type" descr="Error type selector.\;See at Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="DPNv" descr="DPN version\;0: multi_topology_unaware_sw\;1: multi_topology_aware_sw" access="INDEX" enum="multi_topology_unaware_sw=0x0,multi_topology_aware_sw=0x1" offset="0x0.30" size="0x0.1" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_param3_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.16" size="0x0.4" />
	<field name="error_param2_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.20" size="0x0.4" />
	<field name="error_param1_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.24" size="0x0.4" />
	<field name="error_param0_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.28" size="0x0.4" />
	<field name="error_params_0" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  400." access="RW" offset="0x1C.0" size="0x4.0" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table  1827, &quot;DPA_CAP Capability Layout,&quot; on page  2148" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="buffer" descr="Configuring per-buffer parameters. i=0..9.\;See Table 2545, &quot;BufferX Register Layout,&quot; on page 2971" subnode="bufferx_reg_ext" access="RW" high_bound="9" low_bound="0" offset="0xC.0" size="0x50.0" />
	<field name="shared_headroom_pool" descr="Configuring shared headroom pool parameters. Using the same layout as in BufferX.\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit).\;See Table 2545, &quot;BufferX Register Layout,&quot; on page 2971" subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX.\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM.\;See Table 2545, &quot;BufferX Register Layout,&quot; on page 2971" subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>

<node name="pbsr_reg_ext" descr="" size="0x64.0" >
	<field name="buffer_type" descr="Valid only for 8x port setting (see Table 1969, &quot;PMLP - Ports Module to Local Port Register Fields,&quot; on page 2344)\;1: Main buffer\;2: Secondary buffer\;Reserved in Spectrum-5" access="INDEX" offset="0x0.0" size="0x0.2" />
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pddr_c2p_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="core_to_phy_link_nvlink_enabled" descr="NVLink protocols admin state\;see: Table  1866, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2188" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_cable_cap_nvlink_ext" descr="" size="0x4.0" >
	<field name="cable_nvlink_proto_cap" descr="Cable NVLink protocols cap:\;See: Table  1864, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2187" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  2148, &quot;PDDR - Phy Manager Link Enabled IB Layout,&quot; on page  2550\;For Ethernet: Table  2150, &quot;PDDR - Phy Manager Link Enabled Eth Layout,&quot; on page  2550\;For NVLink: Table  2152, &quot;PDDR - Phy Manager Link Enable NVLink Layout,&quot; on page  2551" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  2154, &quot;PDDR - Core2phy Link Enabled IB Layout,&quot; on page  2552\;For Ethernet: Table  2156, &quot;PDDR - Core2phy Link Enabled Eth Layout,&quot; on page  2553\;For NVLink: Table  2158, &quot;PDDR - Core2phy Link Enabled NVLink Layout,&quot; on page  2553" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="cable_proto_cap" descr="For IB: Table  2160, &quot;PDDR - Cable Cap IB Layout,&quot; on page  2554\;For Ethernet: Table  2162, &quot;PDDR - Cable Cap Eth Layout,&quot; on page  2555\;For NVLink: Table  2164, &quot;PDDR - Cable Cap NVLink Layout,&quot; on page  2555" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="link_active" descr="For IB: Table  2166, &quot;PDDR - Link Active IB Layout,&quot; on page  2556\;For Ethernet: Table  2168, &quot;PDDR - Link Active Eth Layout,&quot; on page  2556\;For NVLink: Table  2170, &quot;PDDR - Link Active NVLink Layout,&quot; on page  2557" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="pd_link_enabled" descr="For IB: Table  2172, &quot;PDDR - Parallel Detect Link Enabled IB Layout,&quot; on page  2558\;For Ethernet: Table  2174, &quot;PDDR - Parallel Detect Link Enabled Eth Layout,&quot; on page  2558" subnode="pddr_operation_info_page_pd_link_enabled_auto_ext" access="RO" offset="0x24.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="phy_hst_link_enabled" descr="For IB: Table  2176, &quot;PDDR - HST Link Enabled IB Layout,&quot; on page  2559\;For Ethernet: Table  2178, &quot;PDDR - HST Link Enabled Eth Layout,&quot; on page  2560\;For NVLink: Table  2180, &quot;PDDR - HST Link Enabled NVLink Layout,&quot; on page  2560" subnode="pddr_operation_info_page_phy_hst_link_enabled_auto_ext" access="RO" offset="0x28.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="eth_an_link_enabled" descr="Table  2182, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2561" access="RO" offset="0x2C.0" size="0x4.0" />
...
<node name="pddr_phy_manager_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="phy_manager_link_nvlink_enabled" descr="NVLink protocols admin state: \;see: Table  1866, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2188" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  2146, &quot;Operation Info Page Layout,&quot; on page  2540\;Table  2192, &quot;Troubleshooting info Page layout,&quot; on page  2606\;Table  2184, &quot;Phy Info Page Layout,&quot; on page  2562\;Table  2190, &quot;Module Info Page Layout,&quot; on page  2589\;Table  2186, &quot;Link Down Info Page Layout,&quot; on page  2582\;Table  2202, &quot;Link Up Info Page Layout,&quot; on page  2619\;Table  2204, &quot;Module Latched Flag Info Page Layout,&quot; on page  2623\;Table 2214, &quot;Link Partner Info Page Layout,&quot; on page 2641\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  2194, &quot;PDDR - Monitor opcodes layout,&quot; on page  2607" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table  2384, &quot;Module Status Samples Page- Layout,&quot; on page  2832\;Table  2386, &quot;SNR Samples page - Layout,&quot; on page  2835\;Table  2388, &quot;Laser Monitors Samples page - Layout,&quot; on page  2836\;Table  2392, &quot;Pre-FEC BER Samples Page - Layout,&quot; on page  2841\;Table  2398, &quot;Laser Source Module Essential Samples Page - Layout,&quot; on page  2844\;Table 2400, &quot;Laser Source Module Advanced Samples Page - Layout,&quot; on page 2847\;Table 2402, &quot;Optical Engine Debug Parameters Samples Page - Layout,&quot; on page 2849\;Table 2424, &quot;Laser Source Module Status Samples page - Layout,&quot; on page 2866\;Table  2404, &quot;Module Status Properties Page - Layout,&quot; on page  2854\;Table  2406, &quot;SNR Properties Page - Layout,&quot; on page  2856\;Table  2408, &quot;Laser Monitors Properties Page - Layout,&quot; on page  2857\;Table  2412, &quot;Pre-FEC BER Properties Page - Layout,&quot; on page  2860\;Table  2418, &quot;Laser Source Module Essential Properties page - Layout,&quot; on page  2863\;Table 2420, &quot;Laser Source Module Advanced Properties page - Layout,&quot; on page 2865\;Table 2422, &quot;Optical Engine Debug Parameters Properties page - Layout,&quot; on page 2866\;Table 2426, &quot;Laser Source Module Status Properties page - Layout,&quot; on page 2867" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pfldc_reg_ext" descr="" size="0xc.0" >
	<field name="plane_ind" descr="Reserved for non-planarized port.\;Plane port index of the aggregated port. A value of 0 refers to the aggregated port only." access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="pnat" descr="Port number access type. determines the way local_port is interpreted:\;0: Local_port_number\;1: IB_port_number\;3: Out_of_band_or_PCI" access="INDEX" enum="Local_port_number=0x0,IB_port_number=0x1,Out_of_band_or_PCI=0x3" offset="0x0.14" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="plcc_reg_ext" descr="" size="0x10.0" >
	...
	<field name="page_data" descr="Table  2512, &quot;High symbol error rate configuration Page Layout,&quot; on page  2929\;Table  2514, &quot;High bit error rate configuration Page Layout,&quot; on page  2929" subnode="plcc_reg_page_data_auto_ext" access="RW" offset="0x8.0" size="0x8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x40.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1986, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  2359\;Table  1990, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  2363" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1988, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  2362" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppbmp_reg_ext" descr="" size="0x30.0" >
	...
	<field name="monitor_parameters" descr="Table 2264, &quot;PPBMP - BER Monitor Parameters Layout,&quot; on page 2717" subnode="ppbmp_reg_monitor_parameters_auto_ext" access="RW" condition="$(parent).monitor_group" offset="0x4.0" size="0x8.0" />
	...
	<field name="monitor_parameters_cap" descr="The configured Monitor Parameters shall be within the ranges defined by this field.\;The returned value is according to the monitor_group index and the device capabilities.\;See Table 2268, &quot;PPBMP - Monitor Parameters Capabilities Layout,&quot; on page 2720" subnode="ppbmp_monitor_params_cap_ext" access="RO" offset="0x14.0" size="0x4.0" />
</node>
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1874, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  2202\;Table  1876, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  2206\;Table  1878, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  2209\;Table  1880, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  2214\;Table  1882, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  2218\;Table  1885, &quot;Ethernet Discard Counter Group Fields,&quot; on page  2223\;Table  1886, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  2225\;Table  1890, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  2233\;Table  1902, &quot;Physical Layer Counters Data Layout,&quot; on page  2244\;Table  1892, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  2234\;Table  1906, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  2253\;Table  1898, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  2238\;Table  1900, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  2240\;Table  1908, &quot;PLR Counters Data Layout,&quot; on page  2259 \;Table  1910, &quot;RS-Histograms Data Layout,&quot; on page  2262\;Table  1914, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  2264\;Table  1916, &quot;InfiniBand General Counters Data Layout,&quot; on page  2267\;Table  1934, &quot;Physical Layer Recovery Counters Group Data Layout,&quot; on page  2299\;Table  1936, &quot;NVLink Reduction Counters Group Layout,&quot; on page  2303" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x5c.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table  2242, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page  2689" subnode="pphcr_bin_range_ext" access="RW" high_bound="18" low_bound="0" offset="0x10.0" size="0x4c.0" />
</node>
...
<node name="pplm_reg_ext" descr="" size="0x80.0" >
	...
	<field name="fec_page_data" descr="Table  2036, &quot;PPLM - NVL6 Rates FEC Override Layout,&quot; on page  2439" subnode="pplm_reg_fec_page_data_auto_ext" access="RW" offset="0x68.0" size="0x18.0" union_selector="$(parent).fec_generation" />
</node>
...
<node name="pprm_reg_ext" descr="" size="0x94.0" >
	...
	<field name="param_page_data" descr="recovery parameters for read / write functionality\;see Table  1962, &quot;PPRM phy recovery steps params,&quot; on page  2334" subnode="pprm_reg_param_page_data_auto_ext" access="RW" offset="0x2C.0" size="0x68.0" union_selector="$(parent).param_select" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1958, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  2327" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="ptasv2_reg_ext" descr="" size="0x40.0" >
	...
	<field name="page_data" descr="Table  2104, &quot;PTASv2 - Phy Tuning Algorithm Settings Register Layout for 7nm and 5nm,&quot; on page  2504" subnode="ptasv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x8.0" size="0x38.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1952, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  2324\;Table  1954, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  2325" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="ptys_reg_ext" descr="" size="0x44.0" >
	...
	<field name="ext_ib_proto_cap" descr="IB/NVlink port supported protocols and widths bit-mask.\;Valid if PCAM.feature_cap_mask bit 90 is set OR mask &lt;&gt;0.\;\;For IB: Table  1860, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2186\;For NVLink: Table  1864, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2187" subnode="ptys_reg_ext_ib_proto_cap_auto_ext" access="RO" offset="0x38.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_admin" descr="IB/NVLink port protocols admin values.\;\;For IB: Table  1862, &quot;PTYS - Extended Protocol IB - admin Layout,&quot; on page  2186\;For NVLink: Table  1866, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2188\;\;NOTE: This field and &quot;ib_proto_admin&quot;, &quot;ib_link_width_admin&quot; are mutual exclusive, meaning that only one of the field can be set on write command." subnode="ptys_reg_ext_ib_proto_admin_auto_ext" access="RW" offset="0x3C.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_oper" descr="IB/NVLink port operational protocol.\;For IB: Table  1860, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2186\;For NVLink: Table  1864, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2187" subnode="ptys_reg_ext_ib_proto_oper_auto_ext" access="RO" offset="0x40.0" size="0x4.0" union_selector="$(parent).proto_mask" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  1220, &quot;qpdpm_dscp Layout,&quot; on page  1552" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1226, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="sllm_reg_ext" descr="" size="0x30.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2318, &quot;SLLM - SerDes Lane Link Maintenance Register Layout for 5nm and Serdes_gen_8,&quot; on page  2783" subnode="sllm_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x2c.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  2306, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2775\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  2308, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2777\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2082, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page  2486\;Section  2084, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page  2487\;Section  2086, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page  2489\;Section  2088, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page  2491\;Section  2096, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page  2495\;Section  2098, &quot;SLRG - SerDes Lane Receive Grade Register Layout for Serdes_gen_8,&quot; on page  2496\;Section  2100, &quot;SLRG Measurements Thresholds for 5nm- Layout,&quot; on page  2499" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).port_type AND $(parent).version AND $(parent).all_lanes AND $(parent).measurements_thresholds" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="slrg_thresholds_5nm_ext" descr="" size="0x10.0" >
...
<node name="slsir_reg_ext" descr="" size="0x94.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 2342, &quot;SLSIR - SerDes Lane Status Info Register Layout for 7nm,&quot; on page 2798\;Table 2344, &quot;SLSIR - SerDes Lane Status Info Register Layout for 5nm,&quot; on page 2803\;Table 2346, &quot;SLSIR - SerDes Lane Status Info Register Layout for Serdes_gen_8,&quot; on page 2805" subnode="slsir_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x90.0" union_selector="$(parent).version" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="conf_mod" descr="Set configuration mode for 7nm/5nm product.\;0: tx_linear - when set, tx taps are configured from\;for 7nm\;Table  2066, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2467\;For 5nm\;Table  2070, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2472\;LUT table fields are ignored\;1: tx_lut - when set, tx taps are configured from\;Table  2068, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2468\;7nm_fir_taps page fields are ignored." access="OP" enum="tx_linear=0x0,tx_lut=0x1" offset="0x0.12" size="0x0.1" />
	...
	<field name="page_data" descr="Table  2060, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2464\;Table  2062, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2465\;Table  2066, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2467\;Table  2068, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2468\;Table  2070, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2472\;Table  2072, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for Serdes_gen_8,&quot; on page  2475" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  2076, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2480\;Table  2078, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT Serdes_gen_8,&quot; on page  2482" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x108.0" />
</node>
