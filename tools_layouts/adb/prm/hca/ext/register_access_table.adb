...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2917, &quot;MRFV entry - CVB Layout,&quot; on page 3310\;See Table 2919, &quot;MRFV entry - ULT Layout,&quot; on page 3312\;See Table 2921, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 3313\;See Table 2923, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 3314\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2703, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 3138" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2991, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3360\;Table 2993, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3360\;Table 2995, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3361\;Table 2997, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3361\;Table 2999, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3362\;Table 3001, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3362\;\;Table 3003, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 3363\;Table 3005, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3364" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 411, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 798 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 1073." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2852, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3262" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 1076." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_dpa_apps_info_ext" descr="" size="0x70.0" >
	...
	<field name="dpa_app_metadata" descr="DPA metadata, see Table 2866, &quot;MCQI DPA_APP_METADATA Layout,&quot; on page 3271" subnode="mcqi_dpa_metadata_ext" access="RO" offset="0x8.0" size="0x68.0" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2852, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3262\;VERSION - See Table 2854, &quot;MCQI VERSION Info Layout,&quot; on page 3264\;ACTIVATION_METHOD - See Table 2858, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 3266\;LINKX_PROPERTIES - See Table 2860, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 3267\;CLOCK_SOURCE_PROPERTIES - See Table 2862, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 3269\;DPA_APPS_INFO - See Table 2864, &quot;MCQI DPA_APPS_INFO Layout,&quot; on page 3270" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2856, &quot;Date-Time Layout,&quot; on page 3265" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2856, &quot;Date-Time Layout,&quot; on page 3265" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mcqs_reg_ext" descr="" size="0x10.0" >
	...
	<field name="identifier" descr="This field uniquely identifies a specific component type. \;0x1: BOOT_IMG\;0x4: OEM_NVCONFIG\;0x5: MLNX_NVCONFIG\;0x6: CS_TOKEN\;0x7: DBG_TOKEN\;0xA: Gearbox\;0xB: CC_ALGO - Congestion Control Algorithm\;0xC: LINKX_IMG\;0xD: CRYPTO_TO_COMMISSIONING\;0xE: RMCS_TOKEN\;0xF: RMDT_TOKEN\;0x10: CRCS_TOKEN \;0x11: CRDT_TOKEN \;0x12: CLOCK_SYNC_EEPROM  \;0x15: DIGITAL_CACERT - Certificate to be trusted by the device0x17: DIGITAL_CACERT_REMOVAL\;\;Other values are reserved\;[DWIP]: 0x1A: LINKX_FW_ELS\;\;0x1C: DPA_COMPONENT\;0x1D: DPA_COMPONENT_REMOVAL\;\;0x1E: MTDT_TOKEN\;" access="RO" enum="BOOT_IMG=0x1,OEM_NVCONFIG=0x4,MLNX_NVCONFIG=0x5,CS_TOKEN=0x6,DBG_TOKEN=0x7,Gearbox=0xa,CC_ALGO=0xb,LINKX_IMG=0xc,CRYPTO_TO_COMMISSIONING=0xd,RMCS_TOKEN=0xe,RMDT_TOKEN=0xf,CRCS_TOKEN=0x10,CRDT_TOKEN=0x11,CLOCK_SYNC_EEPROM=0x12,DIGITAL_CACERT=0x15,DPA_COMPONENT=0x1c,DPA_COMPONENT_REMOVAL=0x1d,MTDT_TOKEN=0x1e" offset="0x4.0" size="0x0.16" />
	<field name="component_update_state" descr="Component state in update flow, see Section  10.2.1, &quot;Component Update State,&quot; on page  1073:\;0x0: IDLE\;0x1: IN_PROGRESS\;0x2: APPLIED\;0x3: ACTIVE \;0x4: ACTIVE_PENDING_RESET\;0x5: FAILED\;0x6: CANCELED\;0x7: BUSY\;\;Other values are reserved" access="RO" enum="IDLE=0x0,IN_PROGRESS=0x1,APPLIED=0x2,ACTIVE=0x3,ACTIVE_PENDING_RESET=0x4,FAILED=0x5,CANCELED=0x6,BUSY=0x7" offset="0x8.0" size="0x0.4" />
...
<node name="mdps_reg_ext" descr="" size="0x10.0" >
	...
	<field name="stressors_params" descr="Layout is according to stressor_type value:\;For over voltage seeTable 2961, &quot;Over Voltage Stressor Parameters Layout,&quot; on page 3339\;For under voltage seeTable 2963, &quot;Under Voltage Stressor Parameters Layout,&quot; on page 3339\;" subnode="mdps_reg_stressors_params_auto_ext" access="RW" offset="0x8.0" size="0x8.0" />
</node>
...
<node name="mdtr_reg_ext" descr="" size="0xb0.0" >
	...
	<field name="event_params" descr="event parameters - layout is according to event_id value:\;See Table 2957, &quot;Event_params cvb_config_error Layout,&quot; on page 3337" subnode="mdtr_reg_event_params_auto_ext" access="RW" offset="0x10.0" size="0xa0.0" union_selector="$(parent).event_id" />
</node>
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2880, &quot;Hardware Info Layout,&quot; on page 3284" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2883, &quot;Firmware Info Layout,&quot; on page 3287" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2885, &quot;Software Info Layout,&quot; on page 3290\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2889, &quot;Development Info Layout,&quot; on page 3294" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2882, &quot;Device HW Revision Descriptions,&quot; on page 3286" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  1076\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2691, &quot;JTAG Transaction Set Byte Layout,&quot; on page 3131" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2989, &quot;Configuration Item Header Layout,&quot; on page 3356)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2991, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3360\;Table 2993, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3360\;Table 2995, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3361\;Table 2997, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3361\;Table 2999, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3362\;Table 3001, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3362\;\;Table 3005, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3364" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 31, &quot;PCIe Performance Counters Data Layout,&quot; on page 364\;Table 37, &quot;PCIE Physical Layer Indication Layout,&quot; on page 371\;Table 39, &quot;PCIe Performance Counters 2 Data Layout,&quot; on page 372" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpegc_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="DPNv" descr="DPN version\;0: multi_topology_unaware_sw\;1: multi_topology_aware_sw" access="INDEX" enum="multi_topology_unaware_sw=0x0,multi_topology_aware_sw=0x1" offset="0x0.30" size="0x0.1" />
	<field name="field_select" descr="Field select indicated which writable fields to modify.\;Bit 0: tx_lossy_overflow_oper\;Bit 1: outbound_stalled_reads_th\;Bit 2: outbound_stalled_writes_th\;Bit 3: tx_overflow_sense\;Bit 4: mark_tx_action_cqe\;Bit 5: mark_tx_action_cnp\;Bit 6: virtual_hot_plug_unplug - supported only for internal host" access="WO" enum="tx_lossy_overflow_oper=0x1,outbound_stalled_reads_th=0x2,outbound_stalled_writes_th=0x4,tx_overflow_sense=0x8,mark_tx_action_cqe=0x10,mark_tx_action_cnp=0x20,virtual_hot_plug_unplug=0x40" offset="0x4.0" size="0x0.16" />
...
<node name="mpeinj_reg_ext" descr="" size="0x40.0" >
	<field name="error_type" descr="Error type selector.\;See at Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="DPNv" descr="DPN version\;0: multi_topology_unaware_sw\;1: multi_topology_aware_sw" access="INDEX" enum="multi_topology_unaware_sw=0x0,multi_topology_aware_sw=0x1" offset="0x0.30" size="0x0.1" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_param3_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.16" size="0x0.4" />
	<field name="error_param2_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.20" size="0x0.4" />
	<field name="error_param1_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.24" size="0x0.4" />
	<field name="error_param0_cap" descr="when applicable error param0 capability mask based on Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.28" size="0x0.4" />
	<field name="error_params_0" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table  53, &quot;MPEINJ Error List and Params,&quot; on page  388." access="RW" offset="0x1C.0" size="0x4.0" />
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 29.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1938\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table  1802, &quot;DPA_CAP Capability Layout,&quot; on page  2112" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="buffer" descr="Configuring per-buffer parameters. i=0..9.\;See Table 2480, &quot;BufferX Register Layout,&quot; on page 2889" subnode="bufferx_reg_ext" access="RW" high_bound="9" low_bound="0" offset="0xC.0" size="0x50.0" />
	<field name="shared_headroom_pool" descr="Configuring shared headroom pool parameters. Using the same layout as in BufferX.\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit).\;See Table 2480, &quot;BufferX Register Layout,&quot; on page 2889" subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX.\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM.\;See Table 2480, &quot;BufferX Register Layout,&quot; on page 2889" subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>

<node name="pbsr_reg_ext" descr="" size="0x64.0" >
	<field name="buffer_type" descr="Valid only for 8x port setting (see Table 1940, &quot;PMLP - Ports Module to Local Port Register Fields,&quot; on page 2301)\;1: Main buffer\;2: Secondary buffer" access="INDEX" offset="0x0.0" size="0x0.2" />
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pddr_c2p_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="core_to_phy_link_nvlink_enabled" descr="NVLink protocols admin state\;see: Table  1841, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2154" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_cable_cap_nvlink_ext" descr="" size="0x4.0" >
	<field name="cable_nvlink_proto_cap" descr="Cable NVLink protocols cap:\;See: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2153" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_link_active_nvlink_ext" descr="" size="0x4.0" >
	<field name="link_nvlink_active" descr="NVLink protocols active\;See: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2153" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  2117, &quot;PDDR - Phy Manager Link Enabled IB Layout,&quot; on page  2502\;For Ethernet: Table  2119, &quot;PDDR - Phy Manager Link Enabled Eth Layout,&quot; on page  2503\;For NVLink: Table  2121, &quot;PDDR - Phy Manager Link Enable NVLink Layout,&quot; on page  2503" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  2123, &quot;PDDR - Core2phy Link Enabled IB Layout,&quot; on page  2504\;For Ethernet: Table  2125, &quot;PDDR - Core2phy Link Enabled Eth Layout,&quot; on page  2505\;For NVLink: Table  2127, &quot;PDDR - Core2phy Link Enabled NVLink Layout,&quot; on page  2505" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="cable_proto_cap" descr="For IB: Table  2129, &quot;PDDR - Cable Cap IB Layout,&quot; on page  2506\;For Ethernet: Table  2131, &quot;PDDR - Cable Cap Eth Layout,&quot; on page  2507\;For NVLink: Table  2133, &quot;PDDR - Cable Cap NVLink Layout,&quot; on page  2507" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="link_active" descr="For IB: Table  2135, &quot;PDDR - Link Active IB Layout,&quot; on page  2508\;For Ethernet: Table  2137, &quot;PDDR - Link Active Eth Layout,&quot; on page  2508\;For NVLink: Table  2139, &quot;PDDR - Link Active NVLink Layout,&quot; on page  2509" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="fec_mode_active" descr="FEC mode active\;0: No_FEC\;1: Firecode_FEC\;2: Standard_RS_FEC - RS(528,514)\;3: Standard_LL_RS_FEC - RS(271,257)\;4: Interleaved_Quad_RS_FEC - (544,514)   Quad_KP4_FEC\;5: Interleaved_Quad_RS_FEC_PLR - 546,516) Quad_KP4_FEC\;6: Interleaved_Standard_RS-FEC - (544,514)\;7: Standard_RS-FEC - (544,514)\;8: Interleaved_Octet_RS_FEC_PLR -(546,516) Octet_KP4_FEC\;9: Ethernet_Consortium_LL_50G_RS_FEC- (272,257+1)\;10: Interleaved_Ethernet_Consortium_LL_50G_RS_FEC - (272,257+1)\;12: RS-FEC - (544,514) + PLR- [Internal]\;13: LL-FEC - (271,257) + PLR- [Internal]\;14: Ethernet_Consortium_LL_50G_RS_FEC_PLR - (272,257+1) [Internal] \;15: Interleaved_Ethernet_Consortium_LL_50G_RS_FEC_PLR - (272,257+1) [Internal]" access="RO" enum="No_FEC=0x0,Firecode_FEC=0x1,Standard_RS_FEC=0x2,Standard_LL_RS_FEC=0x3,Interleaved_Quad_RS_FEC=0x4,Interleaved_Quad_RS_FEC_PLR=0x5,Interleaved_Standard_RS=0x6,Standard_RS=0x7,Interleaved_Octet_RS_FEC_PLR=0x8,Ethernet_Consortium_LL_50G_RS_FEC=0x9,Interleaved_Ethernet_Consortium_LL_50G_RS_FEC=0xa,RS=0xc,LL=0xd,Ethernet_Consortium_LL_50G_RS_FEC_PLR=0xe,Interleaved_Ethernet_Consortium_LL_50G_RS_FEC_PLR=0xf" offset="0x1C.16" size="0x0.16" />
	...
	<field name="pd_link_enabled" descr="For IB: Table  2141, &quot;PDDR - Parallel Detect Link Enabled IB Layout,&quot; on page  2510\;For Ethernet: Table  2143, &quot;PDDR - Parallel Detect Link Enabled Eth Layout,&quot; on page  2510" subnode="pddr_operation_info_page_pd_link_enabled_auto_ext" access="RO" offset="0x24.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="phy_hst_link_enabled" descr="For IB: Table  2145, &quot;PDDR - HST Link Enabled IB Layout,&quot; on page  2511\;For Ethernet: Table  2147, &quot;PDDR - HST Link Enabled Eth Layout,&quot; on page  2512" subnode="pddr_operation_info_page_phy_hst_link_enabled_auto_ext" access="RO" offset="0x28.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="eth_an_link_enabled" descr="Table  2149, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2512" access="RO" offset="0x2C.0" size="0x4.0" />
	<field name="test_mode_fsm_state" descr="Test mode FSM state exposure is supported only if PCAM.feature_cap_mask bit 120 is set.\;Mode B links test mode FSM\;0: Disable - this state is shared by Mode A links and Mode B links test mode FSM\;1: Open_lane\;2: Idle\;3: Close_lane\;- Mode A links test mode FSM\;4: Receiver_detect\;5. Idle_mode_a\;6. Signal_detect\;7. Auto_fix_reversal_polarity\;8. Tuning" access="RO" enum="Disable=0x0,Open_lane=0x1,Idle=0x2,Close_lane=0x3,Receiver_detect=0x4" offset="0x38.24" size="0x0.8" />
...
<node name="pddr_phy_manager_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="phy_manager_link_nvlink_enabled" descr="NVLink protocols admin state: \;see: Table  1841, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2154" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  2115, &quot;Operation Info Page Layout,&quot; on page  2492\;Table  2159, &quot;Troubleshooting info Page layout,&quot; on page  2553\;Table  2151, &quot;Phy Info Page Layout,&quot; on page  2513\;Table  2157, &quot;Module Info Page Layout,&quot; on page  2536\;Table  2153, &quot;Link Down Info Page Layout,&quot; on page  2530\;Table  2169, &quot;Link Up Info Page Layout,&quot; on page  2566\;Table  2171, &quot;Module Latched Flag Info Page Layout,&quot; on page  2570\;Table 2181, &quot;Link Partner Info Page Layout,&quot; on page 2588\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  2161, &quot;PDDR - Monitor opcodes layout,&quot; on page  2554" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table  2335, &quot;Module Status Samples Page- Layout,&quot; on page  2759\;Table  2337, &quot;SNR Samples page - Layout,&quot; on page  2761\;Table  2339, &quot;Laser Monitors Samples page - Layout,&quot; on page  2762\;Table  2343, &quot;Pre-FEC BER Samples Page - Layout,&quot; on page  2768\;Table  2349, &quot;Laser Source Module Essential Samples Page - Layout,&quot; on page  2771\;Table 2351, &quot;Laser Source Module Advanced Samples Page - Layout,&quot; on page 2773\;Table 2353, &quot;Optical Engine Debug Parameters Samples Page - Layout,&quot; on page 2776\;Table 2375, &quot;Laser Source Module Status Samples page - Layout,&quot; on page 2791\;Table  2355, &quot;Module Status Properties Page - Layout,&quot; on page  2780\;Table  2357, &quot;SNR Properties Page - Layout,&quot; on page  2782\;Table  2359, &quot;Laser Monitors Properties Page - Layout,&quot; on page  2783\;Table  2363, &quot;Pre-FEC BER Properties Page - Layout,&quot; on page  2785\;Table  2369, &quot;Laser Source Module Essential Properties page - Layout,&quot; on page  2789\;Table 2371, &quot;Laser Source Module Advanced Properties page - Layout,&quot; on page 2790\;Table 2373, &quot;Optical Engine Debug Parameters Properties page - Layout,&quot; on page 2791\;Table 2377, &quot;Laser Source Module Status Properties page - Layout,&quot; on page 2792" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pemi_laser_source_module_status_properties_ext" descr="" size="0xf8.0" >
	<field name="laser_source_module_status_cap" descr="laser source module status mask:\;bit 0: laser_enabled\;bit 1: laser_restriction\;bit 2: laser_status" access="RO" enum="laser_enabled=0x1,laser_restriction=0x2,laser_status=0x4" offset="0x0.29" size="0x0.3" />
</node>

<node name="pemi_laser_source_module_status_samples_ext" descr="" size="0xf8.0" >
	<field name="laser_status" descr="Relevant for CPO product. Each bit represent the ELS&apos;s laser status:\;0: laser_off\;1: laser_ramping\;2: laser_on" access="RO" enum="laser_on=0x2" offset="0x0.0" size="0x0.16" />
...
<node name="plcc_reg_ext" descr="" size="0x10.0" >
	...
	<field name="page_data" descr="Table  2449, &quot;High symbol error rate configuration Page Layout,&quot; on page  2851\;Table  2451, &quot;High bit error rate configuration Page Layout,&quot; on page  2851" subnode="plcc_reg_page_data_auto_ext" access="RW" offset="0x8.0" size="0x8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x40.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1957, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  2316\;Table  1961, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  2320" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1959, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  2319" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	...
	<field name="set_laser_operation" descr="Relevant for ELS module for IB CPO switches only. Set Laser operation:\;0: no_operation\;1: fiber_check\;2: laser_tuning\;3: laser_up" access="WO" offset="0x20.29" size="0x0.3" />
...
<node name="ppbmc_reg_ext" descr="" size="0x10.0" >
	...
	<field name="monitor_type_ext" descr="Operational monitor types extenstion enabled based on monitor_type setting and the operational mode of the link:\;Bit 0: UCR - Uncorrectable Codeword Ratio" access="RO" enum="UCR=0x1" offset="0x4.12" size="0x0.4" />
...
<node name="ppbmp_reg_ext" descr="" size="0x30.0" >
	...
	<field name="monitor_parameters" descr="Table 2231, &quot;PPBMP - BER Monitor Parameters Layout,&quot; on page 2662" subnode="ppbmp_reg_monitor_parameters_auto_ext" access="RW" condition="$(parent).monitor_group" offset="0x4.0" size="0x8.0" />
	...
	<field name="monitor_parameters_cap" descr="The configured Monitor Parameters shall be within the ranges defined by this field.\;The returned value is according to the monitor_group index and the device capabilities.\;See Table 2235, &quot;PPBMP - Monitor Parameters Capabilities Layout,&quot; on page 2665" subnode="ppbmp_monitor_params_cap_ext" access="RO" offset="0x14.0" size="0x4.0" />
</node>
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1849, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  2168\;Table  1851, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  2172\;Table  1853, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  2175\;Table  1855, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  2180\;Table  1857, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  2184\;Table  1860, &quot;Ethernet Discard Counter Group Fields,&quot; on page  2189\;Table  1861, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  2191\;Table  1865, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  2199\;Table  1877, &quot;Physical Layer Counters Data Layout,&quot; on page  2210\;Table  1867, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  2200\;Table  1881, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  2219\;Table  1873, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  2204\;Table  1875, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  2206\;Table  1883, &quot;PLR Counters Data Layout,&quot; on page  2225 \;Table  1885, &quot;RS-Histograms Data Layout,&quot; on page  2227\;Table  1889, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  2229\;Table  1891, &quot;InfiniBand General Counters Data Layout,&quot; on page  2232\;Table  1909, &quot;Physical Layer Recovery Counters Group Data Layout,&quot; on page  2264\;Table  1911, &quot;NVLink Reduction Counters Group Layout,&quot; on page  2268" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x5c.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table  2209, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page  2636" subnode="pphcr_bin_range_ext" access="RW" high_bound="18" low_bound="0" offset="0x10.0" size="0x4c.0" />
</node>

<node name="pplm_nvl6_fec_ext" descr="" size="0x18.0" >
	<field name="nvlink_fec_override_admin_200g_1x" descr="200G 1x (Simplex NVL5/6 XDR_1x) Mode A - override admin bitmask (one-hot setting):\;0: auto_mode - no override\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="auto_mode=0x0,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x0.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_200g_1x" descr="200G 1x (Simplex NVL5/6 XDR_1x) Mode A - override capability bitmask:\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x0.16" size="0x0.16" />
	<field name="nvlink_fec_override_admin_400g_2x" descr="400G 2x (Simplex NVL5/6 XDR_2x) Mode A - override admin bitmask (one-hot set\;ting):\;0: auto_mode - no override\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="auto_mode=0x0,RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x4.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_400g_2x" descr="400G 2x (Simplex NVL5/6 XDR_2x) Mode A - override capability bitmask:\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x4.16" size="0x0.16" />
	<field name="nvlink_fec_override_admin_375g_2x" descr="375G 2x (Bidirectional NVL6) Mode B - override admin bitmask (one-hot setting):\;0: auto_mode - no override\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="auto_mode=0x0,RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x8.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_375g_2x" descr="375G 2x (Bidirectional NVL6) Mode B - override capability bitmask:\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x8.16" size="0x0.16" />
	<field name="nvlink_fec_override_admin_337p5g_2x" descr="337.5G 2x (Bidirectional NVL6) Mode B - NVL6 override admin bitmask (one-hot setting):\;0: auto_mode - no override\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="auto_mode=0x0,RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0xC.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_337p5g_2x" descr="337.5G 2x (Bidirectional NVL6) Mode B - override capability bitmask:\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0xC.16" size="0x0.16" />
	<field name="nvlink_fec_override_admin_307p5g_2x" descr="307.5G 2x (Bidirectional NVL6) Mode B - NVL6 override admin bitmask (one-hot setting):\;0: auto_mode - no override\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="auto_mode=0x0,RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x10.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_307p5g_2x" descr="307.5G 2x (Bidirectional NVL6) Mode B - NVL6 override capability bitmask:\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x10.16" size="0x0.16" />
	<field name="nvlink_fec_override_admin_200g_2x" descr="200G 2x (Simplex XDR 2x slow) Mode A - override admin bitmask (one-hot setting):\;0: auto_mode - no override\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="auto_mode=0x0,RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x14.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_200g_2x" descr="200G 2x (Simplex XDR 2x slow) Mode A - override capability bitmask:\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x14.16" size="0x0.16" />
</node>
...
<node name="pplm_reg_ext" descr="" size="0x80.0" >
	...
	<field name="fec_page_data" descr="Table  2005, &quot;PPLM - NVL6 Rates FEC Override Layout,&quot; on page  2394" subnode="pplm_reg_fec_page_data_auto_ext" access="RW" offset="0x68.0" size="0x18.0" union_selector="$(parent).fec_generation" />
</node>
...
<node name="pprm_phy_steps_ext" descr="" size="0x68.0" >
	...
	<field name="step1_preset_oper" descr="1: PEQ_only\;2: CDR_toggle\;3: full_duplex_EQ\;4: Logic_lock_only\;0xF: no_request - skip step" access="RO" offset="0x24.0" size="0x0.4" />
	<field name="step2_preset_oper" descr="1: PEQ_only\;2: CDR_toggle\;3: full_duplex_EQ\;4: Logic_lock_only\;0xF: no_request - skip step" access="RO" offset="0x24.8" size="0x0.4" />
...
<node name="pprm_reg_ext" descr="" size="0x94.0" >
	...
	<field name="param_page_data" descr="recovery parameters for read / write functionality\;see Table  1933, &quot;PPRM phy recovery steps params,&quot; on page  2291" subnode="pprm_reg_param_page_data_auto_ext" access="RW" offset="0x2C.0" size="0x68.0" union_selector="$(parent).param_select" />
</node>
...
<node name="pprt_reg_ext" descr="" size="0x24.0" >
	...
	<field name="lane_rate_cap" descr="Per lane rate capability (bitmask)\;Bit 0 - 1GE (1.25 Gb/s) / Gen 1 PCIe (2.5 Gb/s)\;Bit 1 - SDR (2.5 Gb/s) / Gen 2 PCIe (5 Gb/s)\;Bit 2 - XAUI/2.5GE (3.125 Gb/s) / Gen 3 PCIe (8 Gb/s)\;Bit 3- DDR (5 Gb/s) / Gen 4 PCIe (16 Gb/s)\;Bit 4- QDR (10 Gb/s) / Gen 5 PCIe (32 Gb/s)\;Bit 5- FDR10 / 10GE/40GE (10.3125 Gb/s) / Gen 5 PCIe (64 Gb/s PAM4, 32Gbd)\;Bit 6- FDR (14.0625 Gb/s) \;Bit 7- EDR / 25GE / 50GE / 100GE (25.78125 Gb/s) \;Bit 8 - 50GE-KR4 (12.89 Gb/s) \;Bit 9 - HDR /50GE / 100GE / 200GE / 400GE (26.5625Gbd / 53.125Gb/s) \;Bit 10 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;Bit 11 - XDR / NVL6 / 200G_1x_simplex (106.25 Gbd / 212.5 Gb/s)\;Bit 12 - NVL6 / 337p5G_2x_bidi (90 Gbd / 180 Gb/s)\;Bit 13 - NVL6 / 375G_2x_bidi (100 Gbd / 200 Gb/s)\;Bit 14 - NVL6 / 307p5G_2x_bidi (82 Gbd / 164 Gb/s)\;Note: PCIe speeds are relevant when pnat = 3 only" access="RO" offset="0xC.16" size="0x0.16" />
	<field name="lane_rate_oper" descr="Lane rate to be used in PRBS, see lane_rate_cap:\;0 - SDR (2.5 Gb/s) / Gen 1 PCIe (2.5 Gb/s)\;1 - DDR (5 Gb/s) / Gen 2 PCIe (5 Gb/s)\;2 - QDR (10 Gb/s)\;3 - FDR10 / 10GE/4 0GE (10.3125 Gb/s) / Gen 3 PCIe (8 Gb/s)\;4 - FDR (14.0625 Gb/s) / Gen 4 PCIe (16 Gb/s)\;5 - EDR / 25GE / 50GE / 100GE (25.78125 Gb/s) / Gen 5 PCIe (32 Gb/s)\;6 - HDR /50GE / 100GE / 200GE / 400GE (26.5625Gbd / 53.125Gb/s / Gen 5 PCIe (64 Gb/s PAM4, 32Gbd)\;7 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s) \;8 - XDR / NVL6 / 200G_1x_simplex (106.25 Gbd / 212.5 Gb/s)\;9 - NVL6 / 337p5G_2x_bidi (90 Gbd / 180 Gb/s)\;10 - 1GE (1.25 Gb/s)\;11 - XAUI/2.5GE (3.125 Gb/s)\;12 - 50GE-KR4 (12.89 Gb/s)\;13 - NVL6 / 375G_2x_bidi (100 Gbd / 200 Gb/s)\;14 - NVL6 / 307p5G_2x_bidi (82 Gbd / 164 Gb/s)\;\;Note: All lanes must be set to the same rate.\;Note: PCIe speeds are relevant when pnat = 3 only" access="RW" offset="0x10.16" size="0x0.16" />
...
<node name="pptt_reg_ext" descr="" size="0x1c.0" >
	...
	<field name="lane_rate_cap" descr="Per lane rate capability (bitmask)\;Bit 0 - 1GE (1.25 Gb/s) / Gen 1 PCIe (2.5 Gb/s)\;Bit 1 - SDR (2.5 Gb/s) / Gen 2 PCIe (5 Gb/s)\;Bit 2 - XAUI/2.5GE (3.125 Gb/s) / Gen 3 PCIe (8 Gb/s)\;Bit 3- DDR (5 Gb/s) / Gen 4 PCIe (16 Gb/s)\;Bit 4- QDR (10 Gb/s) / Gen 5 PCIe (32 Gb/s)\;Bit 5- FDR10 / 10GE/40GE (10.3125 Gb/s) / Gen 5 PCIe (64 Gb/s PAM4, 32Gbd)\;Bit 6- FDR (14.0625 Gb/s) \;Bit 7- EDR / 25GE / 50GE / 100GE (25.78125 Gb/s) \;Bit 8 - 50GE-KR4 (12.89 Gb/s) \;Bit 9 - HDR /50GE / 100GE / 200GE / 400GE (26.5625Gbd / 53.125Gb/s) \;Bit 10 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;Bit 11 - XDR / NVL6 / 200G_1x_simplex (106.25Gbd / 212.5Gb/s)\;Bit 12 - NVL6 / 337p5G_2x_bidi (90 Gbd / 180Gb/s)\;Bit 13 - NVL6 / 375G_2x_bidi (100 Gbd / 200Gb/s)\;Bit 14 - NVL6 / 307p5G_2x_bidi (82 Gbd / 164 Gb/s)\;\;Note: PCIe speeds are relevant when pnat = 3 only\;" access="RO" offset="0xC.16" size="0x0.16" />
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1929, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  2284" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="ptasv2_reg_ext" descr="" size="0x30.0" >
	...
	<field name="page_data" descr="Table 2073, &quot;PTASv2 - Phy Tuning Algorithm Settings Register Layout for 7nm and 5nm,&quot; on page 2458" subnode="ptasv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x8.0" size="0x28.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1923, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  2281\;Table  1925, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  2282" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="ptys_ext_proto_nvlink_admin_ext" descr="" size="0x4.0" >
	<field name="ext_proto_nvlink" descr="NVLink bitmask:\;Bit 0: 200G_1x (Simplex NVL5/6 XDR_1x) - Mode A\;Bit 1: 400G_2x (Simplex NVL5/6 XDR_2x) - Mode A\;Bit 2: 375G_2x (Bidirectional NVL6) - Mode B\;Bit 3: 337p5G_2x (Bidirectional NVL6) - Mode B\;Bit 4: 307p5G_2x (Bidirectional NVL6) - Mode B\;Bit 5: Reserved\;Bit 6: 200G_2x (Simplex XDR_2x_Slow) - Mode A" access="RW" offset="0x0.0" size="0x4.0" />
</node>

<node name="ptys_ext_proto_nvlink_cap_oper_ext" descr="" size="0x4.0" >
	<field name="ext_proto_nvlink" descr="NVLink bitmask:\;Bit 0: 200G_1x (Simplex NVL5/6 XDR_1x) - Mode A\;Bit 1: 400G_2x (Simplex NVL5/6 XDR_2x) - Mode A\;Bit 2: 375G_2x (Bidirectional NVL6) - Mode B\;Bit 3: 337p5G_2x (Bidirectional NVL6) - Mode B\;Bit 4: 307p5G_2x (Bidirectional NVL6) - Mode B\;Bit 5: Reserved\;Bit 6: 200G_2x (Simplex XDR_2x_Slow) - Mode A" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="ptys_reg_ext" descr="" size="0x44.0" >
	...
	<field name="ext_ib_proto_cap" descr="IB/NVlink port supported protocols and widths bit-mask.\;Valid if PCAM.feature_cap_mask bit 90 is set OR mask &lt;&gt;0.\;\;For IB: Table  1835, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2152\;For NVLink: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2153" subnode="ptys_reg_ext_ib_proto_cap_auto_ext" access="RO" offset="0x38.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_admin" descr="IB/NVLink port protocols admin values.\;\;For IB: Table  1837, &quot;PTYS - Extended Protocol IB - admin Layout,&quot; on page  2152\;For NVLink: Table  1841, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2154\;\;NOTE: This field and &quot;ib_proto_admin&quot;, &quot;ib_link_width_admin&quot; are mutual exclusive, meaning that only one of the field can be set on write command." subnode="ptys_reg_ext_ib_proto_admin_auto_ext" access="RW" offset="0x3C.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_oper" descr="IB/NVLink port operational protocol.\;For IB: Table  1835, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2152\;For NVLink: Table  1839, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2153" subnode="ptys_reg_ext_ib_proto_oper_auto_ext" access="RO" offset="0x40.0" size="0x4.0" union_selector="$(parent).proto_mask" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  1194, &quot;qpdpm_dscp Layout,&quot; on page  1529" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1200, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section  29.11, &quot;Resource Dump,&quot; on page  1983." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sllm_5nm_ext" descr="" size="0x2c.0" >
	...
	<field name="is_peq_on" descr="does periodic EQ is on" access="RO" offset="0x0.2" size="0x0.1" />
...
<node name="sllm_reg_ext" descr="" size="0x30.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2279, &quot;SLLM - SerDes Lane Link Maintenance Register Layout for 5nm and Serdes_gen_8,&quot; on page  2714" subnode="sllm_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x2c.0" />
</node>

<node name="sllm_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x2c.0" >
	<field name="sllm_5nm_ext" descr="" subnode="sllm_5nm_ext" condition="($(parent).port_type == Network_Port) AND (($(parent).version ==   prod_5nm) OR $(parent).version == serdes_gen_8)" offset="0x0.0" size="0x2c.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  2267, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2706\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  2269, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2707\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 2051, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2441\;Table 2053, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page 2442\;Table 2055, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page 2444\;Table 2057, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page 2446\;Table 2065, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2450\;Table 2067, &quot;SLRG - SerDes Lane Receive Grade Register Layout for Serdes_gen_8,&quot; on page 2451\;Table 2069, &quot;SLRG Measurements Thresholds for 5nm- Layout,&quot; on page 2454" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).port_type AND $(parent).version AND $(parent).all_lanes AND $(parent).measurements_thresholds" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="slrg_thresholds_5nm_ext" descr="" size="0x8.0" >
	<field name="snr_line_low_warning" descr="Line side warning threshold for SNR value. If SNR value goes below this value, it should be considered as a warning" access="RO" offset="0x0.0" size="0x0.16" />
	<field name="snr_line_low_alarm" descr="Line side alarm threshold for SNR value. If SNR value goes below this value, it should be considered as an alarm" access="RO" offset="0x0.16" size="0x0.16" />
	<field name="snr_host_low_warning" descr="Host side warning threshold for SNR value. If SNR value goes below this value, it should be considered as a warning" access="RO" offset="0x4.0" size="0x0.16" />
	<field name="snr_host_low_alarm" descr="Host side alarm threshold for SNR value. If SNR value goes below this value, it should be considered as an alarm" access="RO" offset="0x4.16" size="0x0.16" />
</node>
...
<node name="slsir_reg_ext" descr="" size="0x94.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 2303, &quot;SLSIR - SerDes Lane Status Info Register Layout for 7nm,&quot; on page 2729\;Table 2305, &quot;SLSIR - SerDes Lane Status Info Register Layout for 5nm,&quot; on page 2734\;Table 2307, &quot;SLSIR - SerDes Lane Status Info Register Layout for Serdes_gen_8,&quot; on page 2736" subnode="slsir_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x90.0" union_selector="$(parent).version" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="lane_speed" descr="Reserved for PCIe.\;The lane speed for TX settings:\;0 - SDR / Gen1 (PCIe)\;1 - DDR / Gen2 (PCIe) / 5GBASE-R\;2 - QDR / Gen3 (PCIe)\;3 - FDR10 (10GE / 40GE)\;4 - FDR (56GE) / Gen4 (PCIe)\;5 - EDR (25GE / 50GE / 100GE) / Gen5 (PCIe)\;6 - HDR (50GE / 200GE / 400GE)\;7 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;8 - XDR / NVL6 / 200G_1x_simplex (106.25 Gbd / 212.5Gb/s)\;9 - Reserved\;10 - 1GE\;11 - 2.5GE (XAUI)\;12 - 50GE-KR4\;13 - NVL6 / 337p5G_2x_bidi (90 Gbd / 180Gb/s)\;14 - NVL6 / 375G_2x_bidi (100 Gbd / 200Gb/s)\;15 - NVL6 / 307p5G_2x_bidi (82 Gbd / 164 Gb/s)" access="RW" offset="0x0.4" size="0x0.4" />
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="conf_mod" descr="Set configuration mode for 7nm/5nm product.\;0: tx_linear - when set, tx taps are configured from\;for 7nm\;Table  2035, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2422\;For 5nm\;Table  2039, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2427\;LUT table fields are ignored\;1: tx_lut - when set, tx taps are configured from\;Table  2037, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2423\;7nm_fir_taps page fields are ignored." access="OP" enum="tx_linear=0x0,tx_lut=0x1" offset="0x0.12" size="0x0.1" />
	...
	<field name="page_data" descr="Table  2029, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2419\;Table  2031, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2420\;Table  2035, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2422\;Table  2037, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2423\;Table  2039, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2427\;Table  2041, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for Serdes_gen_8,&quot; on page  2430" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  2045, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2435\;Table  2047, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT Serdes_gen_8,&quot; on page  2437" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x108.0" />
</node>
