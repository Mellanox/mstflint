...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2996, &quot;MRFV entry - CVB Layout,&quot; on page 3419\;See Table 2998, &quot;MRFV entry - ULT Layout,&quot; on page 3421\;See Table 3000, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 3422\;See Table 3002, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 3423\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2778, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 3242" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="bufferx_reg_ext" descr="" size="0x8.0" >
	...
	<field name="thresholds" descr="For lossless (lossy=0) see Table 2551, &quot;BufferX Lossless Thresholds Layout,&quot; on page 2976.\;" subnode="bufferx_reg_thresholds_auto_ext" access="RW" offset="0x4.00" size="0x4.0" union_selector="$(parent).lossy" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 3070, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3469\;Table 3072, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3469\;Table 3074, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3470\;Table 3076, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3470\;Table 3078, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3471\;Table 3080, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3471\;\;Table 3082, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 3472\;Table 3084, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3473" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="hst_link_nvlink_enabled_ext" descr="" size="0x4.0" >
	<field name="link_nvlink_active" descr="NVLink protocols active\;See: Table  1868, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2188" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 418, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 813 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 1099." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2931, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3371" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 1102." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_dpa_apps_info_ext" descr="" size="0x70.0" >
	...
	<field name="dpa_app_metadata" descr="DPA metadata, see Table 2945, &quot;MCQI DPA_APP_METADATA Layout,&quot; on page 3380" subnode="mcqi_dpa_metadata_ext" access="RO" offset="0x8.0" size="0x68.0" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2931, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3371\;VERSION - See Table 2933, &quot;MCQI VERSION Info Layout,&quot; on page 3373\;ACTIVATION_METHOD - See Table 2937, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 3375\;LINKX_PROPERTIES - See Table 2939, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 3376\;CLOCK_SOURCE_PROPERTIES - See Table 2941, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 3378\;DPA_APPS_INFO - See Table 2943, &quot;MCQI DPA_APPS_INFO Layout,&quot; on page 3379" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2935, &quot;Date-Time Layout,&quot; on page 3374" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2935, &quot;Date-Time Layout,&quot; on page 3374" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mdps_reg_ext" descr="" size="0x10.0" >
	...
	<field name="stressors_params" descr="Layout is according to stressor_type value:\;For over voltage seeTable 3040, &quot;Over Voltage Stressor Parameters Layout,&quot; on page 3448\;For under voltage seeTable 3042, &quot;Under Voltage Stressor Parameters Layout,&quot; on page 3448\;" subnode="mdps_reg_stressors_params_auto_ext" access="RW" offset="0x8.0" size="0x8.0" />
</node>
...
<node name="mdtr_reg_ext" descr="" size="0xb0.0" >
	...
	<field name="event_params" descr="event parameters - layout is according to event_id value:\;See Table 3036, &quot;Event_params cvb_config_error Layout,&quot; on page 3446" subnode="mdtr_reg_event_params_auto_ext" access="RW" offset="0x10.0" size="0xa0.0" union_selector="$(parent).event_id" />
</node>
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2959, &quot;Hardware Info Layout,&quot; on page 3393" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2962, &quot;Firmware Info Layout,&quot; on page 3396" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2964, &quot;Software Info Layout,&quot; on page 3399\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2968, &quot;Development Info Layout,&quot; on page 3403" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2961, &quot;Device HW Revision Descriptions,&quot; on page 3395" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  1102\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2766, &quot;JTAG Transaction Set Byte Layout,&quot; on page 3235" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 3068, &quot;Configuration Item Header Layout,&quot; on page 3465)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 3070, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3469\;Table 3072, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3469\;Table 3074, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3470\;Table 3076, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3470\;Table 3078, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3471\;Table 3080, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3471\;\;Table 3084, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3473" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 29.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1975\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table  1831, &quot;DPA_CAP Capability Layout,&quot; on page  2149" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="buffer" descr="Configuring per-buffer parameters. i=0..9.\;See Table 2549, &quot;BufferX Register Layout,&quot; on page 2975" subnode="bufferx_reg_ext" access="RW" high_bound="9" low_bound="0" offset="0xC.0" size="0x50.0" />
	<field name="shared_headroom_pool" descr="Configuring shared headroom pool parameters. Using the same layout as in BufferX.\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit).\;See Table 2549, &quot;BufferX Register Layout,&quot; on page 2975" subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX.\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM.\;See Table 2549, &quot;BufferX Register Layout,&quot; on page 2975" subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>

<node name="pbsr_reg_ext" descr="" size="0x64.0" >
	<field name="buffer_type" descr="Valid only for 8x port setting (see Table 1973, &quot;PMLP - Ports Module to Local Port Register Fields,&quot; on page 2345)\;1: Main buffer\;2: Secondary buffer\;Reserved in Spectrum-5" access="INDEX" offset="0x0.0" size="0x0.2" />
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pddr_c2p_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="core_to_phy_link_nvlink_enabled" descr="NVLink protocols admin state\;see: Table  1870, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2189" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_cable_cap_nvlink_ext" descr="" size="0x4.0" >
	<field name="cable_nvlink_proto_cap" descr="Cable NVLink protocols cap:\;See: Table  1868, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2188" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  2152, &quot;PDDR - Phy Manager Link Enabled IB Layout,&quot; on page  2551\;For Ethernet: Table  2154, &quot;PDDR - Phy Manager Link Enabled Eth Layout,&quot; on page  2551\;For NVLink: Table  2156, &quot;PDDR - Phy Manager Link Enable NVLink Layout,&quot; on page  2552" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  2158, &quot;PDDR - Core2phy Link Enabled IB Layout,&quot; on page  2553\;For Ethernet: Table  2160, &quot;PDDR - Core2phy Link Enabled Eth Layout,&quot; on page  2554\;For NVLink: Table  2162, &quot;PDDR - Core2phy Link Enabled NVLink Layout,&quot; on page  2554" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="cable_proto_cap" descr="For IB: Table  2164, &quot;PDDR - Cable Cap IB Layout,&quot; on page  2555\;For Ethernet: Table  2166, &quot;PDDR - Cable Cap Eth Layout,&quot; on page  2556\;For NVLink: Table  2168, &quot;PDDR - Cable Cap NVLink Layout,&quot; on page  2556" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="link_active" descr="For IB: Table  2170, &quot;PDDR - Link Active IB Layout,&quot; on page  2557\;For Ethernet: Table  2172, &quot;PDDR - Link Active Eth Layout,&quot; on page  2557\;For NVLink: Table  2174, &quot;PDDR - Link Active NVLink Layout,&quot; on page  2558" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="pd_link_enabled" descr="For IB: Table  2176, &quot;PDDR - Parallel Detect Link Enabled IB Layout,&quot; on page  2559\;For Ethernet: Table  2178, &quot;PDDR - Parallel Detect Link Enabled Eth Layout,&quot; on page  2559" subnode="pddr_operation_info_page_pd_link_enabled_auto_ext" access="RO" offset="0x24.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="phy_hst_link_enabled" descr="For IB: Table  2180, &quot;PDDR - HST Link Enabled IB Layout,&quot; on page  2560\;For Ethernet: Table  2182, &quot;PDDR - HST Link Enabled Eth Layout,&quot; on page  2561\;For NVLink: Table  2184, &quot;PDDR - HST Link Enabled NVLink Layout,&quot; on page  2561" subnode="pddr_operation_info_page_phy_hst_link_enabled_auto_ext" access="RO" offset="0x28.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="eth_an_link_enabled" descr="Table  2186, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2562" access="RO" offset="0x2C.0" size="0x4.0" />
...
<node name="pddr_phy_manager_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="phy_manager_link_nvlink_enabled" descr="NVLink protocols admin state: \;see: Table  1870, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2189" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  2150, &quot;Operation Info Page Layout,&quot; on page  2541\;Table  2196, &quot;Troubleshooting info Page layout,&quot; on page  2607\;Table  2188, &quot;Phy Info Page Layout,&quot; on page  2563\;Table  2194, &quot;Module Info Page Layout,&quot; on page  2590\;Table  2190, &quot;Link Down Info Page Layout,&quot; on page  2583\;Table  2206, &quot;Link Up Info Page Layout,&quot; on page  2620\;Table  2208, &quot;Module Latched Flag Info Page Layout,&quot; on page  2624\;Table 2218, &quot;Link Partner Info Page Layout,&quot; on page 2642\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  2198, &quot;PDDR - Monitor opcodes layout,&quot; on page  2608" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table  2388, &quot;Module Status Samples Page- Layout,&quot; on page  2833\;Table  2390, &quot;SNR Samples page - Layout,&quot; on page  2836\;Table  2392, &quot;Laser Monitors Samples page - Layout,&quot; on page  2837\;Table  2396, &quot;Pre-FEC BER Samples Page - Layout,&quot; on page  2842\;Table  2402, &quot;Laser Source Module Essential Samples Page - Layout,&quot; on page  2845\;Table 2404, &quot;Laser Source Module Advanced Samples Page - Layout,&quot; on page 2848\;Table 2406, &quot;Optical Engine Debug Parameters Samples Page - Layout,&quot; on page 2850\;Table 2428, &quot;Laser Source Module Status Samples page - Layout,&quot; on page 2867\;Table  2408, &quot;Module Status Properties Page - Layout,&quot; on page  2855\;Table  2410, &quot;SNR Properties Page - Layout,&quot; on page  2857\;Table  2412, &quot;Laser Monitors Properties Page - Layout,&quot; on page  2858\;Table  2416, &quot;Pre-FEC BER Properties Page - Layout,&quot; on page  2861\;Table  2422, &quot;Laser Source Module Essential Properties page - Layout,&quot; on page  2864\;Table 2424, &quot;Laser Source Module Advanced Properties page - Layout,&quot; on page 2866\;Table 2426, &quot;Optical Engine Debug Parameters Properties page - Layout,&quot; on page 2867\;Table 2430, &quot;Laser Source Module Status Properties page - Layout,&quot; on page 2868" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="plcc_reg_ext" descr="" size="0x10.0" >
	...
	<field name="page_data" descr="Table  2516, &quot;High symbol error rate configuration Page Layout,&quot; on page  2930\;Table  2518, &quot;High bit error rate configuration Page Layout,&quot; on page  2930" subnode="plcc_reg_page_data_auto_ext" access="RW" offset="0x8.0" size="0x8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x40.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1990, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  2360\;Table  1994, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  2364" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1992, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  2363" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppbmp_reg_ext" descr="" size="0x30.0" >
	...
	<field name="monitor_parameters" descr="Table 2268, &quot;PPBMP - BER Monitor Parameters Layout,&quot; on page 2718" subnode="ppbmp_reg_monitor_parameters_auto_ext" access="RW" condition="$(parent).monitor_group" offset="0x4.0" size="0x8.0" />
	...
	<field name="monitor_parameters_cap" descr="The configured Monitor Parameters shall be within the ranges defined by this field.\;The returned value is according to the monitor_group index and the device capabilities.\;See Table 2272, &quot;PPBMP - Monitor Parameters Capabilities Layout,&quot; on page 2721" subnode="ppbmp_monitor_params_cap_ext" access="RO" offset="0x14.0" size="0x4.0" />
</node>
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1878, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  2203\;Table  1880, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  2207\;Table  1882, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  2210\;Table  1884, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  2215\;Table  1886, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  2219\;Table  1889, &quot;Ethernet Discard Counter Group Fields,&quot; on page  2224\;Table  1890, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  2226\;Table  1894, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  2234\;Table  1906, &quot;Physical Layer Counters Data Layout,&quot; on page  2245\;Table  1896, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  2235\;Table  1910, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  2254\;Table  1902, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  2239\;Table  1904, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  2241\;Table  1912, &quot;PLR Counters Data Layout,&quot; on page  2260 \;Table  1914, &quot;RS-Histograms Data Layout,&quot; on page  2263\;Table  1918, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  2265\;Table  1920, &quot;InfiniBand General Counters Data Layout,&quot; on page  2268\;Table  1938, &quot;Physical Layer Recovery Counters Group Data Layout,&quot; on page  2300\;Table  1940, &quot;NVLink Reduction Counters Group Layout,&quot; on page  2304" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x5c.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table  2246, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page  2690" subnode="pphcr_bin_range_ext" access="RW" high_bound="18" low_bound="0" offset="0x10.0" size="0x4c.0" />
</node>
...
<node name="pplm_reg_ext" descr="" size="0x80.0" >
	...
	<field name="fec_page_data" descr="Table  2040, &quot;PPLM - NVL6 Rates FEC Override Layout,&quot; on page  2440" subnode="pplm_reg_fec_page_data_auto_ext" access="RW" offset="0x68.0" size="0x18.0" union_selector="$(parent).fec_generation" />
</node>
...
<node name="pprm_reg_ext" descr="" size="0x94.0" >
	...
	<field name="wait_for_module_cap" descr="When set, wait_for_module supported " access="RW" offset="0x0.6" size="0x0.1" />
	<field name="plane_ind" descr="Reserved for non-planarized port.\;Plane port index of the aggregated port. A value of 0 refers to the aggregated port only." access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	...
	<field name="param_page_data" descr="recovery parameters for read / write functionality\;see Table  1966, &quot;PPRM phy recovery steps params,&quot; on page  2336" subnode="pprm_reg_param_page_data_auto_ext" access="RW" offset="0x2C.0" size="0x68.0" union_selector="$(parent).param_select" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1962, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  2328" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="ptasv2_reg_ext" descr="" size="0x40.0" >
	...
	<field name="page_data" descr="Table  2108, &quot;PTASv2 - Phy Tuning Algorithm Settings Register Layout for 7nm and 5nm,&quot; on page  2505" subnode="ptasv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x8.0" size="0x38.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1956, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  2325\;Table  1958, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  2326" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="ptys_reg_ext" descr="" size="0x44.0" >
	...
	<field name="ext_ib_proto_cap" descr="IB/NVlink port supported protocols and widths bit-mask.\;Valid if PCAM.feature_cap_mask bit 90 is set OR mask &lt;&gt;0.\;\;For IB: Table  1864, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2187\;For NVLink: Table  1868, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2188" subnode="ptys_reg_ext_ib_proto_cap_auto_ext" access="RO" offset="0x38.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_admin" descr="IB/NVLink port protocols admin values.\;\;For IB: Table  1866, &quot;PTYS - Extended Protocol IB - admin Layout,&quot; on page  2187\;For NVLink: Table  1870, &quot;PTYS - Extended Protocol NVLink - admin Layout,&quot; on page  2189\;\;NOTE: This field and &quot;ib_proto_admin&quot;, &quot;ib_link_width_admin&quot; are mutual exclusive, meaning that only one of the field can be set on write command." subnode="ptys_reg_ext_ib_proto_admin_auto_ext" access="RW" offset="0x3C.0" size="0x4.0" union_selector="$(parent).proto_mask" />
	<field name="ext_ib_proto_oper" descr="IB/NVLink port operational protocol.\;For IB: Table  1864, &quot;PTYS - Extended Protocol IB - cap/oper Layout,&quot; on page  2187\;For NVLink: Table  1868, &quot;PTYS - Extended Protocol NVLink - cap/oper Layout,&quot; on page  2188" subnode="ptys_reg_ext_ib_proto_oper_auto_ext" access="RO" offset="0x40.0" size="0x4.0" union_selector="$(parent).proto_mask" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  1224, &quot;qpdpm_dscp Layout,&quot; on page  1558" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1230, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section  29.11, &quot;Resource Dump,&quot; on page  2020." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sllm_reg_ext" descr="" size="0x30.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2322, &quot;SLLM - SerDes Lane Link Maintenance Register Layout for 5nm and Serdes_gen_8,&quot; on page  2784" subnode="sllm_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x2c.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  2310, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2776\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  2312, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2778\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2086, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page  2487\;Section  2088, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page  2488\;Section  2090, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page  2490\;Section  2092, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page  2492\;Section  2100, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page  2496\;Section  2102, &quot;SLRG - SerDes Lane Receive Grade Register Layout for Serdes_gen_8,&quot; on page  2497\;Section  2104, &quot;SLRG Measurements Thresholds for 5nm- Layout,&quot; on page  2500" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).port_type AND $(parent).version AND $(parent).all_lanes AND $(parent).measurements_thresholds" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="slsir_reg_ext" descr="" size="0x94.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 2346, &quot;SLSIR - SerDes Lane Status Info Register Layout for 7nm,&quot; on page 2799\;Table 2348, &quot;SLSIR - SerDes Lane Status Info Register Layout for 5nm,&quot; on page 2804\;Table 2350, &quot;SLSIR - SerDes Lane Status Info Register Layout for Serdes_gen_8,&quot; on page 2806" subnode="slsir_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x90.0" union_selector="$(parent).version" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="conf_mod" descr="Set configuration mode for 7nm/5nm product.\;0: tx_linear - when set, tx taps are configured from\;for 7nm\;Table  2070, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2468\;For 5nm\;Table  2074, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2473\;LUT table fields are ignored\;1: tx_lut - when set, tx taps are configured from\;Table  2072, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2469\;7nm_fir_taps page fields are ignored." access="OP" enum="tx_linear=0x0,tx_lut=0x1" offset="0x0.12" size="0x0.1" />
	...
	<field name="page_data" descr="Table  2064, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2465\;Table  2066, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2466\;Table  2070, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2468\;Table  2072, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2469\;Table  2074, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2473\;Table  2076, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for Serdes_gen_8,&quot; on page  2476" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  2080, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2481\;Table  2082, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT Serdes_gen_8,&quot; on page  2483" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).port_type AND $(parent).version" offset="0x4.0" size="0x108.0" />
</node>
