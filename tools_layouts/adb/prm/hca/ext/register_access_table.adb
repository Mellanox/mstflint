...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2804, &quot;MRFV entry - CVB Layout,&quot; on page 3171\;See Table 2806, &quot;MRFV entry - ULT Layout,&quot; on page 3173\;See Table 2808, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 3174\;See Table 2810, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 3175\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2596, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 3002" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2878, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3221\;Table 2880, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3221\;Table 2882, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3222\;Table 2884, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3222\;Table 2886, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3223\;Table 2888, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3223\;\;Table 2890, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 3224\;Table 2892, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3225" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 390, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 756 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="lane_2_module_mapping_ext" descr="" size="0x4.0" >
	...
	<field name="sub_module" descr="Indicates start offset of rx_lane, tx_lane inside the modules lanes in 8x granularity. relevant for modules with more than 8 lanes. such as OE.\;0: lanes_0-7\;1: lanes_8_15\;2: lanes_16_23\;3: lanes_24_31" access="RW" offset="0x0.12" size="0x0.2" />
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 1016." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2743, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3125" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 1019." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_dpa_apps_info_ext" descr="" size="0x70.0" >
	...
	<field name="dpa_app_metadata" descr="DPA metadata, see Table 2757, &quot;MCQI DPA_APP_METADATA Layout,&quot; on page 3134" subnode="mcqi_dpa_metadata_ext" access="RO" offset="0x8.0" size="0x68.0" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2743, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3125\;VERSION - See Table 2745, &quot;MCQI VERSION Info Layout,&quot; on page 3127\;ACTIVATION_METHOD - See Table 2749, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 3129\;LINKX_PROPERTIES - See Table 2751, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 3130\;CLOCK_SOURCE_PROPERTIES - See Table 2753, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 3132\;DPA_APPS_INFO - See Table 2755, &quot;MCQI DPA_APPS_INFO Layout,&quot; on page 3133" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2747, &quot;Date-Time Layout,&quot; on page 3128" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2747, &quot;Date-Time Layout,&quot; on page 3128" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mdps_reg_ext" descr="" size="0x10.0" >
	...
	<field name="stressors_params" descr="Layout is according to stressor_type value:\;For over voltage seeTable 2848, &quot;Over Voltage Stressor Parameters Layout,&quot; on page 3200\;For under voltage seeTable 2850, &quot;Under Voltage Stressor Parameters Layout,&quot; on page 3200\;" subnode="mdps_reg_stressors_params_auto_ext" access="RW" offset="0x8.0" size="0x8.0" />
</node>
...
<node name="mdtr_reg_ext" descr="" size="0xb0.0" >
	...
	<field name="event_params" descr="event parameters - layout is according to event_id value:\;See Table 2844, &quot;Event_params cvb_config_error Layout,&quot; on page 3198" subnode="mdtr_reg_event_params_auto_ext" access="RW" offset="0x10.0" size="0xa0.0" union_selector="$(parent).event_id" />
</node>
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2771, &quot;Hardware Info Layout,&quot; on page 3147" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2774, &quot;Firmware Info Layout,&quot; on page 3150" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2776, &quot;Software Info Layout,&quot; on page 3153\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2780, &quot;Development Info Layout,&quot; on page 3157" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2773, &quot;Device HW Revision Descriptions,&quot; on page 3149" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  1019\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2584, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2995" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2876, &quot;Configuration Item Header Layout,&quot; on page 3217)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2878, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3221\;Table 2880, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3221\;Table 2882, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3222\;Table 2884, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3222\;Table 2886, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3223\;Table 2888, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3223\;\;Table 2892, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3225" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 26, &quot;PCIe Performance Counters Data Layout,&quot; on page 328\;Table 32, &quot;PCIE Physical Layer Indication Layout,&quot; on page 335\;Table 34, &quot;PCIe Performance Counters 2 Data Layout,&quot; on page 336" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x40.0" >
	<field name="error_type" descr="Error type selector.\;See at Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="DPNv" descr="DPN version\;0: multi_topology_unaware_sw\;1: multi_topology_aware_sw" access="INDEX" enum="multi_topology_unaware_sw=0x0,multi_topology_aware_sw=0x1" offset="0x0.30" size="0x0.1" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_param3_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.16" size="0x0.4" />
	<field name="error_param2_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.20" size="0x0.4" />
	<field name="error_param1_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.24" size="0x0.4" />
	<field name="error_param0_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.28" size="0x0.4" />
	<field name="error_params_0" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  352." access="RW" offset="0x1C.0" size="0x4.0" />
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 29.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1862\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1727, &quot;DPA_CAP Capability Layout,&quot; on page 2035" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="buffer" descr="Configuring per-buffer parameters. i=0..9.\;See Table 2375, &quot;BufferX Register Layout,&quot; on page 2762" subnode="bufferx_reg_ext" access="RW" high_bound="9" low_bound="0" offset="0xC.0" size="0x50.0" />
	<field name="shared_headroom_pool" descr="Configuring shared headroom pool parameters. Using the same layout as in BufferX.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit).\;See Table 2375, &quot;BufferX Register Layout,&quot; on page 2762" subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM.\;See Table 2375, &quot;BufferX Register Layout,&quot; on page 2762" subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>

<node name="pbsr_reg_ext" descr="" size="0x64.0" >
	<field name="buffer_type" descr="Valid only for 8x port setting (see Table 1869, &quot;PMLP - Ports Module to Local Port Register Fields,&quot; on page 2212)\;1: Main buffer\;2: Secondary buffer" access="INDEX" offset="0x0.0" size="0x0.2" />
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pcnr_reg_ext" descr="" size="0xc.0" >
	...
	<field name="flua_cap" descr="When set, indicates if flu_always, flua_guar_sec, flua_polling_sec, flua_allowed_ber is supported and configurable, flu_always_oper" access="RO" offset="0x0.2" size="0x0.1" />
	<field name="flua_we_mask" descr="Bitmask for all flua fiels. When bit is set in mask, the relevant field configuration is valid. otherwise, field ignores the value.\;Bit 0: flua_en\;bit 1: flua_allowed_ber\;Bit 2: flua_polling_sec\;Bit 3: flua_guar_sec" access="WO" offset="0x0.3" size="0x0.4" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
	...
	<field name="flua_oper" descr="Valid only if flua_cap is set.\;Fast link Up always operational satus\;0: fast_linkup_always_enabled\;1: fast_linkup_always_disabled" access="RO" enum="fast_linkup_always_enabled=0x0,fast_linkup_always_disabled=0x1" offset="0x4.6" size="0x0.2" />
...
<node name="pddr_c2p_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="core_to_phy_link_nvlink_enabled" descr="NVLink protocols admin state\;see: Table  1772, &quot;PTYS - Extended Protocol NVLink - admin layout,&quot; on page  2077" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_cable_cap_nvlink_ext" descr="" size="0x4.0" >
	<field name="cable_nvlink_proto_cap" descr="Cable NVLink protocols cap:\;See: Table  1770, &quot;PTYS - Extended Protocol NVLink - cap/oper layout,&quot; on page  2076" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_link_active_nvlink_ext" descr="" size="0x4.0" >
	<field name="link_nvlink_active" descr="NVLink protocols active\;See: Table  1770, &quot;PTYS - Extended Protocol NVLink - cap/oper layout,&quot; on page  2076" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  2044, &quot;PDDR - Phy Manager Link Enabled IB layout,&quot; on page  2408\;For Ethernet: Table  2046, &quot;PDDR - Phy Manager Link Enabled Eth layout,&quot; on page  2409\;For NVLink: Table  2048, &quot;PDDR - Phy Manager Link Enable NVLink layout,&quot; on page  2409" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  2050, &quot;PDDR - Core2phy Link Enabled IB layout,&quot; on page  2410\;For Ethernet: Table  2052, &quot;PDDR - Core2phy Link Enabled Eth layout,&quot; on page  2411\;For NVLink: Table  2054, &quot;PDDR - Core2phy Link Enabled NVLink layout,&quot; on page  2411" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="cable_proto_cap" descr="For IB: Table  2056, &quot;PDDR - Cable Cap IB layout,&quot; on page  2412\;For Ethernet: Table  2058, &quot;PDDR - Cable Cap Eth layout,&quot; on page  2413\;For NVLink: Table  2060, &quot;PDDR - Cable Cap NVLink layout,&quot; on page  2413" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="link_active" descr="For IB: Table  2062, &quot;PDDR - Link Active IB layout,&quot; on page  2414\;For Ethernet: Table  2064, &quot;PDDR - Link Active Eth layout,&quot; on page  2414\;For NVLink: Table  2066, &quot;PDDR - Link Active NVLink layout,&quot; on page  2415" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="pd_link_enabled" descr="For IB: Table  2068, &quot;PDDR - Parallel Detect Link Enabled IB Layout,&quot; on page  2416\;For Ethernet: Table  2070, &quot;PDDR - Parallel Detect Link Enabled Eth Layout,&quot; on page  2416" subnode="pddr_operation_info_page_pd_link_enabled_auto_ext" access="RO" offset="0x24.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="phy_hst_link_enabled" descr="For IB: Table  2072, &quot;PDDR - HST Link Enabled IB Layout,&quot; on page  2417\;For Ethernet: Table  2074, &quot;PDDR - HST Link Enabled Eth Layout,&quot; on page  2418" subnode="pddr_operation_info_page_phy_hst_link_enabled_auto_ext" access="RO" offset="0x28.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="eth_an_link_enabled" descr="Table  2076, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2418" access="RO" offset="0x2C.0" size="0x4.0" />
	<field name="test_mode_fsm_state" descr="Test mode FSM state exposure is supported only if PCAM.feature_cap_mask bit 120 is set.\;bidi test mode FSM\;0: Disable - this state is shared by bidi and simplex test mode FSM\;1: Open_lane\;2: Idle\;3: Close_lane\;- simplex test mode FSM\;4: Receiver_detect\;5. Idle_simplex\;6. Signal_detect\;7. Auto_fix_reversal_polarity\;8. Tuning" access="RO" enum="Disable=0x0,Open_lane=0x1,Idle=0x2,Close_lane=0x3,Receiver_detect=0x4" offset="0x38.24" size="0x0.8" />
</node>
...
<node name="pddr_phy_manager_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="phy_manager_link_nvlink_enabled" descr="NVLink protocols admin state: \;see: Table  1772, &quot;PTYS - Extended Protocol NVLink - admin layout,&quot; on page  2077" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  2042, &quot;Operation Info Page Layout,&quot; on page  2398\;Table  2086, &quot;Troubleshooting info Page layout,&quot; on page  2459\;Table  2078, &quot;Phy Info Page Layout,&quot; on page  2419\;Table  2084, &quot;Module Info Page Layout,&quot; on page  2442\;Table  2080, &quot;Link Down Info Page Layout,&quot; on page  2436\;Table  2096, &quot;Link Up Info Page Layout,&quot; on page  2472\;Table  2098, &quot;Module Latched Flag Info Page Layout,&quot; on page  2476\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  2088, &quot;PDDR - Monitor opcodes layout,&quot; on page  2460" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_Laser_Monitors_Properties_ext" descr="" size="0xf8.0" >
	<field name="laser_monitor_cap" descr="Laser monitor group capability mask:\;Bit 0: laser_age\;Bit 1: tec_current\;Bit 2: laser_frequency_error\;Bit 3: cooled_laser_temperature" access="RO" enum="laser_age=0x1,tec_current=0x2,laser_frequency_error=0x4,cooled_laser_temperature=0x8" offset="0x0.16" size="0x0.16" />
...
<node name="pemi_Laser_Monitors_Samples_ext" descr="" size="0xf8.0" >
	...
	<field name="tec_current_laser1" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x10.0" size="0x0.16" />
	<field name="tec_current_laser0" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x10.16" size="0x0.16" />
	<field name="tec_current_laser3" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x14.0" size="0x0.16" />
	<field name="tec_current_laser2" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x14.16" size="0x0.16" />
	<field name="tec_current_laser5" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x18.0" size="0x0.16" />
	<field name="tec_current_laser4" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x18.16" size="0x0.16" />
	<field name="tec_current_laser7" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x1C.0" size="0x0.16" />
	<field name="tec_current_laser6" descr="Thermo-electric Cooler (TEC) current on laser &lt;i&gt;, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x1C.16" size="0x0.16" />
	...
	<field name="cooled_laser_temperature_lane1" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x40.0" size="0x0.16" />
	<field name="cooled_laser_temperature_lane0" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x40.16" size="0x0.16" />
	<field name="cooled_laser_temperature_lane3" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x44.0" size="0x0.16" />
	<field name="cooled_laser_temperature_lane2" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x44.16" size="0x0.16" />
	<field name="cooled_laser_temperature_lane5" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x48.0" size="0x0.16" />
	<field name="cooled_laser_temperature_lane4" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x48.16" size="0x0.16" />
	<field name="cooled_laser_temperature_lane7" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x4C.0" size="0x0.16" />
	<field name="cooled_laser_temperature_lane6" descr="The laser temperature for media lane &lt;i&gt;, observes the difference between the target laser temperature for laser temperature.\;The laser temperature value is in unit scale of 1/256 Celsius degrees." access="RO" offset="0x4C.16" size="0x0.16" />
	<field name="els_laser2_temperature" descr="Relevant for CPO ETH switches, when 8x port split is applied, this fields represent the ELS laser with the higher logical mapping index. ELS module laser temperature in unit scale of 1/256 Celsius degrees\;" access="RW" offset="0x50.0" size="0x0.16" />
	<field name="els_laser_temperature" descr="ELS module laser temperature in unit scale of 1/256 Celsius degrees" access="RW" offset="0x50.16" size="0x0.16" />
</node>

<node name="pemi_Module_Status_Properties_ext" descr="" size="0xf8.0" >
	<field name="module_status_cap" descr="Module Status page capability mask:\;Bit 0: voltage\;Bit 1: rx_power\;Bit 2: tx_power\;Bit 3: tx_bias\;Bit 4: temperature\;Bit 5: max_tec_power" access="RO" enum="voltage=0x1,rx_power=0x2,tx_power=0x4,tx_bias=0x8,temperature=0x10,max_tec_power=0x20" offset="0x0.16" size="0x0.16" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_select" descr="The user can select to read a sampled data page or a properties page.\;\;0: Module_Status_Samples\;1: SNR_Samples\;2: Laser_Monitors_Samples\;4: Pre_FEC_BER_Samples\;7: Laser_Source_Module_Essential_Samples\;8: Laser_Source_Module_Advanced_Samples\;9: Optical_Engine_Telemetry_Samples\;16: Module_Status_Properties\;17: SNR_Properties\;18: Laser_Monitors_Properties\;20: Pre_FEC_BER_Properties\;23: Laser_Source_Module_Essential_Properties\;24: Laser_Source_Module_Advanced_Properties\;25: Optical_Engine_Telemetry_Properties\;All other values are reserved." access="INDEX" enum="Module_Status_Samples=0x0,SNR_Samples=0x1,Laser_Monitors_Samples=0x2,Pre_FEC_BER_Samples=0x4,Laser_Source_Module_Essential_Samples=0x7,Laser_Source_Module_Advanced_Samples=0x8,Optical_Engine_Telemetry_Samples=0x9,Module_Status_Properties=0x10,SNR_Properties=0x11,Laser_Monitors_Properties=0x12,Pre_FEC_BER_Properties=0x14,Laser_Source_Module_Essential_Properties=0x17,Laser_Source_Module_Advanced_Properties=0x18,Optical_Engine_Telemetry_Properties=0x19" offset="0x4.0" size="0x0.5" />
	...
	<field name="page_data" descr="Page data:\;Table  2256, &quot;Module Status Samples Page- Layout,&quot; on page  2652\;Table  2258, &quot;SNR Samples page - Layout,&quot; on page  2655\;Table  2260, &quot;Laser Monitors Samples page - Layout,&quot; on page  2656\;Table  2264, &quot;Pre-FEC BER Samples Page - Layout,&quot; on page  2661\;Table  2270, &quot;Laser Source Module Essential Samples Page - Layout,&quot; on page  2664\;Table 2272, &quot;Laser Source Module Advanced Samples Page - Layout,&quot; on page 2666\;Table 2274, &quot;Optical Engine Telemetry Samples Page - Layout,&quot; on page 2668\;Table  2276, &quot;Module Status Properties Page - Layout,&quot; on page  2672\;Table  2278, &quot;SNR Properties Page - Layout,&quot; on page  2675\;Table  2280, &quot;Laser Monitors Properties Page - Layout,&quot; on page  2675\;Table  2284, &quot;Pre-FEC BER Properties Page - Layout,&quot; on page  2678\;Table  2290, &quot;Laser Source Module Essential Properties page - Layout,&quot; on page  2681\;Table 2292, &quot;Laser Source Module Advanced Properties page - Layout,&quot; on page 2682\;Table 2294, &quot;Optical Engine Telemetry Properties page - Layout,&quot; on page 2683" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>

<node name="pemi_laser_source_module_advance_properties_ext" descr="" size="0xf8.0" >
	<field name="laser_source_advance_cap" descr="laser source capability mask:\;Bit 0: laser_mpd\;Bit 1: tec_voltage\;Bit 2: laser_health\;Bit 3: tec_health\;Bit 4: module_power_consumption" access="RO" offset="0x0.16" size="0x0.16" />
</node>

<node name="pemi_laser_source_module_advanced_samples_ext" descr="" size="0xf8.0" >
	<field name="laser_mpd_lane2" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0x0.0" size="0x0.16" />
	<field name="laser_mpd_lane1" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0x0.16" size="0x0.16" />
	<field name="laser_mpd_lane4" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0x4.0" size="0x0.16" />
	<field name="laser_mpd_lane3" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0x4.16" size="0x0.16" />
	<field name="laser_mpd_lane6" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0x8.0" size="0x0.16" />
	<field name="laser_mpd_lane5" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0x8.16" size="0x0.16" />
	<field name="laser_mpd_lane8" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0xC.0" size="0x0.16" />
	<field name="laser_mpd_lane7" descr="Laser MPD for lane &lt;i&gt;, in unit of 1   A.\;" access="RO" offset="0xC.16" size="0x0.16" />
...
<node name="pemi_laser_source_module_essential_properties_ext" descr="" size="0xf8.0" >
	<field name="laser_source_essential_cap" descr="laser source essential capability mask:\;Bit 0: laser_bias\;Bit 1: laser_optical_power\;" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="pemi_laser_source_module_essential_samples_ext" descr="" size="0xf8.0" >
	<field name="voltage_monitor4" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x0.0" size="0x0.8" />
	<field name="voltage_monitor3" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x0.8" size="0x0.8" />
	<field name="voltage_monitor2" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x0.16" size="0x0.8" />
	<field name="voltage_monitor1" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x0.24" size="0x0.8" />
	<field name="voltage_monitor8" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x4.0" size="0x0.8" />
	<field name="voltage_monitor7" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x4.8" size="0x0.8" />
	<field name="voltage_monitor6" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x4.16" size="0x0.8" />
	<field name="voltage_monitor5" descr="Laser voltage for laser &lt;i&gt;, in unit of 15 mV.\;" access="RO" offset="0x4.24" size="0x0.8" />
	<field name="bias_current_monitor2" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0x8.0" size="0x0.16" />
	<field name="bias_current_monitor1" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0x8.16" size="0x0.16" />
	<field name="bias_current_monitor4" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0xC.0" size="0x0.16" />
	<field name="bias_current_monitor3" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0xC.16" size="0x0.16" />
	<field name="bias_current_monitor6" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0x10.0" size="0x0.16" />
	<field name="bias_current_monitor5" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0x10.16" size="0x0.16" />
	<field name="bias_current_monitor8" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0x14.0" size="0x0.16" />
	<field name="bias_current_monitor7" descr="Laser bias for laser &lt;i&gt;, in unit of 100 mA." access="RO" offset="0x14.16" size="0x0.16" />
	<field name="opt_power_monitor2" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x18.0" size="0x0.16" />
	<field name="opt_power_monitor1" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x18.16" size="0x0.16" />
	<field name="opt_power_monitor4" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x1C.0" size="0x0.16" />
	<field name="opt_power_monitor3" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x1C.16" size="0x0.16" />
	<field name="opt_power_monitor6" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x20.0" size="0x0.16" />
	<field name="opt_power_monitor5" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x20.16" size="0x0.16" />
	<field name="opt_power_monitor8" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x24.0" size="0x0.16" />
	<field name="opt_power_monitor7" descr="Laser optical power for laser &lt;i&gt;, in unit of 10   W.\;" access="RO" offset="0x24.16" size="0x0.16" />
...
<node name="pemi_optical_engine_telemetry_properties_ext" descr="" size="0xf8.0" >
	<field name="optical_engine_telemetry_cap" descr="Optical engine Capability mask:\;bit 0: heater_voltage\;bit 1: photocurrent\;bit 2: tx_cm_cathode_voltage\;bit 3: tx_cm_anode_voltage\;bit 4: rx_voa_xpol_voltage\;bit 5: rx_voa_ypol_voltage" access="RO" enum="heater_voltage=0x1,photocurrent=0x2,tx_cm_cathode_voltage=0x4,tx_cm_anode_voltage=0x8,rx_voa_xpol_voltage=0x10,rx_voa_ypol_voltage=0x20" offset="0x0.24" size="0x0.8" />
</node>

<node name="pemi_optical_engine_telemetry_samples_ext" descr="" size="0xf8.0" >
...
<node name="pemi_page_data_auto_ext" descr="" attr_is_union="1" size="0xf8.0" >
	...
	<field name="pemi_optical_engine_telemetry_properties_ext" descr="" subnode="pemi_optical_engine_telemetry_properties_ext" offset="0x0.0" selected_by="Optical_Engine_Telemetry_Properties" size="0xf8.0" />
	<field name="pemi_optical_engine_telemetry_samples_ext" descr="" subnode="pemi_optical_engine_telemetry_samples_ext" offset="0x0.0" selected_by="Optical_Engine_Telemetry_Samples" size="0xf8.0" />
</node>
...
<node name="plcc_reg_ext" descr="" size="0x10.0" >
	...
	<field name="page_data" descr="Table  2360, &quot;High symbol error rate configuration Page Layout,&quot; on page  2728\;Table  2362, &quot;High bit error rate configuration Page Layout,&quot; on page  2728" subnode="plcc_reg_page_data_auto_ext" access="RW" offset="0x8.0" size="0x8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="plds_ext" descr="" size="0x18.0" >
	...
	<field name="rs_fec_uncor_th" descr="Link drop trigger for number of uncorrectable FEC blocks in a 128 fec block window threshold.\;If threshold is crossed, link will be dropped or trigger recovery flow.\;0: FW_default\;\;On Get, when link is down, shall return the admin value to be configured. When link is up, returns operational value." access="RW" offset="0x10.0" size="0x0.7" />
	<field name="plr_csn_retry_th" descr="Link drop trigger for number of PLR retry on same CSN threshold.\;If threshold is crossed, link will be dropped or trigger recovery flow.\;0: FW_default\;On Get, when link is down, shall return the admin value to be configured. When link is up, returns operational value." access="RW" offset="0x10.16" size="0x0.9" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x40.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1886, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  2227\;Table  1890, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  2231" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1888, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  2230" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1780, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  2090\;Table  1782, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  2094\;Table  1784, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  2097\;Table  1786, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  2102\;Table  1788, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  2106\;Table  1791, &quot;Ethernet Discard Counter Group Fields,&quot; on page  2111\;Table  1792, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  2113\;Table  1796, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  2121\;Table  1808, &quot;Physical Layer Counters Data Layout,&quot; on page  2132\;Table  1798, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  2122\;Table  1812, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  2141\;Table  1804, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  2126\;Table  1806, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  2128\;Table  1814, &quot;PLR Counters Data Layout,&quot; on page  2147 \;Table  1816, &quot;RS-Histograms Data Layout,&quot; on page  2149\;Table  1820, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  2151\;Table  1822, &quot;InfiniBand General Counters Data Layout,&quot; on page  2154\;Table  1840, &quot;Physical Layer Recovery Counters Group Data Layout,&quot; on page  2186\;Table  1842, &quot;NVLink Reduction Counters Group Layout,&quot; on page  2189" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x5c.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table  2134, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page  2542" subnode="pphcr_bin_range_ext" access="RW" high_bound="18" low_bound="0" offset="0x10.0" size="0x4c.0" />
</node>

<node name="pplm_nvl6_fec_ext" descr="" size="0x18.0" >
	<field name="nvlink_fec_override_admin_1x_xdr_simplex" descr="XDR 1x simplex - NVL6 override admin bitmask (one-hot setting):\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x0.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_1x_xdr_simplex" descr="XDR 1x simplex - NVL6 override capability bitmask:\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x0.16" size="0x0.16" />
	<field name="nvlink_fec_override_admin_2x_xdr_simplex" descr="XDR 2x simplex - NVL6 override admin bitmask (one-hot set\;ting):\;Bit 1: RS_FEC_546_516_Octet_FEC_Engine\;Bit 4: RS_FEC_546_516_Quad_FEC_Engine\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 6: RS_FEC_546_516_Double_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_Double_FEC_Engine=0x40,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x4.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_2x_xdr_simplex" descr="XDR 2x simplex - NVL6 override capability bitmask:\;Bit 1: RS_FEC_546_516_Octet_FEC_Engine\;Bit 4: RS_FEC_546_516_Quad_FEC_Engine\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 6: RS_FEC_546_516_Double_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_Double_FEC_Engine=0x40,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x4.16" size="0x0.16" />
	<field name="nvlink_fec_override_admin_375g_2x_bidi" descr="375G 2x bidi - NVL6 override admin bitmask (one-hot setting):\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x8.0" size="0x0.16" />
	...
	<field name="nvlink_fec_override_admin_2x_xdr_slow" descr="XDR 2x slow - override admin bitmask (one-hot setting):\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x14.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_2x_xdr_slow" descr="XDR 2x slow - override capability bitmask:\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x14.16" size="0x0.16" />
</node>
...
<node name="pplm_reg_ext" descr="" size="0x80.0" >
	...
	<field name="fec_page_data" descr="Table  1934, &quot;PPLM - NVL6 Rates FEC Override Layout,&quot; on page  2304" subnode="pplm_reg_fec_page_data_auto_ext" access="RW" offset="0x68.0" size="0x18.0" union_selector="$(parent).fec_generation" />
</node>
...
<node name="pplr_reg_ext" descr="" size="0x8.0" >
	...
	<field name="lb_link_mode_idx" descr="Index for link mode type configuration\;0: Simplex_rate\;1: Bidi_rate - when setting a test mode loopback with a bidi rate, It is required to specify this in PPRT.bidir_idx and PPTT.bidir_idx by choosing the &quot;bidir_loopback&quot; enum." access="INDEX" offset="0x4.31" size="0x0.1" />
</node>
...
<node name="pptt_reg_ext" descr="" size="0x1c.0" >
	...
	<field name="lane_rate_cap" descr="Per lane rate capability (bitmask)\;Bit 0 - 1GE (1.25 Gb/s) / Gen 1 PCIe (2.5 Gb/s)\;Bit 1 - SDR (2.5 Gb/s) / Gen 2 PCIe (5 Gb/s)\;Bit 2 - XAUI/2.5GE (3.125 Gb/s) / Gen 3 PCIe (8 Gb/s)\;Bit 3- DDR (5 Gb/s) / Gen 4 PCIe (16 Gb/s)\;Bit 4- QDR (10 Gb/s) / Gen 5 PCIe (32 Gb/s)\;Bit 5- FDR10 / 10GE/40GE (10.3125 Gb/s) / Gen 5 PCIe (64 Gb/s PAM4, 32Gbd)\;Bit 6- FDR (14.0625 Gb/s) \;Bit 7- EDR / 25GE / 50GE / 100GE (25.78125 Gb/s) \;Bit 8 - 50GE-KR4 (12.89 Gb/s) \;Bit 9 - HDR /50GE / 100GE / 200GE / 400GE (26.5625Gbd / 53.125Gb/s) \;Bit 10 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;Bit 11 - XDR / NVL6 / 200G_1x_simplex (106.25Gbd / 212.5Gb/s)\;Bit 12 - NVL6 / NVL7 / 337p5G_2x_bidi / 168p75G_1x_bidi (90 Gbd / 180Gb/s)\;Bit 13 - NVL6 / NVL7 / 375G_2x_bidi / 175p5_1x_bidi (100 Gbd / 200Gb/s)\;Bit 14 - NVL6 / NVL7 / 330G_2x_bidi / 153p75G_1x_bidi (82 Gbd / 164 Gb/s)\;\;Note: PCIe speeds are relevant when pnat = 3 only\;" access="RO" offset="0xC.16" size="0x0.16" />
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1860, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  2205" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="ptasv2_reg_ext" descr="" size="0x30.0" >
	...
	<field name="page_data" descr="Table 2000, &quot;PTASv2 - Phy Tuning Algorithm Settings Register Layout for 7nm and 5nm,&quot; on page 2365" subnode="ptasv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x8.0" size="0x28.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1854, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  2202\;Table  1856, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  2203" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qeec_ext" descr="" size="0x20.0" >
	...
	<field name="element_hierarchy" descr="The hierarchy of the element\;0: Port - host\;1: Group\;2: Sub_Group - subgroup of queues. \;3: Traffic_Class - VoQ queue" access="INDEX" enum="Port=0x0,Group=0x1,Sub_Group=0x2,Traffic_Class=0x3" offset="0x4.16" size="0x0.4" />
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  1121, &quot;qpdpm_dscp Layout,&quot; on page  1452" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1127, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section  29.11, &quot;Resource Dump,&quot; on page  1906." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sbcm_ext" descr="" size="0x28.0" >
	...
	<field name="local_port" descr="Local port number\;\;\;\;" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="modi" descr="[Spectrum-6][DWIP]\;Modification descriptor.\;Applicable on Query only, reserved otherwise.\;On egress (dir=1), only buff_occupancy is valid.\;Mutual exclusive with desc=1.\;Supported from Spectrum-6." access="INDEX" offset="0x0.29" size="0x0.1" />
...
<node name="sbpr_ext" descr="" size="0x18.0" >
	...
	<field name="modi" descr="[Spectrum-6][DWIP]\;Modification descriptor pool.\;Applicable with dir=0 (ingress), reserved otherwise.\;Mutual exclusive with desc=1.\;Supported from Spectrum-6." access="INDEX" offset="0x0.29" size="0x0.1" />
...
<node name="sllm_reg_ext" descr="" size="0x30.0" >
	...
	<field name="pnat" descr="Port number access type. determines the way local_port is interpreted:\;0 - Local port number\;1 - IB port number\;3 - Out of band / PCI" access="INDEX" offset="0x0.14" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="version" descr="3: prod_16nm\;4: prod_7nm\;5: prod_5nm - (Uphy 7.0/ 7.5)\;6: prod_3nm - (Uphy 8)" access="RO" enum="prod_16nm=0x3,prod_7nm=0x4,prod_5nm=0x5,prod_3nm=0x6" offset="0x0.24" size="0x0.4" />
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2200, &quot;SLLM - SerDes Lane Link Maintenance Register Layout for 5nm and 3nm,&quot; on page  2608" subnode="sllm_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x2c.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  2188, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2600\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  2190, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2601\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	<field name="all_lanes" descr="Set 1 for all lanes measurement page.\;Supported if PCAM.feature_cap_mask bit 91 is set. \;Relevant only for 5nm\;0: per_lane_measurement\;1: all_lane_measurement" access="INDEX" enum="per_lane_measurement=0x0,all_lane_measurement=0x1" offset="0x0.1" size="0x0.1" />
	...
	<field name="local_port" descr="Local port number.\;" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="version" descr="0: prod_40nm\;1: prod_28nm\;3: prod_16nm\;4: prod_7nm\;5: prod_5nm - (Uphy 7.0/ 7.5)\;6: prod_3nm - (Uphy 8)" access="RO" enum="prod_40nm=0x0,prod_28nm=0x1,prod_16nm=0x3,prod_7nm=0x4,prod_5nm=0x5,prod_3nm=0x6" offset="0x0.24" size="0x0.4" />
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1980, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2349\;Table 1982, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page 2351\;Table 1984, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page 2353\;Table 1986, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page 2355\;Table 1994, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2359\;Table 1996, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 3nm,&quot; on page 2360" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="slrg_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x24.0" >
	...
	<field name="slrg_3nm_ext" descr="" subnode="slrg_3nm_ext" condition="(($(parent).port_type == Network_Port | $(parent).port_type == Internal_IC_LR_Port  | $(parent).port_type == NearEnd_Port  | $(parent).port_type == FarEnd_Port) AND ($(parent).version == prod_3nm))" offset="0x0.0" size="0x18.0" />
...
<node name="sltp_3nm_ext" descr="" size="0x48.0" >
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="lane_speed" descr="Reserved for PCIe.\;The lane speed for TX settings:\;0 - SDR / Gen1 (PCIe)\;1 - DDR / Gen2 (PCIe) / 5GBASE-R\;2 - QDR / Gen3 (PCIe)\;3 - FDR10 (10GE / 40GE)\;4 - FDR (56GE) / Gen4 (PCIe)\;5 - EDR (25GE / 50GE / 100GE) / Gen5 (PCIe)\;6 - HDR (50GE / 200GE / 400GE)\;7 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;8 - XDR (106.25 Gbd / 212.5Gb/s)\;9 - Reserved\;10 - 1GE\;11 - 2.5GE (XAUI)\;12 - 50GE-KR4\;13 - NVL6 / NVL7 / 337p5G_2x_bidi / 168p75G_1x_bidi (90 Gbd / 180Gb/s)\;14 - NVL6 / NVL7 / 375G_2x_bidi / 175p5_1x_bidi (100 Gbd / 200Gb/s)\;15 - NVL6 / NVL7 / 330G_2x_bidi / 153p75G_1x_bidi (82 Gbd / 164 Gb/s)" access="RW" offset="0x0.4" size="0x0.4" />
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="conf_mod" descr="Set configuration mode for 7nm/5nm product.\;0: tx_linear - when set, tx taps are configured from\;for 7nm\;Table  1964, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2332\;For 5nm\;Table  1968, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2336\;LUT table fields are ignored\;1: tx_lut - when set, tx taps are configured from\;Table  1966, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2333\;7nm_fir_taps page fields are ignored." access="OP" enum="tx_linear=0x0,tx_lut=0x1" offset="0x0.12" size="0x0.1" />
	...
	<field name="pnat" descr="Port number access type. determines the way local_port is interpreted:\;0 - Local port number\;1 - IB port number\;3 - Out of band / PCI" access="INDEX" offset="0x0.14" size="0x0.2" />
	<field name="local_port" descr="Local port number [7:0]" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="version" descr="0: prod_40nm\;1: prod_28nm\;3: prod_16nm\;4: prod_7nm\;5: prod_5nm - (UPHY 7.0/7.5)\;6: prod_3nm - (UPHY 8.0)7: prod_lut_7nm" access="RO" enum="prod_40nm=0x0,prod_28nm=0x1,prod_16nm=0x3,prod_7nm=0x4,prod_5nm=0x5,prod_3nm=0x6" offset="0x0.24" size="0x0.4" />
	...
	<field name="page_data" descr="Table  1958, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2329\;Table  1960, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2330\;Table  1964, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2332\;Table  1966, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2333\;Table  1968, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2336Table  1970, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 3nm,&quot; on page  2339" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltp_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x48.0" >
	...
	<field name="sltp_3nm_ext" descr="" subnode="sltp_3nm_ext" condition="($(parent).port_type == Network_Port | $(parent).port_type == Internal_IC_LR_Port) AND ($(parent).version == prod_3nm)" offset="0x0.0" size="0x48.0" />
...
<node name="sltpv2_lut_3nm_ext" descr="" size="0x108.0" >
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="port_type" descr="For HCA supported only when indicated by PCAM \;0: Network_Port\;1: NearEnd_Port - (For Retimer/Gearbox - Host side)\;2: Internal_IC_LR_Port \;3: FarEnd_Port - (For Retimer/Gearbox - Line side)\;\;" access="INDEX" enum="Network_Port=0x0,NearEnd_Port=0x1,Internal_IC_LR_Port=0x2,FarEnd_Port=0x3" offset="0x0.1" size="0x0.3" />
	<field name="lane_speed" descr="Reserved for PCIe.\;The lane speed for TX settings:\;0 - SDR / Gen1 (PCIe)\;1 - DDR / Gen2 (PCIe) / 5GBASE-R\;2 - QDR / Gen3 (PCIe)\;3 - FDR10 (10GE / 40GE)\;4 - FDR (56GE) / Gen4 (PCIe)\;5 - EDR (25GE / 50GE / 100GE) / Gen5 (PCIe)\;6 - HDR (50GE / 200GE / 400GE)\;7 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;8 - XDR NVL6 / 200G_1x_simplex (106.25 Gbd / 212.5Gb/s)\;9 - Reserved\;10 - 1GE\;11 - 2.5GE (XAUI)\;12 - 50GE-KR4\;13 - NVL6 / NVL7 / 337p5G_2x_bidi / 168p75G_1x_bidi (90 Gbd / 180Gb/s)\;14 - NVL6 / NVL7 / 375G_2x_bidi / 175p5_1x_bidi (100 Gbd / 200Gb/s)\;15 - NVL6 / NVL7 / 330G_2x_bidi / 153p75G_1x_bidi (82 Gbd / 164 Gb/s)" access="RW" offset="0x0.4" size="0x0.4" />
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="tx_policy" descr="Configures Tx parameter set policy\;0 - Tx parameters will be set according to best possible configuration chosen by the system\;1 - Tx parameters will be set according to Data Base only and will not be overridden by link training (e.g KR-Startup)" access="RW" offset="0x0.13" size="0x0.1" />
	<field name="pnat" descr="Port number access type. determines the way local_port is interpreted:\;0 - Local port number\;1 - IB port number" access="INDEX" offset="0x0.14" size="0x0.2" />
	<field name="local_port" descr="Local port number [7:0]" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="version" descr="5: prod_5nm\;6: prod_3nm" access="RO" enum="prod_5nm=0x5,prod_3nm=0x6" offset="0x0.24" size="0x0.4" />
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  1974, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2345\;Table  1976, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 3nm,&quot; on page  2346" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>

<node name="sltpv2_reg_page_data_auto_ext" descr="" attr_is_union="1" is_conditional="1" size="0x108.0" >
	<field name="sltpv2_lut_3nm_ext" descr="" subnode="sltpv2_lut_3nm_ext" condition="($(parent).port_type == Network_Port | $(parent).port_type == Internal_IC_LR_Port  | $(parent).port_type == NearEnd_Port  | $(parent).port_type == FarEnd_Port) AND ($(parent).version == prod_3nm)" offset="0x0.0" size="0x108.0" />
