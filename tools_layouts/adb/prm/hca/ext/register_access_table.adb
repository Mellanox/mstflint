...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2746, &quot;MRFV entry - CVB Layout,&quot; on page 3113\;See Table 2748, &quot;MRFV entry - ULT Layout,&quot; on page 3115\;See Table 2750, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 3116\;See Table 2752, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 3117\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2540, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2947" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2818, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3162\;Table 2820, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3162\;Table 2822, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3163\;Table 2824, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3163\;Table 2826, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3164\;Table 2828, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3164\;\;Table 2830, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 3165\;Table 2832, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3166" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 386, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 734 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 992." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2687, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3070" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 995." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_dpa_apps_info_ext" descr="" size="0x70.0" >
	...
	<field name="dpa_app_metadata" descr="DPA metadata, see Table 2701, &quot;MCQI DPA_APP_METADATA Layout,&quot; on page 3079" subnode="mcqi_dpa_metadata_ext" access="RO" offset="0x8.0" size="0x68.0" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2687, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 3070\;VERSION - See Table 2689, &quot;MCQI VERSION Info Layout,&quot; on page 3072\;ACTIVATION_METHOD - See Table 2693, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 3074\;LINKX_PROPERTIES - See Table 2695, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 3075\;CLOCK_SOURCE_PROPERTIES - See Table 2697, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 3077\;DPA_APPS_INFO - See Table 2699, &quot;MCQI DPA_APPS_INFO Layout,&quot; on page 3078" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2691, &quot;Date-Time Layout,&quot; on page 3073" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2691, &quot;Date-Time Layout,&quot; on page 3073" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mdps_reg_ext" descr="" size="0x10.0" >
	...
	<field name="stressors_params" descr="Layout is according to stressor_type value:\;For over voltage seeTable 2788, &quot;Over Voltage Stressor Parameters Layout,&quot; on page 3141\;For under voltage seeTable 2790, &quot;Under Voltage Stressor Parameters Layout,&quot; on page 3141\;" subnode="mdps_reg_stressors_params_auto_ext" access="RW" offset="0x8.0" size="0x8.0" />
</node>
...
<node name="mdtr_reg_ext" descr="" size="0xb0.0" >
	...
	<field name="event_params" descr="event parameters - layout is according to event_id value:\;See Table 2784, &quot;Event_params cvb_config_error Layout,&quot; on page 3139" subnode="mdtr_reg_event_params_auto_ext" access="RW" offset="0x10.0" size="0xa0.0" union_selector="$(parent).event_id" />
</node>
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2715, &quot;Hardware Info Layout,&quot; on page 3092" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2718, &quot;Firmware Info Layout,&quot; on page 3095" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2720, &quot;Software Info Layout,&quot; on page 3098\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2724, &quot;Development Info Layout,&quot; on page 3101" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2717, &quot;Device HW Revision Descriptions,&quot; on page 3094" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  995\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2528, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2940" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2816, &quot;Configuration Item Header Layout,&quot; on page 3158)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2818, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3162\;Table 2820, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3162\;Table 2822, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3163\;Table 2824, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3163\;Table 2826, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3164\;Table 2828, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3164\;\;Table 2832, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3166" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 26, &quot;PCIe Performance Counters Data Layout,&quot; on page 309\;Table 32, &quot;PCIE Physical Layer Indication Layout,&quot; on page 317\;Table 34, &quot;PCIe Performance Counters 2 Data Layout,&quot; on page 317" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x40.0" >
	<field name="error_type" descr="Error type selector.\;See at Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="DPNv" descr="DPN version\;0: multi_topology_unaware_sw\;1: multi_topology_aware_sw" access="INDEX" enum="multi_topology_unaware_sw=0x0,multi_topology_aware_sw=0x1" offset="0x0.30" size="0x0.1" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_param3_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.16" size="0x0.4" />
	<field name="error_param2_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.20" size="0x0.4" />
	<field name="error_param1_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.24" size="0x0.4" />
	<field name="error_param0_cap" descr="when applicable error param0 capability mask based on Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333\;Invalid when the error_type is not supported as indicated in the error_trpe_cap." access="RO" offset="0xC.28" size="0x0.4" />
	<field name="error_params_0" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table  48, &quot;MPEINJ Error List and Params,&quot; on page  333." access="RW" offset="0x1C.0" size="0x4.0" />
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 29.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1825\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1699, &quot;DPA_CAP Capability Layout,&quot; on page 1998" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="buffer" descr="Configuring per-buffer parameters. i=0..9.\;See Table 2321, &quot;BufferX Register Layout,&quot; on page 2706" subnode="bufferx_reg_ext" access="RW" high_bound="9" low_bound="0" offset="0xC.0" size="0x50.0" />
	<field name="shared_headroom_pool" descr="Configuring shared headroom pool parameters. Using the same layout as in BufferX.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit).\;See Table 2321, &quot;BufferX Register Layout,&quot; on page 2706" subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM.\;See Table 2321, &quot;BufferX Register Layout,&quot; on page 2706" subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>

<node name="pbsr_reg_ext" descr="" size="0x64.0" >
	<field name="buffer_type" descr="Valid only for 8x port setting (see Table 1841, &quot;PMLP - Ports Module to Local Port Register Fields,&quot; on page 2175)\;1: Main buffer\;2: Secondary buffer" access="INDEX" offset="0x0.0" size="0x0.2" />
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pddr_c2p_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="core_to_phy_link_nvlink_enabled" descr="NVLink protocols admin state\;see: Table  1744, &quot;PTYS - Extended Protocol NVLink - admin layout,&quot; on page  2040" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_cable_cap_nvlink_ext" descr="" size="0x4.0" >
	<field name="cable_nvlink_proto_cap" descr="Cable NVLink protocols cap:\;See: Table  1742, &quot;PTYS - Extended Protocol NVLink - cap/oper layout,&quot; on page  2039" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_link_active_nvlink_ext" descr="" size="0x4.0" >
	<field name="link_nvlink_active" descr="NVLink protocols active\;See: Table  1742, &quot;PTYS - Extended Protocol NVLink - cap/oper layout,&quot; on page  2039" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  2010, &quot;PDDR - Phy Manager Link Enabled IB layout,&quot; on page  2365\;For Ethernet: Table  2012, &quot;PDDR - Phy Manager Link Enabled Eth layout,&quot; on page  2366\;For NVLink: Table  2014, &quot;PDDR - Phy Manager Link Enable NVLink layout,&quot; on page  2366" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  2016, &quot;PDDR - Core2phy Link Enabled IB layout,&quot; on page  2367\;For Ethernet: Table  2018, &quot;PDDR - Core2phy Link Enabled Eth layout,&quot; on page  2368\;For NVLink: Table  2020, &quot;PDDR - Core2phy Link Enabled NVLink layout,&quot; on page  2368" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="cable_proto_cap" descr="For IB: Table  2022, &quot;PDDR - Cable Cap IB layout,&quot; on page  2369\;For Ethernet: Table  2024, &quot;PDDR - Cable Cap Eth layout,&quot; on page  2370\;For NVLink: Table  2026, &quot;PDDR - Cable Cap NVLink layout,&quot; on page  2370" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="link_active" descr="For IB: Table  2028, &quot;PDDR - Link Active IB layout,&quot; on page  2371\;For Ethernet: Table  2030, &quot;PDDR - Link Active Eth layout,&quot; on page  2371\;For NVLink: Table  2032, &quot;PDDR - Link Active NVLink layout,&quot; on page  2372" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="pd_link_enabled" descr="For IB: Table  2034, &quot;PDDR - Parallel Detect Link Enabled IB Layout,&quot; on page  2373\;For Ethernet: Table  2036, &quot;PDDR - Parallel Detect Link Enabled Eth Layout,&quot; on page  2373" subnode="pddr_operation_info_page_pd_link_enabled_auto_ext" access="RO" offset="0x24.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="phy_hst_link_enabled" descr="For IB: Table  2038, &quot;PDDR - HST Link Enabled IB Layout,&quot; on page  2374\;For Ethernet: Table  2040, &quot;PDDR - HST Link Enabled Eth Layout,&quot; on page  2375" subnode="pddr_operation_info_page_phy_hst_link_enabled_auto_ext" access="RO" offset="0x28.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="eth_an_link_enabled" descr="Table  2042, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2375" access="RO" offset="0x2C.0" size="0x4.0" />
...
<node name="pddr_phy_manager_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="phy_manager_link_nvlink_enabled" descr="NVLink protocols admin state: \;see: Table  1744, &quot;PTYS - Extended Protocol NVLink - admin layout,&quot; on page  2040" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  2008, &quot;Operation Info Page Layout,&quot; on page  2355\;Table  2052, &quot;Troubleshooting info Page layout,&quot; on page  2415\;Table  2044, &quot;Phy Info Page Layout,&quot; on page  2376\;Table  2050, &quot;Module Info Page Layout,&quot; on page  2398\;Table  2046, &quot;Link Down Info Page Layout,&quot; on page  2392\;Table  2062, &quot;Link Up Info Page Layout,&quot; on page  2429\;Table  2064, &quot;Module Latched Flag Info Page Layout,&quot; on page  2433\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  2054, &quot;PDDR - Monitor opcodes layout,&quot; on page  2416" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_Laser_Monitors_Samples_ext" descr="" size="0xf8.0" >
	...
	<field name="tec1_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x10.0" size="0x0.16" />
	<field name="tec0_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x10.16" size="0x0.16" />
	<field name="tec3_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x14.0" size="0x0.16" />
	<field name="tec2_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x14.16" size="0x0.16" />
	<field name="tec5_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x18.0" size="0x0.16" />
	<field name="tec4_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x18.16" size="0x0.16" />
	<field name="tec7_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x1C.0" size="0x0.16" />
	<field name="tec6_current" descr="Thermo-electric Cooler (TEC) current, Observes the amount of current flowing to the TEC of a cooled laser.\;TEC current presented in percentages: 100/32767 %.\;+32767 (100%) of the max current magnitude when heating\;-32767 is -100% of the max current magnitude when cooling\;" access="RO" offset="0x1C.16" size="0x0.16" />
	<field name="els_input_power_lane1" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x20.0" size="0x0.16" />
	<field name="els_input_power_lane0" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x20.16" size="0x0.16" />
	<field name="els_input_power_lane3" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x24.0" size="0x0.16" />
	<field name="els_input_power_lane2" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x24.16" size="0x0.16" />
	<field name="els_input_power_lane5" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x28.0" size="0x0.16" />
	<field name="els_input_power_lane4" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x28.16" size="0x0.16" />
	<field name="els_input_power_lane7" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x2C.0" size="0x0.16" />
	<field name="els_input_power_lane6" descr="Laser power in OE input, in units of 0.01dBm.\;" access="RO" offset="0x2C.16" size="0x0.16" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="freeze_statistics_collection" descr="Relevant for CMIS VDM statistcs observables. when raise, indicate to module to freeze internal statistics collection for exposure. When set, this field enable a host control time interval for statistics collection." access="WO" offset="0x0.26" size="0x0.1" />
	...
	<field name="page_data" descr="Page data:\;Table  2218, &quot;Module Status Samples Page- Layout,&quot; on page  2600\;Table  2220, &quot;SNR Samples page - Layout,&quot; on page  2603\;Table  2222, &quot;Laser Monitors Samples page - Layout,&quot; on page  2604\;Table  2226, &quot;Pre-FEC BER Samples Page - Layout,&quot; on page  2609\;Table  2232, &quot;Laser Source Module Essential Samples Page - Layout,&quot; on page  2612\;Table 2234, &quot;Laser Source Module Advanced Samples Page - Layout,&quot; on page 2614\;Table 2236, &quot;Optical Engine Telemetry Samples Page - Layout,&quot; on page 2617\;Table  2238, &quot;Module Status Properties Page - Layout,&quot; on page  2618\;Table  2240, &quot;SNR Properties Page - Layout,&quot; on page  2620\;Table  2242, &quot;Laser Monitors Properties Page - Layout,&quot; on page  2621\;Table  2246, &quot;Pre-FEC BER Properties Page - Layout,&quot; on page  2624\;Table  2252, &quot;Laser Source Module Essential Properties page - Layout,&quot; on page  2628\;Table 2254, &quot;Laser Source Module Advanced Properties page - Layout,&quot; on page 2629\;Table 2256, &quot;Optical Engine Telemetry Properties page - Layout,&quot; on page 2629" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pemi_laser_source_module_advanced_samples_ext" descr="" size="0xf8.0" >
	...
	<field name="tec_voltage2" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x10.0" size="0x0.16" />
	<field name="tec_voltage1" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x10.16" size="0x0.16" />
	<field name="tec_voltage4" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x14.0" size="0x0.16" />
	<field name="tec_voltage3" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x14.16" size="0x0.16" />
	<field name="tec_voltage6" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x18.0" size="0x0.16" />
	<field name="tec_voltage5" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x18.16" size="0x0.16" />
	<field name="tec_voltage8" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x1C.0" size="0x0.16" />
	<field name="tec_voltage7" descr="TEC current for TEC &lt;i&gt;, in unit of 1 mV.\;" access="RO" offset="0x1C.16" size="0x0.16" />
	<field name="health_value_tec4" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x20.0" size="0x0.8" />
	<field name="health_value_tec3" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x20.8" size="0x0.8" />
	<field name="health_value_tec2" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x20.16" size="0x0.8" />
	<field name="health_value_tec1" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x20.24" size="0x0.8" />
	<field name="health_value_tec8" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x24.0" size="0x0.8" />
	<field name="health_value_tec7" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x24.8" size="0x0.8" />
	<field name="health_value_tec6" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x24.16" size="0x0.8" />
	<field name="health_value_tec5" descr="TEC health for TEC &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x24.24" size="0x0.8" />
	<field name="health_value_laser4" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x28.0" size="0x0.8" />
	<field name="health_value_laser3" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x28.8" size="0x0.8" />
	<field name="health_value_laser2" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x28.16" size="0x0.8" />
	<field name="health_value_laser1" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x28.24" size="0x0.8" />
	<field name="health_value_laser8" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x2C.0" size="0x0.8" />
	<field name="health_value_laser7" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x2C.8" size="0x0.8" />
	<field name="health_value_laser6" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x2C.16" size="0x0.8" />
	<field name="health_value_laser5" descr="Laser health for lane &lt;i&gt;, in unit of 5mV.\;" access="RO" offset="0x2C.24" size="0x0.8" />
	<field name="power_consumption" descr="Module power consumption in unit of 0.1W" access="RO" offset="0x30.16" size="0x0.16" />
</node>
...
<node name="pemi_optical_engine_telemetry_samples_ext" descr="" size="0xf8.0" >
	<field name="heater_voltage_lane" descr="Optical Engine heater voltage for lane &lt;i&gt; in unit of 1500 / 4095 mV" high_bound="7" low_bound="0" offset="0x0.16" size="0x10.0" />
	<field name="photocurrent_lane" descr="Optical Engine photo current for lane &lt;i&gt; in unit of TBD" high_bound="7" low_bound="0" offset="0x10.16" size="0x10.0" />
	<field name="tx_cm_cathode_voltage_lane" descr="Optical Engine Tx cathode common mode voltage for lane &lt;i&gt; in unit of 1500 / 4095 mV" high_bound="7" low_bound="0" offset="0x20.16" size="0x10.0" />
	<field name="tx_cm_anode_voltage_lane" descr="Optical Engine Tx anode common mode voltage for lane &lt;i&gt; in unit of 1500 / 4095 mV" high_bound="7" low_bound="0" offset="0x30.16" size="0x10.0" />
	<field name="rx_voa_xpol_voltage_lane" descr="Optical Engine Rx XPOL VOA for lane &lt;i&gt; in unit of 1500 / 4095 mV" high_bound="7" low_bound="0" offset="0x40.16" size="0x10.0" />
	<field name="rx_voa_ypol_voltage_lane" descr="Optical Engine Rx YPOL VOA for lane &lt;i&gt; in unit of 1500 / 4095 mV" high_bound="7" low_bound="0" offset="0x50.16" size="0x10.0" />
</node>
...
<node name="plcc_reg_ext" descr="" size="0x10.0" >
	...
	<field name="page_data" descr="Table  2306, &quot;High symbol error rate configuration Page Layout,&quot; on page  2669\;Table  2308, &quot;High bit error rate configuration Page Layout,&quot; on page  2669" subnode="plcc_reg_page_data_auto_ext" access="RW" offset="0x8.0" size="0x8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x40.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1858, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  2190\;Table  1862, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  2194" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1860, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  2193" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1752, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  2053\;Table  1754, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  2057\;Table  1756, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  2060\;Table  1758, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  2065\;Table  1760, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  2069\;Table  1763, &quot;Ethernet Discard Counter Group Fields,&quot; on page  2074\;Table  1764, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  2076\;Table  1768, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  2084\;Table  1780, &quot;Physical Layer Counters Data Layout,&quot; on page  2095\;Table  1770, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  2085\;Table  1784, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  2104\;Table  1776, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  2089\;Table  1778, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  2091\;Table  1786, &quot;PLR Counters Data Layout,&quot; on page  2110 \;Table  1788, &quot;RS-Histograms Data Layout,&quot; on page  2112\;Table  1792, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  2114\;Table  1794, &quot;InfiniBand General Counters Data Layout,&quot; on page  2117\;Table  1812, &quot;Physical Layer Recovery Counters Group Data Layout,&quot; on page  2149\;Table  1814, &quot;NVLink Reduction Counters Group Layout,&quot; on page  2152" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x5c.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table  2100, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page  2499" subnode="pphcr_bin_range_ext" access="RW" high_bound="18" low_bound="0" offset="0x10.0" size="0x4c.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1832, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  2168" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="ptasv2_reg_ext" descr="" size="0x30.0" >
	...
	<field name="page_data" descr="Table 1966, &quot;PTASv2 - Phy Tuning Algorithm Settings Register Layout for 7nm and 5nm,&quot; on page 2322" subnode="ptasv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x8.0" size="0x28.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1826, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  2165\;Table  1828, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  2166" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  1097, &quot;qpdpm_dscp Layout,&quot; on page  1424" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1103, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 29.11, &quot;Resource Dump&quot;, on page 1869." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sllm_reg_ext" descr="" size="0x30.0" >
	...
	<field name="status" descr="0 - invalid\;1 - valid" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table  2162, &quot;SLLM - SerDes Lane Link Maintenance Register Layout for 5nm and 3nm,&quot; on page  2556" subnode="sllm_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x2c.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  2150, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2548\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  2152, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2549\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1946, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2306\;Table 1948, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page 2308\;Table 1950, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page 2310\;Table 1952, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page 2312\;Table 1960, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2316\;Table 1962, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 3nm,&quot; on page 2317" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="conf_mod" descr="Set configuration mode for 7nm/5nm product.\;0: tx_linear - when set, tx taps are configured from\;for 7nm\;Table  1934, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2293\;For 5nm\;Table  1938, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2298\;LUT table fields are ignored\;1: tx_lut - when set, tx taps are configured from\;Table  1936, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2294\;7nm_fir_taps page fields are ignored." access="OP" enum="tx_linear=0x0,tx_lut=0x1" offset="0x0.12" size="0x0.1" />
	...
	<field name="page_data" descr="Table  1928, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2290\;Table  1930, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2291\;Table  1934, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2293\;Table  1936, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2294\;Table  1938, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2298" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  1942, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2303" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>
