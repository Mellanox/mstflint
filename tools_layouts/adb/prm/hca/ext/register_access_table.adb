...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table 1798, &quot;PDDR - Phy manager link enabled IB layout,&quot; on page 2097\;For Ethernet: Table 1800, &quot;PDDR - Phy manager link enabled Eth layout,&quot; on page 2097\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table 1802, &quot;PDDR - core2phy link enabled IB layout,&quot; on page 2098\;For Ethernet: Table 1804, &quot;PDDR - Core2Phy link enabled Eth layout,&quot; on page 2099" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table 1806, &quot;PDDR - cable cap IB layout,&quot; on page 2100\;For Ethernet: Table 1808, &quot;PDDR - cable cap Eth layout,&quot; on page 2101\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table 1810, &quot;PDDR - Link Active IB layout,&quot; on page 2102\;For Ethernet: Table 1812, &quot;PDDR - Link Active Eth layout,&quot; on page 2102" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="eth_an_link_enabled" descr="For IB: Table 1822, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page 2105" access="RO" offset="0x2C.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table 1796, &quot;Operation Info Page Layout,&quot; on page 2088\;Table 1832, &quot;Troubleshooting info Page layout,&quot; on page 2140\;Table 1824, &quot;Phy Info Page Layout,&quot; on page 2106\;Table 1830, &quot;Module Info Page Layout,&quot; on page 2127\;Table 1826, &quot;Link Down Info Page layout,&quot; on page 2121\;Table 1844, &quot;Module Latched Flag Info Page Layout,&quot; on page 2158\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table 1834, &quot;PDDR - Monitor opcodes layout,&quot; on page 2141" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table 1984, &quot;SNR Samples page - Layout,&quot; on page 2319" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table 1656, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page 1938\;Table 1660, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page 1943" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table 1658, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page 1941" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1568, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page 1831\;Table 1570, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page 1836\;Table 1572, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page 1839\;Table 1574, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page 1844\;Table 1576, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page 1848\;Table 1579, &quot;Ethernet Discard Counter Group Fields,&quot; on page 1853\;Table 1580, &quot;Ethernet Per Priority Group Data Layout,&quot; on page 1855\;Table 1584, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page 1863\;Table 1596, &quot;Physical Layer Counters Data Layout,&quot; on page 1874\;Table 1586, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page 1864\;Table 1600, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page 1884\;Table 1592, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page 1868\;Table 1594, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page 1870\;Table 1602, &quot;PLR Counters Data Layout,&quot; on page 1889 \;Table 1604, &quot;RS-Histograms Data Layout,&quot; on page 1891\;Table 1606, &quot;InfiniBand Packets Counters Data Layout,&quot; on page 1892\;Table 1608, &quot;InfiniBand General Counters Data Layout,&quot; on page 1895" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1880, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 2219" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table 1634, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page 1924" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table 1628, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page 1920\;Table 1630, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page 1921" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1740, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2045\;Table 1742, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 16nm,&quot; on page 2047\;Table 1744, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 7nm,&quot; on page 2049\;Table 1746, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 5nm,&quot; on page 2050\;Table 1754, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2054" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table 1722, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page 2030\;Table 1724, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 16nm,&quot; on page 2031\;Table 1728, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 7nm,&quot; on page 2033\;Table 1732, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 5nm,&quot; on page 2038" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table 1736, &quot;SLTPv2 - Serdes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page 2043" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>
