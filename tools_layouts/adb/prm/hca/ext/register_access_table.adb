...
<info source_doc_name="Mellanox &lt;Doc Name&gt;" source_doc_version="Rev 0.62" />
...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2684, &quot;MRFV entry - CVB Layout,&quot; on page 2988\;See Table 2686, &quot;MRFV entry - ULT Layout,&quot; on page 2990\;See Table 2688, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 2991\;See Table 2690, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 2992\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2482, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2827" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="access_reg_summary_ext" descr="" attr_is_union="1" size="0x300" >
	...
	<field name="pplm_reg" descr="" subnode="pplm_reg_ext" capability="0" offset="0x0.0" selected_by="PPLM" size="0x78" />
...
<node name="bufferx_reg_ext" descr="" size="0x8.0" >
	...
	<field name="xon_xoff_threshold_mask" descr="Mask bit indicating if xon_threshold and xoff_threshold should be updated.\;0: xon_threshold and xoff_threshold will be updated.\;1: xon_threshold and xoff_threshold will not be updated.\;\;Valid only on HCAs." access="WO" offset="0x0.31" size="0x0.1" />
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2754, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3034\;Table 2756, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3034\;Table 2758, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3035\;Table 2760, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3035\;Table 2762, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3036\;Table 2764, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3036\;\;Table 2766, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 3037\;Table 2768, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3038" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 380, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 717 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 976." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2629, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2947" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 979." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2629, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2947\;VERSION - See Table 2631, &quot;MCQI VERSION Info Layout,&quot; on page 2949\;ACTIVATION_METHOD - See Table 2635, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 2951\;LINKX_PROPERTIES - See Table 2637, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 2952\;CLOCK_SOURCE_PROPERTIES - See Table 2639, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 2954" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2633, &quot;Date-Time Layout,&quot; on page 2950" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2633, &quot;Date-Time Layout,&quot; on page 2950" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mcqs_reg_ext" descr="" size="0x10.0" >
	...
	<field name="identifier" descr="This field uniquely identifies a specific component type. \;0x1: BOOT_IMG\;0x4: OEM_NVCONFIG\;0x5: MLNX_NVCONFIG\;0x6: CS_TOKEN\;0x7: DBG_TOKEN\;0xA: Gearbox\;0xB: CC_ALGO - Congestion Control Algorithm\;0xC: LINKX_IMG\;0xD: CRYPTO_TO_COMMISSIONING\;0xE: RMCS_TOKEN\;0xF: RMDT_TOKEN\;0x10: CRCS_TOKEN \;0x11: CRDT_TOKEN \;0x12: CLOCK_SYNC_EEPROM  \;0x15: DIGITAL_CACERT - Certificate to be trusted by the device0x17: DIGITAL_CACERT_REMOVAL\;\;Other values are reserved\;[DWIP]: 0x1A: LINKX_FW_ELS\;\;0x1C: DPA_COMPONENT\;0x1D: DPA_COMPONENT_REMOVAL" access="RO" enum="BOOT_IMG=0x1,OEM_NVCONFIG=0x4,MLNX_NVCONFIG=0x5,CS_TOKEN=0x6,DBG_TOKEN=0x7,Gearbox=0xa,CC_ALGO=0xb,LINKX_IMG=0xc,CRYPTO_TO_COMMISSIONING=0xd,RMCS_TOKEN=0xe,RMDT_TOKEN=0xf,CRCS_TOKEN=0x10,CRDT_TOKEN=0x11,CLOCK_SYNC_EEPROM=0x12,DIGITAL_CACERT=0x15,DPA_COMPONENT=0x1c,DPA_COMPONENT_REMOVAL=0x1d" offset="0x4.0" size="0x0.16" />
	<field name="component_update_state" descr="Component state in update flow, see Section  10.2.1, &quot;Component Update State,&quot; on page  976:\;0x0: IDLE\;0x1: IN_PROGRESS\;0x2: APPLIED\;0x3: ACTIVE \;0x4: ACTIVE_PENDING_RESET\;0x5: FAILED\;0x6: CANCELED\;0x7: BUSY\;\;Other values are reserved" access="RO" enum="IDLE=0x0,IN_PROGRESS=0x1,APPLIED=0x2,ACTIVE=0x3,ACTIVE_PENDING_RESET=0x4,FAILED=0x5,CANCELED=0x6,BUSY=0x7" offset="0x8.0" size="0x0.4" />
...
<node name="mdps_reg_ext" descr="" size="0x10.0" >
	...
	<field name="stressors_params" descr="Layout is according to stressor_type value:\;For over voltage seeTable 2724, &quot;Over Voltage Stressor Parameters Layout,&quot; on page 3012\;For under voltage seeTable 2726, &quot;Under Voltage Stressor Parameters Layout,&quot; on page 3013\;" subnode="mdps_reg_stressors_params_auto_ext" access="RW" offset="0x8.0" size="0x8.0" />
</node>
...
<node name="mdtr_reg_ext" descr="" size="0xb0.0" >
	...
	<field name="event_params" descr="event parameters - layout is according to event_id value:\;See Table 2720, &quot;Event_params cvb_config_error Layout,&quot; on page 3011" subnode="mdtr_reg_event_params_auto_ext" access="RW" offset="0x10.0" size="0xa0.0" union_selector="$(parent).event_id" />
</node>
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2653, &quot;Hardware Info Layout,&quot; on page 2967" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2656, &quot;Firmware Info Layout,&quot; on page 2970" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2658, &quot;Software Info Layout,&quot; on page 2973\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2662, &quot;Development Info Layout,&quot; on page 2976" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2655, &quot;Device HW Revision Descriptions,&quot; on page 2969" access="RO" offset="0x0.16" size="0x0.16" />
	...
	<field name="nic_disable" descr="0: Embedded HCA PCIe endpoint enabled\;1: Embedded HCA PCIe endpoint disabled" access="RO" offset="0xC.31" size="0x0.1" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  979\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2470, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2820" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2752, &quot;Configuration Item Header Layout,&quot; on page 3030)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2754, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 3034\;Table 2756, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 3034\;Table 2758, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 3035\;Table 2760, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 3035\;Table 2762, &quot;Configuration Item Data Type Class File Layout,&quot; on page 3036\;Table 2764, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 3036\;\;Table 2768, &quot;Configuration Item Data Type Class Multi Instance Layout,&quot; on page 3038" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="module_latched_flag_info_ext" descr="" size="0x68.0" >
	...
	<field name="laser_source_flag_in_use" descr="Bitmask per flag type in ELS module.\;When bit is set, indicates that FW reads flag from module.\;In order to get reliable latched flag information for that flag, it&apos;s recommended to set event for module flags via trap.\;Bit 0: global_alarm_laser0\;Bit 1: global_alarm_laser1\;Bit 2: global_alarm_laser2\;Bit 3: global_alarm_laser3\;Bit 4: global_alarm_laser4\;Bit 5: global_alarm_laser5\;Bit 6: global_alarm_laser6\;Bit 7: global_alarm_laser7\;Bit 8: global_warning_laser0\;Bit 9: global_warning_laser1\;Bit 10: global_warning_lase2\;Bit 11: global_warning_lase3\;Bit 12: global_warning_lase4\;Bit 13: global_warning_lase5\;Bit 14: global_warning_laser6\;Bit 15: global_warning_laser7\;\;for global masking\;1b - all alarm/warning are disable for lane n (n=0 to 7) irrespective for individual alarm/warning setting.\;0b - all alarm/warning are enable for lane n (n=0 to 7) irrespective for individual alarm/warning setting.\;" access="RO" offset="0x20.0" size="0x4.0" />
	<field name="laser_bias_lo_war_cap" descr="Bit mask for ELS laser bias high alarm\;1b - Alarm interrupt is disabled\;0b - Alarm interrupt is enable\;" access="RO" offset="0x24.0" size="0x0.8" />
	<field name="laser_bias_hi_war_cap" descr="Bit mask for ELS laser bias high alarm\;1b - Alarm interrupt is disabled\;0b - Alarm interrupt is enable\;" access="RO" offset="0x24.8" size="0x0.8" />
	<field name="laser_bias_lo_al_cap" descr="Bit mask for ELS laser bias high alarm\;1b - Alarm interrupt is disabled\;0b - Alarm interrupt is enable\;" access="RO" offset="0x24.16" size="0x0.8" />
	<field name="laser_bias_hi_al_cap" descr="Bit mask for ELS laser bias high alarm\;1b - Alarm interrupt is disabled\;0b - Alarm interrupt is enable" access="RO" offset="0x24.24" size="0x0.8" />
	<field name="laser_opt_pwr_lo_war_cap" descr="Bit mask for ELS laser optical power low warning\;1b - Warning interrupt is disabled\;0b - Warning interrupt is enable\;" access="RO" offset="0x28.0" size="0x0.8" />
	<field name="laser_opt_pwr_hi_war_cap" descr="Bit mask for ELS laser optical power high warning\;1b - Warning interrupt is disabled\;0b - Warning interrupt is enable\;" access="RO" offset="0x28.8" size="0x0.8" />
	<field name="laser_opt_pwr_lo_al_cap" descr="Bit mask for ELS laser optical power low alarm\;1b - Alarm interrupt is disabled\;0b - Alarm interrupt is enable\;" access="RO" offset="0x28.16" size="0x0.8" />
	<field name="laser_opt_pwr_hi_al_cap" descr="Bit mask for ELS laser optical power high alarm\;1b - Alarm interrupt is disabled\;0b - Alarm interrupt is enable\;" access="RO" offset="0x28.24" size="0x0.8" />
	<field name="laser_bias_lo_war" descr="Thresholds for ELS laser bias, in unit of 100  A" access="RO" offset="0x2C.0" size="0x0.8" />
	<field name="laser_bias_hi_war" descr="Thresholds for ELS laser bias, in unit of 100  A" access="RO" offset="0x2C.8" size="0x0.8" />
	<field name="laser_bias_lo_al" descr="Thresholds for ELS laser bias, in unit of 100  A" access="RO" offset="0x2C.16" size="0x0.8" />
	<field name="laser_bias_hi_al" descr="Thresholds for ELS laser bias, in unit of 100  A" access="RO" offset="0x2C.24" size="0x0.8" />
	<field name="laser_opt_pwr_lo_war" descr="Thresholds for ELS laser optical power, in unit of 10  W\;" access="RO" offset="0x30.0" size="0x0.8" />
	<field name="laser_opt_pwr_hi_war" descr="Thresholds for ELS laser optical power, in unit of 10  W\;" access="RO" offset="0x30.8" size="0x0.8" />
	<field name="laser_opt_pwr_lo_al" descr="Thresholds for ELS laser optical power, in unit of 10  W\;" access="RO" offset="0x30.16" size="0x0.8" />
	<field name="laser_opt_pwr_hi_al" descr="Thresholds for ELS laser optical power, in unit of 10  W\;" access="RO" offset="0x30.24" size="0x0.8" />
	<field name="laser_fault_summery" descr="ELS laser fault summery\;bit 2 - OR&apos;ed lane fault\;bit 3 - OR&apos;ed lane warning" access="RO" offset="0x34.8" size="0x0.8" />
	<field name="warn_flag_lane" descr="ELSFP warning condition in lanes 1 to 8bit 0 - lane 0, bit 1 - lane 1, ..., bit 7 lane 7" access="RO" offset="0x34.16" size="0x0.8" />
	<field name="fault_flag_lane" descr="ELSFP fault condition in lanes 1 to 8bit 0 - lane 0, bit 1 - lane 1, ..., bit 7 lane 7" access="RO" offset="0x34.24" size="0x0.8" />
	<field name="optical_engine_flag_in_use_lsb" descr="Bitmask per flag type in OE module.\;When bit is set, indicates that FW reads flag from module.\;In order to get reliable latched flag information for that flag, it&apos;s recommended to set event for module flags via trap.\;bit 0: oe_get_pwr_up_done \;bit 1: oe_get_pwr_dn_done \;bit 2: oe_get_over_temp_low_alert\;Bit 3: oe_get_therm_fsm_done  \;Bit 4: oe_get_real_done\;Bit 5: oe_get_adc_meas_done\;Bit 6: oe_get_irq_cr2pri_error\;Bit 7: oe_get_irq_cr2pri_timeout\;Bit 8: oe_get_irq_cr2i2c_timeout\;Bit 9: oe_get_irq_efuse_rdy\;Bit 10: oe_get_irq_tx_low_els\;Bit 11: oe_get_irq_tx_high_els\;Bit 12: oe_get_irq_tx_one_time_cal_done\;Bit 13: oe_get_irq_tx_p0_cal_peakdet_rvdd_cck_viol\;Bit 14: oe_get_irq_tx_p0_cal_peakdet_rvdd_overflow\;Bit 15: oe_get_irq_tx_hs_cal_ctle_gain_fine_underflow0\;Bit 16: oe_get_irq_tx_hs_cal_ctle_gain_fine_underflow1\;Bit 17: oe_get_irq_tx_hs_cal_fbtia_fine_cal_underflow\;Bit 18: oe_get_irq_tx_hs_cal_fbtia_fine_cal_overflow\;Bit 19: oe_get_irq_tx_hs_cal_fbtia_fine_trk_underflow\;Bit 20: oe_get_irq_tx_hs_cal_fbtia_fine_trk_overflow\;Bit 21: oe_get_irq_tx_imem_chksm_fail\;Bit 22: oe_get_irq_tx_rocm\;Bit 23: oe_get_irq_tx_locm\;Bit 24: oe_get_irq_tx_nop_rs_uvf_error\;Bit 25: oe_get_irq_tx_nop_rs_ovf_error\;Bit 26: oe_get_irq_tx_nop_ds_uvf_error\;Bit 27: oe_get_irq_tx_nop_ds_ovf_error\;Bit 28: oe_get_irq_tcl_tia_vcm_cal_fail\;Bit 29: oe_get_irq_tcl_reg_cal_fail\;Bit 30: oe_get_irq_tcl_sqroot_cal_fail\;Bit 31: oe_get_irq_heatdrv_gain_cal_fail\;" access="RO" offset="0x38.0" size="0x4.0" />
	<field name="oe_get_irq_cr2pri_timeout" descr="Efuse register access timeout" access="RW" offset="0x3C.0" size="0x0.1" />
	<field name="oe_get_irq_cr2pri_error" descr="Efuse register access error" access="RO" offset="0x3C.1" size="0x0.1" />
	<field name="oe_get_adc_meas_done" descr="ADC measurement done indication.  " access="RO" offset="0x3C.2" size="0x0.1" />
	<field name="oe_get_rcal_done" descr="RCAL done indication.  " access="RO" offset="0x3C.3" size="0x0.1" />
	<field name="oe_get_therm_fsm_done" descr="Thermal FSM done indication." access="RO" offset="0x3C.4" size="0x0.1" />
	<field name="oe_get_over_temp_low_alert" descr="Over temperature low alert indication." access="RO" offset="0x3C.5" size="0x0.1" />
	<field name="oe_get_pwr_dn_done" descr="Power down done indication." access="RO" offset="0x3C.6" size="0x0.1" />
	<field name="oe_get_pwr_up_done" descr="Power up done indication." access="RO" offset="0x3C.7" size="0x0.1" />
	<field name="optical_engine_flag_in_use_msb" descr="Bitmask per flag type in OE module.\;When bit is set, indicates that FW reads flag from module.\;In order to get reliable latched flag information for that flag, it&apos;s recommended to set event for module flags via trap.\;Bit 0: oe_get_irq_tcl_tia_gain_mode_cal_fail\;Bit 1: oe_get_irq_tcl_mrm_crs_srch_fail\;Bit 2: oe_get_irq_tcl_mrm_fine_lock\;Bit 3: oe_get_irq_tcl_mrm_pi_large_input_err\;Bit 4: oe_get_irq_tcl_mrm_fine_unlock\;Bit 5: oe_get_irq_rx_high_els\;Bit 6: oe_get_irq_rx_high_agc\;Bit 7: oe_get_irq_rx_low_agc\;Bit 8: oe_get_irq_rx_one_time_cal_done\;Bit 9: oe_get_irq_rx_imem_chksm_fail\;Bit 10: oe_get_irq_rx_nop_rs_uvf_error\;Bit 11: oe_get_irq_rx_nop_rs_ovf_error\;Bit 12: oe_get_irq_rx_nop_ds_uvf_error\;Bit 13: oe_get_irq_rx_nop_ds_ovf_error\;Bit 14: oe_get_tx_tcl_lock_status\;Bit 15: oe_get_tx_hs_cal_done\;Bit 16: oe_get_rx_hs_cal_done" access="RO" offset="0x3C.8" size="0x0.24" />
	<field name="oe_get_irq_tx_one_time_cal_done" descr="Bit mask for TX complete one time calibration" access="RO" offset="0x40.0" size="0x0.8" />
	<field name="oe_get_irq_tx_high_els" descr="TX ELS power too high" access="RO" offset="0x40.8" size="0x0.8" />
	<field name="oe_get_irq_tx_low_els" descr="TX ELS power too low" access="RO" offset="0x40.16" size="0x0.8" />
	<field name="oe_get_irq_efuse_rdy" descr="Efuse sense done" access="RO" offset="0x40.30" size="0x0.1" />
	<field name="oe_get_irq_cr2i2c_timeout" descr="I2C register access timeout" access="RW" offset="0x40.31" size="0x0.1" />
	<field name="oe_get_irq_tx_hs_cal_ctle_gain_fine_underflow1" descr="Bit mask for P0.PAM4 EQ vga gain calibration" access="RO" offset="0x44.0" size="0x0.8" />
	<field name="oe_get_irq_tx_hs_cal_ctle_gain_fine_underflow0" descr="Bit mask for TX P0.PAM4 EQ vga gain calibration" access="RO" offset="0x44.8" size="0x0.8" />
	<field name="oe_get_irq_tx_p0_cal_peakdet_rvdd_overflow" descr="Bit mask for TX P0_CAL Peakdet rvdd calibration" access="RO" offset="0x44.16" size="0x0.8" />
	<field name="oe_get_irq_tx_p0_cal_peakdet_rvdd_cck_viol" descr="Bit mask for TX P0_CAL Peakdet rvdd calibration" access="RO" offset="0x44.24" size="0x0.8" />
	<field name="oe_get_irq_tx_hs_cal_fbtia_fine_trk_overflow" descr="Bit mask for TX P0.PAM4 EQ fbtia gain trk" access="RO" offset="0x48.0" size="0x0.8" />
	<field name="oe_get_irq_tx_hs_cal_fbtia_fine_trk_underflow" descr="Bit mask for TX P0.PAM4 EQ fbtia gain trk" access="RO" offset="0x48.8" size="0x0.8" />
	<field name="oe_get_irq_tx_hs_cal_fbtia_fine_cal_overflow" descr="Bit mask for TX P0.PAM4 EQ fbtia gain calibration" access="RO" offset="0x48.16" size="0x0.8" />
	<field name="oe_get_irq_tx_hs_cal_fbtia_fine_cal_underflow" descr="Bit mask for TX P0.PAM4 EQ fbtia gain calibration" access="RO" offset="0x48.24" size="0x0.8" />
	<field name="oe_get_irq_tx_nop_rs_uvf_error" descr="Bit mask for TX NOP RS underflow" access="RO" offset="0x4C.0" size="0x0.8" />
	<field name="oe_get_irq_tx_locm" descr="Bit mask for TX loss of common mode signal" access="RO" offset="0x4C.8" size="0x0.8" />
	<field name="oe_get_irq_tx_rocm" descr="Bit mask for TX return of common mode signal" access="RO" offset="0x4C.16" size="0x0.8" />
	<field name="oe_get_irq_tx_imem_chksm_fail" descr="Bit mask for TX patch IMEM&quot;s chksum failed" access="RO" offset="0x4C.24" size="0x0.8" />
	<field name="oe_get_irq_tcl_tia_vcm_cal_fail" descr="Bit mask for TCL VCM calibration fail" access="RO" offset="0x50.0" size="0x0.8" />
	<field name="oe_get_irq_tx_nop_ds_ovf_error" descr="Bit mask for TX NOP DS Overflow" access="RO" offset="0x50.8" size="0x0.8" />
	<field name="oe_get_irq_tx_nop_ds_uvf_error" descr="Bit mask for TX NOP DS underflow" access="RO" offset="0x50.16" size="0x0.8" />
	<field name="oe_get_irq_tx_nop_rs_ovf_error" descr="Bit mask for TX NOP RS Overflow" access="RO" offset="0x50.24" size="0x0.8" />
	<field name="oe_get_irq_tcl_tia_gain_mode_cal_fail" descr="Bit mask for TCL TIA gain mode calibration fail" access="RO" offset="0x54.0" size="0x0.8" />
	<field name="oe_get_irq_heatdrv_gain_cal_fail" descr="Bit mask for TCL heater driver gain calibration fail" access="RO" offset="0x54.8" size="0x0.8" />
	<field name="oe_get_irq_tcl_sqroot_cal_fail" descr="Bit mask for TCL SQROOT calibration fail" access="RO" offset="0x54.16" size="0x0.8" />
	<field name="oe_get_irq_tcl_reg_cal_fail" descr="Bit mask for TCL REG calibration fail" access="RO" offset="0x54.24" size="0x0.8" />
	<field name="oe_get_irq_tcl_mrm_fine_unlock" descr="Bit mask for TCL MRM fine unlock" access="RO" offset="0x58.0" size="0x0.8" />
	<field name="oe_get_irq_tcl_mrm_pi_large_input_err" descr="Bit mask for TX TCL fine loop PI controller input error exceeding threshold during fine search" access="RO" offset="0x58.8" size="0x0.8" />
	<field name="oe_get_irq_tcl_mrm_fine_lock" descr="Bit mask for TCL MRM fine lock" access="RO" offset="0x58.16" size="0x0.8" />
	<field name="oe_get_irq_tcl_mrm_crs_srch_fail" descr="Bit mask for TCL MRM coarse search fail" access="RO" offset="0x58.24" size="0x0.8" />
	<field name="oe_get_irq_rx_one_time_cal_done" descr="Bit mask for RX complete one time calibration" access="RO" offset="0x5C.0" size="0x0.8" />
	<field name="oe_get_irq_rx_low_agc" descr="Bit mask for RX AGC-loop underflow" access="RO" offset="0x5C.8" size="0x0.8" />
	<field name="oe_get_irq_rx_high_agc" descr="Bit mask for RX AGC-loop overflow" access="RO" offset="0x5C.16" size="0x0.8" />
	<field name="oe_get_irq_rx_high_els" descr="Bit mask for RX high AGC: RSSIP &gt; 1.2V" access="RO" offset="0x5C.24" size="0x0.8" />
	<field name="oe_get_irq_rx_nop_ds_uvf_error" descr="Bit mask for RX NOP DS underflow" access="RO" offset="0x60.0" size="0x0.8" />
	<field name="oe_get_irq_rx_nop_rs_ovf_error" descr="Bit mask for RX NOP RS Overflow" access="RO" offset="0x60.8" size="0x0.8" />
	<field name="oe_get_irq_rx_nop_rs_uvf_error" descr="Bit mask for RX NOP RS underflow" access="RO" offset="0x60.16" size="0x0.8" />
	<field name="oe_get_irq_rx_imem_chksm_fail" descr="Bit mask for RX patch IMEM&quot;s chksum is failed" access="RO" offset="0x60.24" size="0x0.8" />
	<field name="oe_get_rx_hs_cal_done" descr="Bit mask for RX high-speed calibration done" access="RO" offset="0x64.0" size="0x0.8" />
	<field name="oe_get_tx_hs_cal_done" descr="Bit mask for TX complete high speed calibration" access="RO" offset="0x64.8" size="0x0.8" />
	<field name="oe_get_tx_tcl_lock_status" descr="Bit mask for TX TCL lock status indication" access="RO" offset="0x64.16" size="0x0.8" />
	<field name="oe_get_irq_rx_nop_ds_ovf_error" descr="Bit mask for RX NOP DS Overflow" access="RO" offset="0x64.24" size="0x0.8" />
</node>
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 26, &quot;PCIe Performance Counters Data Layout,&quot; on page 303\;Table 32, &quot;PCIE Physical Layer Indication Layout,&quot; on page 311\;Table 34, &quot;PCIe Performance Counters 2 Data Layout,&quot; on page 311" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x20.0" >
	<field name="error_type" descr="Error type selector.\;See at Table 48, &quot;MPEINJ Error List and Params,&quot; on page 325 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="DPNv" descr="DPN version\;0: multi_topology_unaware_sw\;1: multi_topology_aware_sw" access="INDEX" enum="multi_topology_unaware_sw=0x0,multi_topology_aware_sw=0x1" offset="0x0.30" size="0x0.1" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table 48, &quot;MPEINJ Error List and Params,&quot; on page 325.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_params_0" descr="Error specific parameters according to Table 48, &quot;MPEINJ Error List and Params,&quot; on page 325." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table 48, &quot;MPEINJ Error List and Params,&quot; on page 325." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table 48, &quot;MPEINJ Error List and Params,&quot; on page 325." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table 48, &quot;MPEINJ Error List and Params,&quot; on page 325." access="RW" offset="0x1C.0" size="0x4.0" />
</node>
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 29.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1760\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="mvcap_reg_ext" descr="" size="0x10.0" >
	...
	<field name="sensor_map_type" descr="[DWIP]\;0: Ambient sensors, no module and no ASIC.\;" access="INDEX" offset="0x8.28" size="0x0.2" />
</node>

<node name="mvcr_ext" descr="" size="0x18.0" >
	<field name="sensor_index" descr="Sensors:\;- 0..max_system_sensors-1 are ambient sensors on the system (max_system_sensors from INI)\;[DWIP][Switch_internal]: 64..154 are mapped to modules by 1:1 e.g. module 1 is index 65\;127: Total Power Consumption\;" access="INDEX" offset="0x0.0" size="0x0.8" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1669, &quot;DPA_CAP Capability Layout,&quot; on page 1933" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="over_voltage_stressor_parameters_ext" descr="" size="0x8.0" >
	<field name="percentage_change" descr="The percentage change in 1% units\;If percentage change is over 1 percentage point or change from previous request, FW will return BAD PARAM" access="WO" offset="0x0.0" size="0x0.6" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="buffer" descr="Configuring per-buffer parameters. i=0..9.\;See Table 2255, &quot;BufferX Register Layout,&quot; on page 2610" subnode="bufferx_reg_ext" access="RW" high_bound="9" low_bound="0" offset="0xC.0" size="0x50.0" />
	<field name="shared_headroom_pool" descr="Configuring shared headroom pool parameters. Using the same layout as in BufferX.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit).\;See Table 2255, &quot;BufferX Register Layout,&quot; on page 2610" subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM.\;See Table 2255, &quot;BufferX Register Layout,&quot; on page 2610" subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>

<node name="pbsr_reg_ext" descr="" size="0x64.0" >
	<field name="buffer_type" descr="Valid only for 8x port setting (see Table 1809, &quot;PMLP - Ports Module to Local Port Register Fields,&quot; on page 2106)\;1: Main buffer\;2: Secondary buffer" access="INDEX" offset="0x0.0" size="0x0.2" />
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pcmr_reg_ext" descr="" size="0xc.0" >
	...
	<field name="encap_replace_ipv4_id_en" descr="0: ENABLE - HW overrides the ipv4 packet id field with a random value.\;1: DISABLE - encap ipv4 packet id field remains." access="RW" offset="0x8.25" size="0x0.1" />
	<field name="mpls_explicit_null_en" descr="0: ENABLE - mpls explicit null label is parsed (default behaviour). \;1: DISABLE - mpls explicit null label is skipped by parser." access="RW" offset="0x8.26" size="0x0.1" />
...
<node name="pcnr_reg_ext" descr="" size="0xc.0" >
	...
	<field name="flu_always_cap" descr="When set, indicates if flu_always is supported and configurable" access="RO" offset="0x0.2" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
	...
	<field name="flu_always" descr="valid only if flu_always_cap is set\;0: device_default_behavior\;1: enable_fast_linkup_always\;2: disable_fast_linkup\;\;When enabled, fast linkup attempt will always be performed. On fast linkup failure, regular linkup flow will be performed." access="RW" offset="0x4.4" size="0x0.2" />
</node>
...
<node name="pddr_c2p_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="core_to_phy_link_nvlink_enabled" descr="NVLink protocols admin state\;see: Table  1714, &quot;PTYS - Extended Protocol NVLink - admin layout,&quot; on page  1975" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_cable_cap_nvlink_ext" descr="" size="0x4.0" >
	<field name="cable_nvlink_proto_cap" descr="Cable NVLink protocols cap:\;See: Table  1712, &quot;PTYS - Extended Protocol NVLink - cap/oper layout,&quot; on page  1974" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_link_active_nvlink_ext" descr="" size="0x4.0" >
	<field name="link_nvlink_active" descr="NVLink protocols active\;See: Table  1712, &quot;PTYS - Extended Protocol NVLink - cap/oper layout,&quot; on page  1974" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_module_info_ext" descr="" size="0xd0.0" >
	...
	<field name="els_oper_state" descr="Indicates the ELS operative state. 3 bits per lane:\;0: ELS_module_ready\;1: Restriction_mode\;2: full_power_mode\;3: full_power_ramping_up_mode\;4: full_power_ramping_down_mode\;5: undefined_state" access="RO" enum="ELS_module_ready=0x0,Restriction_mode=0x1,full_power_mode=0x2,full_power_ramping_up_mode=0x3,full_power_ramping_down_mode=0x4,undefined_state=0x5" offset="0xC4.21" size="0x0.3" />
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table  1974, &quot;PDDR - Phy Manager Link Enabled IB layout,&quot; on page  2288\;For Ethernet: Table  1976, &quot;PDDR - Phy Manager Link Enabled Eth layout,&quot; on page  2289\;For NVLink: Table  1978, &quot;PDDR - Phy Manager Link Enable NVLink layout,&quot; on page  2289" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table  1980, &quot;PDDR - Core2phy Link Enabled IB layout,&quot; on page  2290\;For Ethernet: Table  1982, &quot;PDDR - Core2phy Link Enabled Eth layout,&quot; on page  2291\;For NVLink: Table  1984, &quot;PDDR - Core2phy Link Enabled NVLink layout,&quot; on page  2291" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="cable_proto_cap" descr="For IB: Table  1986, &quot;PDDR - Cable Cap IB layout,&quot; on page  2292\;For Ethernet: Table  1988, &quot;PDDR - Cable Cap Eth layout,&quot; on page  2293\;For NVLink: Table  1990, &quot;PDDR - Cable Cap NVLink layout,&quot; on page  2293" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="link_active" descr="For IB: Table  1992, &quot;PDDR - Link Active IB layout,&quot; on page  2294\;For Ethernet: Table  1994, &quot;PDDR - Link Active Eth layout,&quot; on page  2294\;For NVLink: Table  1996, &quot;PDDR - Link Active NVLink layout,&quot; on page  2295" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="pd_link_enabled" descr="For IB: Table  1998, &quot;PDDR - Parallel Detect Link Enabled IB Layout,&quot; on page  2296\;For Ethernet: Table  2000, &quot;PDDR - Parallel Detect Link Enabled Eth Layout,&quot; on page  2296" subnode="pddr_operation_info_page_pd_link_enabled_auto_ext" access="RO" offset="0x24.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="phy_hst_link_enabled" descr="For IB: Table  2002, &quot;PDDR - HST Link Enabled IB Layout,&quot; on page  2297\;For Ethernet: Table  2004, &quot;PDDR - HST Link Enabled Eth Layout,&quot; on page  2298" subnode="pddr_operation_info_page_phy_hst_link_enabled_auto_ext" access="RO" offset="0x28.0" size="0x4.0" union_selector="$(parent).proto_active" />
	<field name="eth_an_link_enabled" descr="Table  2006, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page  2298" access="RO" offset="0x2C.0" size="0x4.0" />
</node>
...
<node name="pddr_phy_manager_link_enabled_nvlink_ext" descr="" size="0x4.0" >
	<field name="phy_manager_link_nvlink_enabled" descr="NVLink protocols admin state: \;see: Table  1714, &quot;PTYS - Extended Protocol NVLink - admin layout,&quot; on page  1975" access="RO" offset="0x0.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table  1972, &quot;Operation Info Page Layout,&quot; on page  2279\;Table  2016, &quot;Troubleshooting info Page layout,&quot; on page  2334\;Table  2008, &quot;Phy Info Page Layout,&quot; on page  2299\;Table  2014, &quot;Module Info Page Layout,&quot; on page  2319\;Table  2010, &quot;Link Down Info Page Layout,&quot; on page  2314\;Table  2026, &quot;Link Up Info Page Layout,&quot; on page  2348\;Table  2028, &quot;Module Latched Flag Info Page Layout,&quot; on page  2352\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>

<node name="pddr_reg_page_data_auto_ext" descr="" attr_is_union="1" size="0xf8.0" >
	<field name="module_latched_flag_info_ext" descr="" subnode="module_latched_flag_info_ext" offset="0x0.0" selected_by="Module_latched_flag_info_page" size="0x68.0" />
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table  2018, &quot;PDDR - Monitor opcodes layout,&quot; on page  2335" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="module_ind_type" descr="Module index type selector:\;0: CPO_or_pluggable_modules\;1: OE\;2: ELS\;" access="INDEX" offset="0x0.24" size="0x0.2" />
	<field name="page_select" descr="The user can select to read a sampled data page or a properties page.\;\;1: SNR_Samples\;8: Laser_Source_Module_Advanced_Samples\;24: Laser_Source_Module_Advanced_Properties\;All other values are reserved." access="INDEX" enum="SNR_Samples=0x1,Laser_Source_Module_Advanced_Samples=0x8,Laser_Source_Module_Advanced_Properties=0x18" offset="0x4.0" size="0x0.5" />
	<field name="group_cap_mask" descr="Group capability mask:\;Bit 1: SNR" access="RO" enum="SNR=0x2" offset="0x4.16" size="0x0.16" />
	<field name="page_data" descr="Page data:\;Table  2178, &quot;SNR Samples page - Layout,&quot; on page  2519" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pfcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="device_auto_calculate" descr="Describes which functionality is controlled by the firmware when buf_ownership indicates partial software ownership.\;Bit 0: FW is responsible for updating shared buffer.\;Bit 1: FW is responsible for updating Xon/Xoff.\;\;Valid only on HCAs." access="RO" offset="0x14.24" size="0x0.8" />
</node>
...
<node name="pmdr_reg_ext" descr="" size="0x48.0" >
	...
	<field name="module_lane_mask_msb" descr="Module extension for MSB" access="RO" offset="0x3C.24" size="0x0.8" />
...
<node name="pmmp_reg_ext" descr="" size="0x40.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table  1826, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page  2121\;Table  1830, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page  2125" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table  1828, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page  2124" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="pmscr_reg_ext" descr="" size="0x48.0" >
	<field name="prm_index" descr="Register to get / set the local port mask configurations\;0: PREI" access="INDEX" enum="PREI=0x0" offset="0x0.0" size="0x0.4" />
	<field name="prm_support" descr="Bitmask of the register that supports the multiple port set configuration.\;Bit 0: PREI\;\;Note that if the selected register index is not supported, a bad status will be returned." access="RO" enum="PREI=0x1" offset="0x0.8" size="0x0.8" />
...
<node name="ppcnt_recovery_counters_ext" descr="" size="0xf4.0" >
	...
	<field name="time_in_last_host_logical_recovery" descr="Time of each of the recovery types from last recovery flow event." access="RO" offset="0xC.0" size="0x4.0" />
	<field name="time_in_last_host_serdes_feq_recovery" descr="Time of each of the recovery types from last recovery flow event." access="RO" offset="0x10.0" size="0x4.0" />
	<field name="time_in_last_module_tx_disable_recovery" descr="Time of each of the recovery types from last recovery flow event." access="RO" offset="0x14.0" size="0x4.0" />
	<field name="time_in_last_module_datapath_full_toggle_recovery" descr="Time of each of the recovery types from last recovery flow event." access="RO" offset="0x18.0" size="0x4.0" />
	<field name="total_time_in_host_logical_recovery" descr="Total time of each of the recovery types from all of the recovery flows that happened." access="RO" offset="0x1C.0" size="0x4.0" />
	<field name="total_time_in_host_serdes_feq_recovery" descr="Total time of each of the recovery types from all of the recovery flows that happened." access="RO" offset="0x20.0" size="0x4.0" />
	<field name="total_time_in_module_tx_disable_recovery" descr="Total time of each of the recovery types from all of the recovery flows that happened." access="RO" offset="0x24.0" size="0x4.0" />
	<field name="total_time_in_module_datapath_full_toggle_recovery" descr="Total time of each of the recovery types from all of the recovery flows that happened." access="RO" offset="0x28.0" size="0x4.0" />
	<field name="host_logical_recovery_count" descr="Counter of the total times each recovery type flow happened." access="RO" offset="0x2C.0" size="0x4.0" />
	<field name="host_serdes_feq_recovery_count" descr="Counter of the total times each recovery type flow happened." access="RO" offset="0x30.0" size="0x4.0" />
	<field name="module_tx_disable_recovery_count" descr="Counter of the total times each recovery type flow happened." access="RO" offset="0x34.0" size="0x4.0" />
	<field name="module_datapath_full_toggle_recovery_count" descr="Counter of the total times each recovery type flow happened." access="RO" offset="0x38.0" size="0x4.0" />
	<field name="host_logical_succesful_recovery_count" descr="Counter of the total times each recovery type flow happened and succeeded to recover." access="RO" offset="0x3C.0" size="0x4.0" />
	<field name="host_serdes_feq_succesful_recovery_count" descr="Counter of the total times each recovery type flow happened and succeeded to recover." access="RO" offset="0x40.0" size="0x4.0" />
	<field name="module_tx_disable_succesful_recovery_count" descr="Counter of the total times each recovery type flow happened and succeeded to recover." access="RO" offset="0x44.0" size="0x4.0" />
	<field name="module_datapath_full_toggle_succesful_recovery_count" descr="Counter of the total times each recovery type flow happened and succeeded to recover." access="RO" offset="0x48.0" size="0x4.0" />
	<field name="time_since_last_recovery" descr="Time since last successful recovery\;1 sec granularity." access="RO" offset="0x4C.0" size="0x4.0" />
</node>
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table  1722, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page  1988\;Table  1724, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page  1992\;Table  1726, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page  1995\;Table  1728, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page  2000\;Table  1730, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page  2004\;Table  1733, &quot;Ethernet Discard Counter Group Fields,&quot; on page  2009\;Table  1734, &quot;Ethernet Per Priority Group Data Layout,&quot; on page  2011\;Table  1738, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page  2019\;Table  1750, &quot;Physical Layer Counters Data Layout,&quot; on page  2030\;Table  1740, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page  2020\;Table  1754, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page  2039\;Table  1746, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page  2024\;Table  1748, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page  2026\;Table  1756, &quot;PLR Counters Data Layout,&quot; on page  2045 \;Table  1758, &quot;RS-Histograms Data Layout,&quot; on page  2047\;Table  1762, &quot;InfiniBand Packets Counters Data Layout,&quot; on page  2049\;Table  1764, &quot;InfiniBand General Counters Data Layout,&quot; on page  2052\;Table  1782, &quot;Physical Layer Recovery Counters Group Data Layout,&quot; on page  2084" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x5c.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table  2064, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page  2421" subnode="pphcr_bin_range_ext" access="RW" high_bound="18" low_bound="0" offset="0x10.0" size="0x4c.0" />
</node>

<node name="pplm_reg_ext" descr="" size="0x78.0" >
	...
	<field name="nvlink_fec_override_admin_nvl_phy6" descr="XDR FEC override admin bitmask (one-hot setting):\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RW" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x50.0" size="0x0.16" />
	<field name="nvlink_fec_override_cap_nvl_phy6" descr="NVLink-PHY6FEC override capability bitmask:\;Bit 5: RS_FEC_546_516_plus_PLR_Quad_FEC_Engine\;Bit 8: RS_FEC_546_516_plus_PLR_Octet_FEC_Engine\;Bit 11: RS_FEC_546_516_plus_PLR_Double_FEC_Engine\;All others Reserved" access="RO" enum="RS_FEC_546_516_plus_PLR_Quad_FEC_Engine=0x20,RS_FEC_546_516_plus_PLR_Octet_FEC_Engine=0x100,RS_FEC_546_516_plus_PLR_Double_FEC_Engine=0x800" offset="0x50.16" size="0x0.16" />
...
<node name="pprm_reg_ext" descr="" size="0x50.0" >
	...
	<field name="local_port" descr="Local port number." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="recovery_types_cap" descr="Recovery types that are supported by device.\;Bit 0: host_logcic_re_lock\;Bit 1: host_serdes_feq\;Bit 2: module_tx_disable\;Bit 3: module_datapath_full_toggle" access="RO" enum="host_logcic_re_lock=0x1,host_serdes_feq=0x2,module_tx_disable=0x4,module_datapath_full_toggle=0x8" offset="0x4.0" size="0x0.8" />
	<field name="no_neg_bhvr" descr="Relevant only if ovrd_no_neg_bhvr is set to &apos;2&apos;, ignored otherwise\;In case of no negotiation happened during link up flow, defines the behavior of enabled recovery types:\;Bit 0: host_logcic_re_lock\;Bit 1: host_serdes_feq\;Bit 2-3: reserved\;\;0: Disaled\;1: Enabled" access="RW" enum="host_logcic_re_lock=0x1,host_serdes_feq=0x2,Disaled=0x0,Enabled=0x1" offset="0x4.24" size="0x0.4" />
	...
	<field name="oper_recovery" descr="Bitmask of agreed and operational recovery modes.\;Prior to negotiation and linkup value will be 0.\;Bit 0: host_logcic_re_lock\;Bit 1: host_serdes_feq\;Bit 2: module_tx_disable\;Bit 3: module_datapath_full_toggle" access="RO" enum="host_logcic_re_lock=0x1,host_serdes_feq=0x2,module_tx_disable=0x4,module_datapath_full_toggle=0x8" offset="0x18.0" size="0x0.8" />
	...
	<field name="oper_time_host_feq" descr="10ms granularity for operational timer in host FEQ recovery\;on GET operation, returns watchdog value requested" access="RO" offset="0x20.16" size="0x0.8" />
	<field name="oper_time_host_logic_re_lock" descr="1ms granularity for operational timer in host Re-lock recovery\;on GET operation, returns watchdog value requested" access="RO" offset="0x20.24" size="0x0.8" />
</node>
...
<node name="pprt_reg_ext" descr="" size="0x24.0" >
	...
	<field name="lane_rate_cap" descr="Per lane rate capability (bitmask)\;Bit 0 - 1GE (1.25 Gb/s) / Gen 1 PCIe (2.5 Gb/s)\;Bit 1 - SDR (2.5 Gb/s) / Gen 2 PCIe (5 Gb/s)\;Bit 2 - XAUI/2.5GE (3.125 Gb/s) / Gen 3 PCIe (8 Gb/s)\;Bit 3- DDR (5 Gb/s) / Gen 4 PCIe (16 Gb/s)\;Bit 4- QDR (10 Gb/s) / Gen 5 PCIe (32 Gb/s)\;Bit 5- FDR10 / 10GE/40GE (10.3125 Gb/s) / Gen 5 PCIe (64 Gb/s PAM4, 32Gbd)\;Bit 6- FDR (14.0625 Gb/s) \;Bit 7- EDR / 25GE / 50GE / 100GE (25.78125 Gb/s) \;Bit 8 - 50GE-KR4 (12.89 Gb/s) \;Bit 9 - HDR /50GE / 100GE / 200GE / 400GE (26.5625Gbd / 53.125Gb/s) \;Bit 10 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;Bit 11 - XDR (106.25Gbd / 212.5Gb/s)\;Bit 12 - Reserved\;Bit 13 - NVL_PHY6_bidir\;Bit 14 - NVL_PHY6_simplex\;Note: PCIe speeds are relevant when pnat = 3 only" access="RO" offset="0xC.16" size="0x0.16" />
	<field name="lane_rate_oper" descr="Lane rate to be used in PRBS, see lane_rate_cap:\;0 - SDR (2.5 Gb/s) / Gen 1 PCIe (2.5 Gb/s)\;1 - DDR (5 Gb/s) / Gen 2 PCIe (5 Gb/s)\;2 - QDR (10 Gb/s)\;3 - FDR10 / 10GE/4 0GE (10.3125 Gb/s) / Gen 3 PCIe (8 Gb/s)\;4 - FDR (14.0625 Gb/s) / Gen 4 PCIe (16 Gb/s)\;5 - EDR / 25GE / 50GE / 100GE (25.78125 Gb/s) / Gen 5 PCIe (32 Gb/s)\;6 - HDR /50GE / 100GE / 200GE / 400GE (26.5625Gbd / 53.125Gb/s / Gen 5 PCIe (64 Gb/s PAM4, 32Gbd)\;7 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s) \;8 - XDR (106.25Gbd / 212.5Gb/s)\;9 - reserved\;10 - 1GE (1.25 Gb/s)\;11 - XAUI/2.5GE (3.125 Gb/s)\;12 - 50GE-KR4 (12.89 Gb/s)\;13 - NVL_PHY6_bidir\;14 - NVL_PHY6_simplex\;\;Note: All lanes must be set to the same rate.\;Note: PCIe speeds are relevant when pnat = 3 only" access="RW" offset="0x10.16" size="0x0.16" />
...
<node name="pptt_reg_ext" descr="" size="0x1c.0" >
	...
	<field name="lane_rate_cap" descr="Per lane rate capability (bitmask)\;Bit 0 - 1GE (1.25 Gb/s) / Gen 1 PCIe (2.5 Gb/s)\;Bit 1 - SDR (2.5 Gb/s) / Gen 2 PCIe (5 Gb/s)\;Bit 2 - XAUI/2.5GE (3.125 Gb/s) / Gen 3 PCIe (8 Gb/s)\;Bit 3- DDR (5 Gb/s) / Gen 4 PCIe (16 Gb/s)\;Bit 4- QDR (10 Gb/s) / Gen 5 PCIe (32 Gb/s)\;Bit 5- FDR10 / 10GE/40GE (10.3125 Gb/s) / Gen 5 PCIe (64 Gb/s PAM4, 32Gbd)\;Bit 6- FDR (14.0625 Gb/s) \;Bit 7- EDR / 25GE / 50GE / 100GE (25.78125 Gb/s) \;Bit 8 - 50GE-KR4 (12.89 Gb/s) \;Bit 9 - HDR /50GE / 100GE / 200GE / 400GE (26.5625Gbd / 53.125Gb/s) \;Bit 10 - NDR /100GE / 200GE / 400GE / 800GE (53.125 Gbd / 106.25Gb/s)\;Bit 11 - XDR (106.25Gbd / 212.5Gb/s)\;Bit 12 - Reserved\;Bit 13 - NVL_PHY6_bidir\;Bit 14 - NVL_PHY6_simplex\;\;Note: PCIe speeds are relevant when pnat = 3 only\;Note: for Bidir rates the following field" access="RO" offset="0xC.16" size="0x0.16" />
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table  1800, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page  2099" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="ptasv2_7nm_ext" descr="" size="0x28.0" >
	...
	<field name="iter_time_admin" descr="requested value of The time that each iteration will use. An iteration is defined as a receiver equalizer configuration followed by a BER measurement.\;\;10 msec granularity." access="RW" offset="0x14.22" size="0x0.10" />
	...
	<field name="iter_time_oper" descr="operational value of The time that each iteration will use. An iteration is defined as a receiver equalizer configuration followed by a BER measurement.\;\;10 msec granularity." access="RO" offset="0x1C.22" size="0x0.10" />
...
<node name="ptasv2_reg_ext" descr="" size="0x30.0" >
	...
	<field name="page_data" descr="Table 1932, &quot;PTASv2 - Phy Tuning Algorithm Settings Register Layout for 7nm and 5nm,&quot; on page 2248" subnode="ptasv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x8.0" size="0x28.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table  1794, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page  2096\;Table  1796, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page  2097" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qetcr_ext" descr="" size="0x50.0" >
	...
	<field name="tc_configuration" descr="Per-tclass configuration. For details, refer to Table 1075, &quot;ETS tcN Configuration Register Layout&quot;.\;Valid TCs are: 0.. HCA_CAP.max_tc, invaild TCs are reserved." subnode="ets_ext" access="RW" high_bound="7" low_bound="0" offset="0x8.0" size="0x40.0" />
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1077, &quot;ETS Global Configuration Register Layout&quot;.\;Reserved for NICs" subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  1071, &quot;qpdpm_dscp Layout,&quot; on page  1393" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 1077, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 29.11, &quot;Resource Dump&quot;, on page 1803." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="roce_accl_reg_ext" descr="" size="0x80.0" >
	...
	<field name="roce_tx_window_field_select" descr="In Query, indicates whether roce_tx_window mode is configurable.\;In set, indicates roce_tx_window_enfield is modified." access="RW" offset="0x0.1" size="0x0.1" />
...
<node name="sbcm_ext" descr="" size="0x28.0" >
	...
	<field name="local_port" descr="Local port number\;\;\;\;" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="modi" descr="[Spectrum-6][DWIP]\;Modification descriptor.\;Applicable on Query only, reserved otherwise.\;On egress (dir=1), only buff_occupancy is valid.\;Supported from Spectrum-6." access="INDEX" offset="0x0.29" size="0x0.1" />
	<field name="snap" descr="Read the snapshot guage\;0: FREE - read free running buff_occupancy\;1: SNAP - read snapshot of the buff_occupancy\;When SBSNS.status is RELEASED then the device will NACK the command\;[Spectrum-6][DWIP] Reserved when modi=1." access="OP" offset="0x0.30" size="0x0.1" />
	...
	<field name="pool" descr="Association of the port-priority to a pool\;Range 0 .. cap_num_pool_supported - 1.\;[Spectrum-6][DWIP] When modi=1 the range is 0..cap_num_modi_pools-1." access="RW" offset="0x24.0" size="0x0.4" />
</node>

<node name="sbpr_ext" descr="" size="0x18.0" >
	<field name="pool" descr="Pool index\;Range 0 .. cap_num_pool_supported - 1.\;[Spectrum-6][DWIP] When modi=1 the range is 0..cap_num_modi_pools-1." access="INDEX" offset="0x0.0" size="0x0.4" />
	<field name="dir" descr="Direction\;0: Ingress pools\;1: Egress pools\;\;" access="INDEX" offset="0x0.24" size="0x0.2" />
	<field name="modi" descr="[Spectrum-6][DWIP]\;Modification descriptor pool.\;Applicable with dir=0 (ingress), reserved otherwise.\;Supported from Spectrum-6." access="INDEX" offset="0x0.29" size="0x0.1" />
	<field name="snap" descr="Read the snapshot guage\;0: FREE - read free running buff_occupancy\;1: SNAP - read snapshot of the buff_occupancy\;When SBSNS.status is RELEASED then the device will NACK with status = RESOURCE_NOT_AVAILABLE\;[Spectrum-6][DWIP] Reserved when modi=1.\;" access="OP" offset="0x0.30" size="0x0.1" />
	<field name="desc" descr="[Advanced]\;Descriptor buffer\;For NIC: Supported when descriptors_cap is set\;\;" access="INDEX" offset="0x0.31" size="0x0.1" />
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table  2110, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for info page,&quot; on page  2467\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table  2112, &quot;SLRED - SerDes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page  2468\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1914, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2234\;Table 1916, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 16nm,&quot; on page 2236\;Table 1918, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 7nm,&quot; on page 2238\;Table 1920, &quot;SLRG - SerDes Lane Receive Grade Register Layout for 5nm,&quot; on page 2239\;Table 1928, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2243" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="lane" descr="Logical lane number" access="INDEX" offset="0x0.8" size="0x0.4" />
	<field name="conf_mod" descr="Set configuration mode for 7nm/5nm product.\;0: tx_linear - when set, tx taps are configured from\;for 7nm\;Table  1902, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2221\;For 5nm\;Table  1906, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2226\;LUT table fields are ignored\;1: tx_lut - when set, tx taps are configured from\;Table  1904, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2222\;7nm_fir_taps page fields are ignored." access="OP" enum="tx_linear=0x0,tx_lut=0x1" offset="0x0.12" size="0x0.1" />
	...
	<field name="page_data" descr="Table  1896, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page  2218\;Table  1898, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 16nm,&quot; on page  2219\;Table  1902, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 7nm,&quot; on page  2221\;Table  1904, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for LUT 7nm,&quot; on page  2222\;Table  1906, &quot;SLTP - SerDes Lane Transmit Parameters Register Layout for 5nm,&quot; on page  2226" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table  1910, &quot;SLTPv2 - SerDes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page  2231" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>
