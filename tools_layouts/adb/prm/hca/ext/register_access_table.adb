...
<node name="MRFV_PVS_ext" descr="" size="0x4.0" >
	<field name="pvs_data_index" descr="PVS Data\;Process Sigma = -4 + 0.5 * cvb_data_index\;cvb_data_index valid values 0 .. 16\;For ArcusE\;Process Sigma &lt;-&gt; DVDD (mV)\;-4.0: 856.00\;-3.5: 847.75\;-3.0: 839.50\;-2.5: 831.25\;-2.0: 823.00\;-1.5: 814.75\;-1.0: 806.50\;-0.5: 798.25\;0 (nominal): 790.00\;0.5: 781.75\;1.0: 773.50\;1.5: 765.25\;2.0: 757.00\;2.5: 748.75\;3.0: 740.50\;3.5: 732.25\;4.0: 724.00" access="RO" offset="0x0.0" size="0x0.5" />
</node>
...
<node name="MRFV_ext" descr="" size="0x40.0" >
	<field name="fuse_id" descr="Fuse Index\;0: PVS_Values\;1: ULT\;Reserved when fm = 1" access="INDEX" enum="PVS_Values=0x0,ULT=0x1" offset="0x0.0" size="0x0.16" />
	...
	<field name="data" descr="Data\;See Table 2324, &quot;MRFV entry - PVS Layout,&quot; on page 2657\;See Table 2326, &quot;MRFV entry - ULT Layout,&quot; on page 2658\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2170, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2539" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2360, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2686\;Table 2362, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2686\;Table 2364, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2687\;Table 2366, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2687\;Table 2368, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2688\;Table 2370, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2688\;\;Table 2372, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2689" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 364, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 660 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 880." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2271, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2620" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcia_ext" descr="" size="0x94.0" >
	...
	<field name="pnv" descr="[DWIP]:\;Page Number Valid\;0: write page number\;1: don&apos;t write page number" access="OP" offset="0x0.29" size="0x0.1" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 883." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2271, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2620\;VERSION - See Table 2273, &quot;MCQI VERSION Info Layout,&quot; on page 2622\;ACTIVATION_METHOD - See Table 2277, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 2624\;LINKX_PROPERTIES - See Table 2279, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 2625\;CLOCK_SOURCE_PROPERTIES - See Table 2281, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 2627" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2275, &quot;Date-Time Layout,&quot; on page 2623" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2275, &quot;Date-Time Layout,&quot; on page 2623" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mfrl_reg_ext" descr="" size="0x8.0" >
	<field name="reset_trigger" descr="The firmware reset trigger. \;Only a single bit may be set.\;Bit 0: TRIGGER0 (live-patch, embedded CPU shut down/reset)\;Bit 3: TRIGGER3 (PCIe link toggle)\;Bit 6: TRIGGER6 (PERST)\;Other bits are reserved." access="RW" offset="0x4.0" size="0x0.8" />
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2295, &quot;Hardware Info Layout,&quot; on page 2638" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2298, &quot;Firmware Info Layout,&quot; on page 2641" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2300, &quot;Software Info Layout,&quot; on page 2643\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2304, &quot;Development Info Layout,&quot; on page 2647" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2297, &quot;Device HW Revision Descriptions,&quot; on page 2640" access="RO" offset="0x0.16" size="0x0.16" />
	...
	<field name="ga" descr="[DWIP]\;Geographical Address\;0: ASIC 0\;1: ASIC 1\;2: ASIC 2\;3: ASIC 3\;Valid for multi ASIC platforms only" access="RO" offset="0x10.16" size="0x0.2" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  883\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2162, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2534" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2358, &quot;Configuration Item Header Layout,&quot; on page 2682)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2360, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2686\;Table 2362, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2686\;Table 2364, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2687\;Table 2366, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2687\;Table 2368, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2688\;Table 2370, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2688\;\;Table 2372, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2689" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 20, &quot;PCIe Performance Counters Data Layout,&quot; on page 255" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x20.0" >
	<field name="error_type" descr="Error type selector.\;See at Table 38, &quot;MPEINJ error list and params,&quot; on page 272 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table 38, &quot;MPEINJ error list and params,&quot; on page 272.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_params_0" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 272." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 272." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 272." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table 38, &quot;MPEINJ error list and params,&quot; on page 272." access="RW" offset="0x1C.0" size="0x4.0" />
</node>
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 25.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1606\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1457, &quot;DPA_CAP Capability Layout,&quot; on page 1736" access="RW" high_bound="27" low_bound="0" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="paos_reg_ext" descr="" size="0x10.0" >
	...
	<field name="lock_mode" descr="When port is forced down, indicates the lock mode of the port.\;\;Bit 0: Force_down_by_fuse\;Bit 1: Force_down_by_hard_wire\;Bit 2: Force_down_by_config\;Bit 3: Locked_after_down\;Bit 4: Locked_by_system\;\;Note - value of 0x0 indicates not locked\;[internal] - \;GPU supports bits 0-3\;QM3 - supports bits 2,3\;" access="RO" enum="Force_down_by_fuse=0x1,Force_down_by_hard_wire=0x2,Force_down_by_config=0x4,Locked_after_down=0x8,Locked_by_system=0x10" offset="0x8.24" size="0x0.6" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="shared_headroom_pool" descr="Configuring shared haeadroom pool parameters. Using the same layout as in BufferX, for details see Table 1959, &quot;bufferX Register Layout,&quot; on page 2325.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit)." subnode="uint64" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX, for details see Table 1959, &quot;bufferX Register Layout,&quot; on page 2325.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM." subnode="uint64" access="RW" offset="0x64.0" size="0x8.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table 1722, &quot;PDDR - Phy manager link enabled IB layout,&quot; on page 2048\;For Ethernet: Table 1724, &quot;PDDR - Phy manager link enabled Eth layout,&quot; on page 2048\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table 1726, &quot;PDDR - core2phy link enabled IB layout,&quot; on page 2049\;For Ethernet: Table 1728, &quot;PDDR - Core2Phy link enabled Eth layout,&quot; on page 2050" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table 1730, &quot;PDDR - cable cap IB layout,&quot; on page 2051\;For Ethernet: Table 1732, &quot;PDDR - cable cap Eth layout,&quot; on page 2052\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table 1734, &quot;PDDR - Link Active IB layout,&quot; on page 2053\;For Ethernet: Table 1736, &quot;PDDR - Link Active Eth layout,&quot; on page 2053" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table 1720, &quot;Operation Info Page Layout,&quot; on page 2038\;Table 1756, &quot;Troubleshooting info Page layout,&quot; on page 2090\;Table 1754, &quot;Module Info Page Layout,&quot; on page 2077\;Table 1750, &quot;Link Down Info Page layout,&quot; on page 2072\;Table 1768, &quot;Module Latched Flag Info Page Layout,&quot; on page 2108\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table 1758, &quot;PDDR - Monitor opcodes layout,&quot; on page 2091" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table 1906, &quot;SNR Samples page - Layout,&quot; on page 2254" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="phbr_ext" descr="" size="0x1c.0" >
	...
	<field name="hist_type" descr="Histogram Type.\;See Table 1971, &quot;Histogram Types,&quot; on page 2333" access="RW" offset="0x8.0" size="0x0.16" />
...
<node name="phrr_reg_ext" descr="" size="0x68.0" >
	...
	<field name="hist_id" descr="see Table  1969, &quot;PHBR - Port Histogram Binding Register Layout,&quot; on page  2332" access="INDEX" offset="0x4.0" size="0x0.8" />
...
<node name="pipg_reg_ext" descr="" size="0x8.0" >
	<field name="disable_1g_short_ipg" descr="Relevant only for SPC-1.\;" access="RW" offset="0x0.0" size="0x0.1" />
	<field name="all_lp" descr="Local Port global variable\;0: local_port index indicates a Local port number.\;1: local_port 255 indicates all ports the device." access="OP" offset="0x0.1" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local port number.\;Note:\;when all_lp=1, 255 indicates all ports on the device, and is only allowed for Set() operation.\;when all_lp=0, the index is a local port number" access="INDEX" offset="0x0.16" size="0x0.8" />
...
<node name="pmmp_reg_ext" descr="" size="0x28.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table 1588, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page 1895\;Table 1592, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page 1900" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table 1590, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page 1898" access="RW" high_bound="2" low_bound="0" offset="0x14.0" size="0xc.0" />
	...
	<field name="module_type" descr="0: passive_copper_cable\;1: active_copper_cable\;2: Liner_far_end_equlized_copper\;3: Linear_full_equlized_copper\;4: Linear_optical_module - Direct Drive\;5: active_optical_module" access="RW" offset="0x20.8" size="0x0.4" />
...
<node name="ppcnt_plr_counters_ext" descr="" size="0xf8.0" >
	...
	<field name="plr_codes_loss_high" descr="Recieved bandwidth loss due to codes retransmission. calculated in resolution of \;(plr_rcv_code_err / plr_rcv_codes) * 10^10" access="RO" offset="0x38.0" size="0x4.0" />
	<field name="plr_codes_loss_low" descr="Recieved bandwidth loss due to codes retransmission. calculated in resolution of \;(plr_rcv_code_err / plr_rcv_codes) * 10^10" access="RO" offset="0x3C.0" size="0x4.0" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1488, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page 1783\;Table 1490, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page 1788\;Table 1492, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page 1791\;Table 1494, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page 1796\;Table 1496, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page 1800\;Table 1499, &quot;Ethernet Discard Counter Group Fields,&quot; on page 1805\;Table 1500, &quot;Ethernet Per Priority Group Data Layout,&quot; on page 1807\;Table 1504, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page 1815\;Table 1516, &quot;Physical Layer Counters Data Layout,&quot; on page 1826\;Table 1506, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page 1816\;Table 1520, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page 1836\;Table 1512, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page 1820\;Table 1514, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page 1822\;Table 1522, &quot;PLR Counters Data Layout,&quot; on page 1841 \;Table 1524, &quot;RS-Histograms Data Layout,&quot; on page 1843\;Table 1526, &quot;InfiniBand Packets Counters Data Layout,&quot; on page 1844\;Table 1528, &quot;InfiniBand General Counters Data Layout,&quot; on page 1846" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1802, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 2158" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table 1556, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page 1873" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table 1550, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page 1869\;Table 1552, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page 1870" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qetcr_ext" descr="" size="0x50.0" >
	...
	<field name="tc_configuration" descr="Per-tclass configuration. For details, refer to Table 968, &quot;ETS tcN Configuration Register Layout&quot;." subnode="ets_ext" access="RW" high_bound="7" low_bound="0" offset="0x8.0" size="0x40.0" />
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 970, &quot;ETS Global Configuration Register Layout&quot;.\;Reserved for NICs" subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  964, &quot;dscp&lt;i&gt; Layout,&quot; on page  1229" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 970, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 25.10, &quot;Resource Dump&quot;, on page 1617." access="RW" offset="0x0.0" size="0x0.16" />
...
<node name="sbsr_ext" descr="" size="0xfc.0" >
	...
	<field name="shared_buffer_status" descr="Shared Buffer Properties, see Table 2067, &quot;Shared Buffer Status Fields,&quot; on page 2456\;This field is a collection of all the statuses of the requested quotas, while i=0..min{requested quotas, cap_sbsr_stat_size-1}\;The ith status refers a quota as follows;\;The occurrences of the masked ingress quotas are written before the masked egress quotas.\;All the occurrences associated to port are written together from the smallest masked port index. In each port, the occurrences of the masked priority groups/ traffic classes are written from the lowest to the highest." subnode="shared_buffer_status_ext" access="RO" high_bound="19" low_bound="0" offset="0x5C.0" size="0xa0.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table 1840, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for info page,&quot; on page 2200\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table 1842, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page 2202\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1668, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2001\;Table 1670, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 16nm,&quot; on page 2002\;Table 1672, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 7nm and 5nm,&quot; on page 2004" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).version" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table 1652, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page 1988\;Table 1654, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 16nm,&quot; on page 1989\;Table 1658, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 7nm,&quot; on page 1991\;" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
