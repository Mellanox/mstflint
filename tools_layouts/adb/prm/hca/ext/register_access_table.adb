...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2483, &quot;MRFV entry - CVB Layout,&quot; on page 2832\;See Table 2485, &quot;MRFV entry - ULT Layout,&quot; on page 2833\;See Table 2487, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 2834\;See Table 2489, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 2835\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2295, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2680" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="PBWS_reg_ext" descr="" size="0x8.0" >
	...
	<field name="plane_ind" descr="Reserved for a non-planarized port.\;Plane port index of the aggregated port. A value of 0 refers to the aggregated port only." access="INDEX" offset="0x4.12" size="0x0.4" />
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2525, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2866\;Table 2527, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2866\;Table 2529, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2867\;Table 2531, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2867\;Table 2533, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2868\;Table 2535, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2868\;\;Table 2537, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2869" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 348, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 652 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 908." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2426, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2789" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 911." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2426, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2789\;VERSION - See Table 2428, &quot;MCQI VERSION Info Layout,&quot; on page 2791\;ACTIVATION_METHOD - See Table 2432, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 2793\;LINKX_PROPERTIES - See Table 2434, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 2794\;CLOCK_SOURCE_PROPERTIES - See Table 2436, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 2796" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2430, &quot;Date-Time Layout,&quot; on page 2792" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2430, &quot;Date-Time Layout,&quot; on page 2792" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2450, &quot;Hardware Info Layout,&quot; on page 2809" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2453, &quot;Firmware Info Layout,&quot; on page 2812" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2455, &quot;Software Info Layout,&quot; on page 2815\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2459, &quot;Development Info Layout,&quot; on page 2819" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2452, &quot;Device HW Revision Descriptions,&quot; on page 2811" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  911\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2283, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2673" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2523, &quot;Configuration Item Header Layout,&quot; on page 2862)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2525, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2866\;Table 2527, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2866\;Table 2529, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2867\;Table 2531, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2867\;Table 2533, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2868\;Table 2535, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2868\;\;Table 2537, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2869" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 570, &quot;PCIe Performance Counters Data Layout,&quot; on page 886\;Table 576, &quot;PCIE Physical Layer Indication Layout,&quot; on page 892" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x20.0" >
	<field name="error_type" descr="Error type selector.\;See at Table 588, &quot;MPEINJ Error List and Params,&quot; on page 903 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 903.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_params_0" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 903." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 903." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 903." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 903." access="RW" offset="0x1C.0" size="0x4.0" />
</node>
...
<node name="mroq_ext" descr="" size="0x20.0" >
	...
	<field name="reset_type" descr="Query chip reset type\;0: Full chip reset\;1: Keep network port active during reset\;2: NIC only reset (for SoC devices)\;3: ARM only reset\;4: ARM OS shut down\;5: Network reset - Keep PCIe active during reset. Relevant for CX8 onward" access="INDEX" offset="0x0.8" size="0x0.8" />
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 26.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1695\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1554, &quot;DPA_CAP Capability Layout,&quot; on page 1861" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="shared_headroom_pool" descr="Configuring shared haeadroom pool parameters. Using the same layout as in BufferX, for details see Table 2064, &quot;bufferX Register Layout,&quot; on page 2466.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit)." subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX, for details see Table 2064, &quot;bufferX Register Layout,&quot; on page 2466.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM." subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table 1815, &quot;PDDR - Phy manager link enabled IB layout,&quot; on page 2172\;For Ethernet: Table 1817, &quot;PDDR - Phy manager link enabled Eth layout,&quot; on page 2172\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table 1819, &quot;PDDR - core2phy link enabled IB layout,&quot; on page 2173\;For Ethernet: Table 1821, &quot;PDDR - Core2Phy link enabled Eth layout,&quot; on page 2174" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table 1823, &quot;PDDR - cable cap IB layout,&quot; on page 2175\;For Ethernet: Table 1825, &quot;PDDR - cable cap Eth layout,&quot; on page 2176\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table 1827, &quot;PDDR - Link Active IB layout,&quot; on page 2177\;For Ethernet: Table 1829, &quot;PDDR - Link Active Eth layout,&quot; on page 2177" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="eth_an_link_enabled" descr="For IB: Table 1839, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page 2180" access="RO" offset="0x2C.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table 1813, &quot;Operation Info Page Layout,&quot; on page 2163\;Table 1849, &quot;Troubleshooting info Page layout,&quot; on page 2215\;Table 1841, &quot;Phy Info Page Layout,&quot; on page 2181\;Table 1847, &quot;Module Info Page Layout,&quot; on page 2202\;Table 1843, &quot;Link Down Info Page layout,&quot; on page 2196\;Table 1861, &quot;Module Latched Flag Info Page Layout,&quot; on page 2233\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table 1851, &quot;PDDR - Monitor opcodes layout,&quot; on page 2216" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table 2001, &quot;SNR Samples page - Layout,&quot; on page 2393" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table 1673, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page 2013\;Table 1677, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page 2018" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table 1675, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page 2016" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1585, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page 1906\;Table 1587, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page 1911\;Table 1589, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page 1914\;Table 1591, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page 1919\;Table 1593, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page 1923\;Table 1596, &quot;Ethernet Discard Counter Group Fields,&quot; on page 1928\;Table 1597, &quot;Ethernet Per Priority Group Data Layout,&quot; on page 1930\;Table 1601, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page 1938\;Table 1613, &quot;Physical Layer Counters Data Layout,&quot; on page 1949\;Table 1603, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page 1939\;Table 1617, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page 1959\;Table 1609, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page 1943\;Table 1611, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page 1945\;Table 1619, &quot;PLR Counters Data Layout,&quot; on page 1964 \;Table 1621, &quot;RS-Histograms Data Layout,&quot; on page 1966\;Table 1623, &quot;InfiniBand Packets Counters Data Layout,&quot; on page 1967\;Table 1625, &quot;InfiniBand General Counters Data Layout,&quot; on page 1970" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1897, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 2294" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table 1651, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page 1999" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table 1645, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page 1995\;Table 1647, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page 1996" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qetcr_ext" descr="" size="0x50.0" >
	...
	<field name="tc_configuration" descr="Per-tclass configuration. For details, refer to Table 989, &quot;ETS tcN Configuration Register Layout&quot;." subnode="ets_ext" access="RW" high_bound="7" low_bound="0" offset="0x8.0" size="0x40.0" />
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 991, &quot;ETS Global Configuration Register Layout&quot;.\;Reserved for NICs" subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  985, &quot;qpdpm_dscp Layout,&quot; on page  1301" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 991, &quot;ETS Global Configuration Register Layout&quot;.\;On get, the actual returned values can differ from the set values." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 26.11, &quot;Resource Dump&quot;, on page 1736." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sbsr_ext" descr="" size="0xfc.0" >
	...
	<field name="shared_buffer_status" descr="Shared Buffer Properties, see Table 2188, &quot;Shared Buffer Status Fields,&quot; on page 2595\;This field is a collection of all the statuses of the requested quotas, while i=0..min{requested quotas, cap_sbsr_stat_size-1}\;The ith status refers a quota as follows;\;The occurrences of the masked ingress quotas are written before the masked egress quotas.\;All the occurrences associated to port are written together from the smallest masked port index. In each port, the occurrences of the masked priority groups/ traffic classes are written from the lowest to the highest." subnode="shared_buffer_status_ext" access="RO" high_bound="19" low_bound="0" offset="0x5C.0" size="0xa0.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table 1935, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for info page,&quot; on page 2338\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table 1937, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page 2340\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1757, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2120\;Table 1759, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 16nm,&quot; on page 2122\;Table 1761, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 7nm,&quot; on page 2124\;Table 1763, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 5nm,&quot; on page 2125\;Table 1771, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2129" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table 1739, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page 2105\;Table 1741, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 16nm,&quot; on page 2106\;Table 1745, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 7nm,&quot; on page 2108\;Table 1749, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 5nm,&quot; on page 2113" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table 1753, &quot;SLTPv2 - Serdes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page 2118" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>
