...
<node name="MRFV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2473, &quot;MRFV entry - CVB Layout,&quot; on page 2833\;See Table 2475, &quot;MRFV entry - ULT Layout,&quot; on page 2834\;See Table 2477, &quot;MRFV entry - PVS_MAIN Layout,&quot; on page 2835\;See Table 2479, &quot;MRFV entry - PVS_Tile Layout,&quot; on page 2836\;Reserved when fm = 1" subnode="MRFV_data_auto_ext" access="RO" offset="0x10.0" size="0xc.0" union_selector="$(parent).fuse_id" />
</node>
...
<node name="MRSV_ext" descr="" size="0x40.0" >
	...
	<field name="data" descr="Data\;See Table 2283, &quot;MRSV entry - BF-3 Straps Layout,&quot; on page 2683" subnode="MRSV_data_auto_ext" access="RO" offset="0x10.0" size="0x20.0" union_selector="$(parent).ssid" />
</node>
...
<node name="config_item_ext" descr="" size="0xc.0" >
	...
	<field name="type" descr="Configuration item index according to its type_class. \;Table 2515, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2866\;Table 2517, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2866\;Table 2519, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2867\;Table 2521, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2867\;Table 2523, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2868\;Table 2525, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2868\;\;Table 2527, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2869" subnode="config_item_type_auto_ext" access="INDEX" offset="0x4.0" size="0x4.0" />
</node>
...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 348, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 648 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 904." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcda_reg_ext" descr="" size="0x90.0" >
	...
	<field name="offset" descr="Offset of accessed address relative to component start. Accesses must be in accordance to log_mcda_word_size in Table 2414, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2790" access="RW" offset="0x4.0" size="0x4.0" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 907." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mcqi_reg_ext" descr="" size="0x94.0" >
	...
	<field name="data" descr="Properties set structure according to info_type.\;CAPABILITIES - See Table 2414, &quot;MCQI CAPABILITIES Info Layout,&quot; on page 2790\;VERSION - See Table 2416, &quot;MCQI VERSION Info Layout,&quot; on page 2792\;ACTIVATION_METHOD - See Table 2420, &quot;MCQI ACTIVATION_METHOD Info Layout,&quot; on page 2794\;LINKX_PROPERTIES - See Table 2422, &quot;MCQI LINKX_PROPERTIES Info Layout,&quot; on page 2795\;CLOCK_SOURCE_PROPERTIES - See Table 2424, &quot;MCQI CLOCK_SOURCE_PROPERTIES Layout,&quot; on page 2797" subnode="mcqi_reg_data_auto_ext" access="RO" offset="0x18.0" size="0x7c.0" union_selector="$(parent).info_type" />
</node>
...
<node name="mcqi_version_ext" descr="" size="0x7c.0" >
	...
	<field name="build_time" descr="Time of component creation. Valid only if build_time_valid is set. See Table 2418, &quot;Date-Time Layout,&quot; on page 2793" subnode="date_time_layout_ext" access="RW" offset="0x8.0" size="0x8.0" />
	<field name="user_defined_time" descr="User-defined time assigned to the component version. Valid only if user_defined_time_valid is set. See Table 2418, &quot;Date-Time Layout,&quot; on page 2793" subnode="date_time_layout_ext" access="RW" offset="0x10.0" size="0x8.0" />
...
<node name="mfrl_reg_ext" descr="" size="0x8.0" >
	...
	<field name="pci_switch_exist" descr="[DWIP]:\;Pcie topology has Pcie switch." access="RO" offset="0x4.20" size="0x0.1" />
	<field name="pci_reset_req_method" descr="FW reset Method selector; Support for the different reset methods exposed through reset_info register. \;0: Link Disable \;1: Hot reset (SBR) \;2: DPC \;This method is valid only for reset_trigger equal to TRIGGER3 (PCIe link toggle) \;3-7: reserved ." access="WO" offset="0x4.21" size="0x0.3" />
...
<node name="mfsv_reg_ext" descr="" size="0x30.0" >
	...
	<field name="fuse_failure" descr="0:N/A - No info about fuse failure\;1: No failure\;2: Failure identified\;3: Reserved" access="RO" offset="0x0.8" size="0x0.2" />
...
<node name="mgir_ext" descr="" size="0xa0.0" >
	<field name="hw_info" descr="Hardware Information, see Table 2438, &quot;Hardware Info Layout,&quot; on page 2809" subnode="mgir_hardware_info_ext" access="RW" offset="0x0.0" size="0x20.0" />
	<field name="fw_info" descr="Firmware Information, see Table 2441, &quot;Firmware Info Layout,&quot; on page 2812" subnode="mgir_fw_info_ext" access="RW" offset="0x20.0" size="0x40.0" />
	<field name="sw_info" descr="Software Information, see Table 2443, &quot;Software Info Layout,&quot; on page 2815\;This field indicates the oldest software version compatible with the current firmware" subnode="mgir_sw_info_ext" access="RW" offset="0x60.0" size="0x20.0" />
	<field name="dev_info" descr="Development Information, see Table 2447, &quot;Development Info Layout,&quot; on page 2819" subnode="mgir_dev_info_ext" access="RW" offset="0x80.0" size="0x1c.0" />
</node>
...
<node name="mgir_hardware_info_ext" descr="" size="0x20.0" >
	...
	<field name="device_hw_revision" descr="See Table 2440, &quot;Device HW Revision Descriptions,&quot; on page 2811" access="RO" offset="0x0.16" size="0x0.16" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section  10.3.7, &quot;Error Handling,&quot; on page  907\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mjtag_ext" descr="" size="0x30.0" >
	...
	<field name="jtag_transaction_set" descr="See Table 2271, &quot;JTAG Transaction Set Byte Layout,&quot; on page 2676" access="RW" high_bound="43" low_bound="0" offset="0x4.24" size="0x2c.0" />
</node>
...
<node name="mnvia_reg_ext" descr="" size="0x8.0" >
	...
	<field name="writer_id" descr="The entity which perform the invalidate.\;The encoding same as writer_id in Configuration Item register (See Table 2513, &quot;Configuration Item Header Layout,&quot; on page 2862)." access="RW" offset="0x0.4" size="0x0.5" />
</node>

<node name="mnvqc_reg_ext" descr="" size="0x8.0" >
	<field name="type" descr="Configuration item type according to its class. \;Table 2515, &quot;Configuration Item Data Type Class Global Layout,&quot; on page 2866\;Table 2517, &quot;Configuration Item Data Type Class Physical Port Layout,&quot; on page 2866\;Table 2519, &quot;Configuration Item Data Type Class Per Host-PF Layout,&quot; on page 2867\;Table 2521, &quot;Configuration Item Data Type Class Log Layout,&quot; on page 2867\;Table 2523, &quot;Configuration Item Data Type Class File Layout,&quot; on page 2868\;Table 2525, &quot;Configuration Item Data Type Class Host Layout,&quot; on page 2868\;\;Table 2527, &quot;Configuration Item Data Type Class Module Layout,&quot; on page 2869" access="INDEX" offset="0x0.0" size="0x4.0" />
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 570, &quot;PCIe Performance Counters Data Layout,&quot; on page 882\;Table 576, &quot;PCIE Physical Layer Indication Layout,&quot; on page 888" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mpeinj_reg_ext" descr="" size="0x20.0" >
	<field name="error_type" descr="Error type selector.\;See at Table 588, &quot;MPEINJ Error List and Params,&quot; on page 899 for error_index." access="RW" offset="0x0.0" size="0x0.8" />
	<field name="node" descr="the node within each depth." access="INDEX" offset="0x0.8" size="0x0.8" />
	<field name="pcie_index" descr="PCIE index number\;Reserved when access is from the host" access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="depth" descr="depth level of the DUT of some hierarchy" access="INDEX" offset="0x0.24" size="0x0.6" />
	<field name="error_duration" descr="Depending on the error type, can be either -    \;Number of packets or number of usecs to apply the error according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 899.\;For Read access, the current value is returned (how many errors/time are left to be executed), or 0 if no error is pending injection" access="RW" offset="0x4.0" size="0x0.24" />
	...
	<field name="error_params_0" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 899." access="RW" offset="0x10.0" size="0x4.0" />
	<field name="error_params_1" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 899." access="RW" offset="0x14.0" size="0x4.0" />
	<field name="error_params_2" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 899." access="RW" offset="0x18.0" size="0x4.0" />
	<field name="error_params_3" descr="Error specific parameters according to Table 588, &quot;MPEINJ Error List and Params,&quot; on page 899." access="RW" offset="0x1C.0" size="0x4.0" />
</node>
...
<node name="mroq_ext" descr="" size="0x20.0" >
	...
	<field name="pci_reset_req_method" descr="FW reset Method\;bit0: Link Disable \;bit1: Hot reset (SBR)\;bit2: DPC\;bit3-7: reserved \;Note: This field provides information when reset trigger equal to TRIGGER3 (e.g., PCIe link toggle, PCIe hot reset)" access="RO" offset="0x0.24" size="0x0.8" />
</node>
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 26.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1687\;0x0: VER_0\;0x1: VER_1\;Other values are reserved.\;Reserved in Switch" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="nic_cap_ext_reg_ext" descr="" size="0x80.0" >
	...
	<field name="cap_data" descr="Capability information according to cap_group.\;For DPA_CAP See Table 1542, &quot;DPA_CAP Capability Layout,&quot; on page 1849" subnode="nic_cap_ext_reg_cap_data_auto_ext" access="RO" offset="0x10.0" size="0x70.0" />
</node>
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="shared_headroom_pool" descr="Configuring shared haeadroom pool parameters. Using the same layout as in BufferX, for details see Table 2052, &quot;bufferX Register Layout,&quot; on page 2456.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit)." subnode="bufferx_reg_ext" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX, for details see Table 2052, &quot;bufferX Register Layout,&quot; on page 2456.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM." subnode="bufferx_reg_ext" access="RW" offset="0x64.0" size="0x8.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table 1803, &quot;PDDR - Phy manager link enabled IB layout,&quot; on page 2160\;For Ethernet: Table 1805, &quot;PDDR - Phy manager link enabled Eth layout,&quot; on page 2160\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table 1807, &quot;PDDR - core2phy link enabled IB layout,&quot; on page 2161\;For Ethernet: Table 1809, &quot;PDDR - Core2Phy link enabled Eth layout,&quot; on page 2162" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table 1811, &quot;PDDR - cable cap IB layout,&quot; on page 2163\;For Ethernet: Table 1813, &quot;PDDR - cable cap Eth layout,&quot; on page 2164\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table 1815, &quot;PDDR - Link Active IB layout,&quot; on page 2165\;For Ethernet: Table 1817, &quot;PDDR - Link Active Eth layout,&quot; on page 2165" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" union_selector="$(parent).proto_active" />
	...
	<field name="eth_an_link_enabled" descr="For IB: Table 1827, &quot;PDDR - ETH AN Link Enabled Eth Layout,&quot; on page 2168" access="RO" offset="0x2C.0" size="0x4.0" />
</node>
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table 1801, &quot;Operation Info Page Layout,&quot; on page 2151\;Table 1837, &quot;Troubleshooting info Page layout,&quot; on page 2203\;Table 1829, &quot;Phy Info Page Layout,&quot; on page 2169\;Table 1835, &quot;Module Info Page Layout,&quot; on page 2190\;Table 1831, &quot;Link Down Info Page layout,&quot; on page 2184\;Table 1849, &quot;Module Latched Flag Info Page Layout,&quot; on page 2221\;" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table 1839, &quot;PDDR - Monitor opcodes layout,&quot; on page 2204" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pemi_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Page data:\;Table 1989, &quot;SNR Samples page - Layout,&quot; on page 2382" subnode="pemi_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pmmp_reg_ext" descr="" size="0x2c.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table 1661, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page 2001\;Table 1665, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page 2006" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table 1663, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page 2004" subnode="pmmp_reg_sfp_cable_protocol_technology_auto_ext" access="RW" offset="0x14.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1573, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page 1894\;Table 1575, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page 1899\;Table 1577, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page 1902\;Table 1579, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page 1907\;Table 1581, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page 1911\;Table 1584, &quot;Ethernet Discard Counter Group Fields,&quot; on page 1916\;Table 1585, &quot;Ethernet Per Priority Group Data Layout,&quot; on page 1918\;Table 1589, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page 1926\;Table 1601, &quot;Physical Layer Counters Data Layout,&quot; on page 1937\;Table 1591, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page 1927\;Table 1605, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page 1947\;Table 1597, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page 1931\;Table 1599, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page 1933\;Table 1607, &quot;PLR Counters Data Layout,&quot; on page 1952 \;Table 1609, &quot;RS-Histograms Data Layout,&quot; on page 1954\;Table 1611, &quot;InfiniBand Packets Counters Data Layout,&quot; on page 1955\;Table 1613, &quot;InfiniBand General Counters Data Layout,&quot; on page 1958" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1885, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 2282" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table 1639, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page 1987" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table 1633, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page 1983\;Table 1635, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page 1984" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table  985, &quot;qpdpm_dscp Layout,&quot; on page  1296" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="resource_dump_ext" descr="" size="0x100.0" >
	<field name="segment_type" descr="See Section 26.10, &quot;Resource Dump&quot;, on page 1725." access="INDEX" offset="0x0.0" size="0x0.16" />
...
<node name="sbsr_ext" descr="" size="0xfc.0" >
	...
	<field name="shared_buffer_status" descr="Shared Buffer Properties, see Table 2176, &quot;Shared Buffer Status Fields,&quot; on page 2596\;This field is a collection of all the statuses of the requested quotas, while i=0..min{requested quotas, cap_sbsr_stat_size-1}\;The ith status refers a quota as follows;\;The occurrences of the masked ingress quotas are written before the masked egress quotas.\;All the occurrences associated to port are written together from the smallest masked port index. In each port, the occurrences of the masked priority groups/ traffic classes are written from the lowest to the highest." subnode="shared_buffer_status_ext" access="RO" high_bound="19" low_bound="0" offset="0x5C.0" size="0xa0.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table 1923, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for info page,&quot; on page 2326\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table 1925, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page 2328\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1745, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 2108\;Table 1747, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 16nm,&quot; on page 2110\;Table 1749, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 7nm,&quot; on page 2112\;Table 1751, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 5nm,&quot; on page 2113\;Table 1759, &quot;SLRG all lanes FOM for 5nm- Layout,&quot; on page 2117" subnode="slrg_reg_page_data_auto_ext" access="RO" condition="$(parent).all_lanes" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table 1727, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page 2093\;Table 1729, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 16nm,&quot; on page 2094\;Table 1733, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 7nm,&quot; on page 2096\;Table 1737, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 5nm,&quot; on page 2101" subnode="sltp_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x48.0" />
</node>
...
<node name="sltpv2_reg_ext" descr="" size="0x10c.0" >
	...
	<field name="status" descr="Indicates that Tx setting readout is valid and active. In particular, for links that do AN/LT, valid will be set when link operational status is UP (PAOS.oper_status=0x1).\;For links without AN/LT, valid will be set when Tx is enabled.\;\;0 - Invalid\;1 - Valid\;\;Note: Get and Set operations can be set when status = invalid." access="RO" offset="0x0.28" size="0x0.1" />
	<field name="lp_msb" descr="Local port number [9:8]" access="INDEX" offset="0x0.30" size="0x0.2" />
	<field name="page_data" descr="Table 1741, &quot;SLTPv2 - Serdes Lane Transmit Parameters v2 Register Layout for LUT 5nm,&quot; on page 2106" subnode="sltpv2_reg_page_data_auto_ext" access="RW" condition="$(parent).version" offset="0x4.0" size="0x108.0" />
</node>
