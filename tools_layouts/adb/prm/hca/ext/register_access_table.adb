...
<node name="import_kek_object_ext" descr="" size="0x100.0" >
	...
	<field name="key" descr="\;Actual size and layout of this field described in Table 353, &quot;IMPORT_KEK Field Construction Summary,&quot; on page 604 below. Note that the layout explained in following table should be used from the MSBs and on." high_bound="31" low_bound="0" offset="0x40.0" size="0x80.0" />
</node>
...
<node name="mcc_reg_ext" descr="" size="0x20.0" >
	...
	<field name="update_handle" descr="Token representing the current flow executed by the FSM.\;See Section 10.2.1, &quot;Component Update State&quot;, on page 875." access="RW" offset="0x8.0" size="0x0.24" />
...
<node name="mcqi_cap_ext" descr="" size="0x7c.0" >
	...
	<field name="rd_en" descr="When set, this components may be read, see Section 10.3.4, &quot;Read Flow&quot;, on page 878." access="RO" offset="0x10.31" size="0x0.1" />
</node>
...
<node name="mfsl_ext" descr="" size="0xc.0" >
	...
	<field name="ee" descr="Event Enable.\;0 - Do not generate event\;1 - Generate Event \;2 - Generate single event\;For Fan Error Evet details refer to Section  25.42, &quot;PPS and PTP Registers&quot;." access="RW" offset="0x0.2" size="0x0.2" />
...
<node name="mirc_reg_ext" descr="" size="0x8.0" >
	<field name="status_code" descr="Indicates the successful completion of the instruction, or the reason it failed. See Section 10.3.7, &quot;Error Handling&quot;, on page 878\;0x0: OK\;0x1: BUSY\;0x2: PROHIBITED_FW_VER_ERR\;0x3: FIRST_PAGE_COPY_FAILED\;0x4: FIRST_PAGE_ERASE_FAILED\;0x5: FIRST_PAGE_RESTORE_FAILED\;0x6: CANDIDATE_FW_DEACTIVATION_FAILED\;0x7: FW_ALREADY_ACTIVATED\;0x8: ERROR_DEVICE_RESET_REQUIRED\;0x9: ERROR_FW_PROGRAMMING_NEEDED\;Other values should be treated as an unknown error." access="RO" offset="0x0.0" size="0x0.8" />
</node>
...
<node name="mpcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1754, &quot;PCIe Performance Counters Data Layout,&quot; on page 2100" subnode="mpcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="mtrc_cap_reg_ext" descr="" size="0x84.0" >
	...
	<field name="trc_ver" descr="Indicates the version of the tracing mechanism.\;See Section 24.3.4.1, &quot;Timestamp Event Traces&quot;, on page 1373\;0x0: VER_0\;0x1: VER_1\;Other values are reserved" access="RO" offset="0x0.24" size="0x0.2" />
...
<node name="mtutc_reg_ext" descr="" size="0x1c.0" >
	<field name="operation" descr="Operation:\;\;1: SET_TIME_IMMEDIATE - reserved when Spectrum-1\;2: ADJUST_TIME\;3: ADJUST_FREQ_UTC \;[DWIP]:\;4: ADJUST_FREQ_FRC - Free Running Clock\;5: ADJUST_FREQ_BOTH" access="OP" enum="ADJUST_TIME=0x2,ADJUST_FREQ_UTC=0x3,ADJUST_FREQ_FRC=0x4,ADJUST_FREQ_BOTH=0x5" offset="0x0.0" size="0x0.4" />
...
<node name="pbmc_reg_ext" descr="" size="0x6c.0" >
	...
	<field name="shared_headroom_pool" descr="Configuring shared haeadroom pool parameters. Using the same layout as in BufferX, for details see Table 1619, &quot;bufferX Register Layout,&quot; on page 1975.\;Not supported in SwitchX and SwitchX-2\;Not supported in HCA (See PCAM shp_pbmc_pbsr_support bit)." subnode="uint64" access="RW" offset="0x5C.0" size="0x8.0" />
	<field name="port_shared_buffer" descr="Configuring port shared buffer parameters. Using the same layout as in BufferX, for details see Table 1619, &quot;bufferX Register Layout,&quot; on page 1975.\;Not supported in SwitchX and SwitchX-2\;Valid for HCA when pbmc_port_shared_buffer is set in PCAM." subnode="uint64" access="RW" offset="0x64.0" size="0x8.0" />
</node>
...
<node name="pddr_operation_info_page_ext" descr="" size="0xf8.0" >
	...
	<field name="phy_manager_link_enabled" descr="For IB: Table 1430, &quot;PDDR - Phy manager link enabled IB layout,&quot; on page 1763\;For Ethernet: Table 1432, &quot;PDDR - Phy manager link enabled Eth layout,&quot; on page 1763\;" subnode="pddr_operation_info_page_phy_manager_link_enabled_auto_ext" access="RO" offset="0x8.0" size="0x4.0" />
	<field name="core_to_phy_link_enabled" descr="For IB: Table 1434, &quot;PDDR - core2phy link enabled IB layout,&quot; on page 1764\;For Ethernet: Table 1436, &quot;PDDR - Core2Phy link enabled Eth layout,&quot; on page 1765" subnode="pddr_operation_info_page_core_to_phy_link_enabled_auto_ext" access="RO" offset="0xC.0" size="0x4.0" />
	<field name="cable_proto_cap" descr="For IB: Table 1438, &quot;PDDR - cable cap IB layout,&quot; on page 1766\;For Ethernet: Table 1440, &quot;PDDR - cable cap Eth layout,&quot; on page 1767\;" subnode="pddr_operation_info_page_cable_proto_cap_auto_ext" access="RO" offset="0x10.0" size="0x4.0" />
	<field name="link_active" descr="For IB: Table 1442, &quot;PDDR - Link Active IB layout,&quot; on page 1768\;For Ethernet: Table 1444, &quot;PDDR - Link Active Eth layout,&quot; on page 1768" subnode="pddr_operation_info_page_link_active_auto_ext" access="RO" offset="0x14.0" size="0x4.0" />
...
<node name="pddr_reg_ext" descr="" size="0x100.0" >
	...
	<field name="page_data" descr="Table 1422, &quot;Operation Info Page Layout,&quot; on page 1740\;Table 1464, &quot;Troubleshooting info Page layout,&quot; on page 1800\;Table 1462, &quot;Module Info Page Layout,&quot; on page 1787\;Table 1476, &quot;Module Latched Flag Info Page Layout,&quot; on page 1817" subnode="pddr_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).page_select" />
</node>
...
<node name="pddr_troubleshooting_page_ext" descr="" size="0xf8.0" >
	...
	<field name="status_opcode" descr="Status opcode described in:\;Table 1466, &quot;PDDR - Monitor opcodes layout,&quot; on page 1801" subnode="pddr_troubleshooting_page_status_opcode_auto_ext" access="RO" offset="0x4.0" size="0x4.0" union_selector="$(parent).group_opcode" />
...
<node name="pmmp_reg_ext" descr="" size="0x28.0" >
	...
	<field name="qsfp_cable_protocol_technology" descr="Protocol technology override for QSFP cable or CMIS based cable (QSFP-DD/OSFP)\;Valid only when the protocols and technology for QSFP is overridden as indicated by eeprom_override\;Table 1314, &quot;PMMP - QSFP Protocol Bytes Override Layout,&quot; on page 1624\;Table 1318, &quot;PMMP - CMIS Protocol Bytes Override Layout,&quot; on page 1629" subnode="pmmp_reg_qsfp_cable_protocol_technology_auto_ext" access="RW" offset="0x8.0" size="0xc.0" union_selector="$(parent).eeprom_override" />
	<field name="sfp_cable_protocol_technology" descr="Valid only when the protocols and technology is overridden as indicated by eeprom_override\;Table 1316, &quot;PMMP - SFP Protocol Bytes Override Layout,&quot; on page 1627" access="RW" high_bound="2" low_bound="0" offset="0x14.0" size="0xc.0" />
...
<node name="ppcnt_reg_ext" descr="" size="0x100.0" >
	...
	<field name="counter_set" descr="Counter set as described in\;Table 1222, &quot;Ethernet IEEE 802.3 Counters Group Data Layout,&quot; on page 1527\;Table 1224, &quot;Ethernet RFC 2863 Counter Group Data Layout,&quot; on page 1532\;Table 1226, &quot;Ethernet RFC 2819 Counter Group Data Layout,&quot; on page 1535\;Table 1228, &quot;Ethernet RFC 3635 Counter Group Data Layout,&quot; on page 1540\;Table 1230, &quot;Ethernet Extended Counter Group Data Layout,&quot; on page 1544\;Table 1233, &quot;Ethernet Discard Counter Group Fields,&quot; on page 1549\;Table 1234, &quot;Ethernet Per Priority Group Data Layout,&quot; on page 1551\;Table 1238, &quot;Ethernet Per Traffic Class Group data layout,&quot; on page 1559\;Table 1250, &quot;Physical Layer Counters Data Layout,&quot; on page 1570\;Table 1240, &quot;Ethernet Per Traffic Class Congestion Group data layout,&quot; on page 1560\;Table 1254, &quot;Physical Layer Statistical Counters Data Layout,&quot; on page 1580\;Table 1246, &quot;InfiniBand PortCounters Attribute Group Data Layout,&quot; on page 1564\;Table 1248, &quot;InfiniBand Extended PortCounters Attribute Group Data Layout,&quot; on page 1566\;Table 1256, &quot;PLR Counters Data Layout,&quot; on page 1585 \;Table 1258, &quot;RS-Histograms Data Layout,&quot; on page 1587" subnode="ppcnt_reg_counter_set_auto_ext" access="RO" offset="0x8.0" size="0xf8.0" union_selector="$(parent).grp" />
</node>
...
<node name="pphcr_ext" descr="" size="0x50.0" >
	...
	<field name="bin_range" descr="Write to bin_range[x] is applicable only if we = 1 &amp; the corresponding bits in bin_range_write_mask is set.\;Mapping of measurement units to a bin.\;See Table 1498, &quot;PPHCR - Port Phy Bin Range Histogram Configuration Layout,&quot; on page 1849" subnode="pphcr_bin_range_ext" access="RW" high_bound="15" low_bound="0" offset="0x10.0" size="0x40.0" />
</node>
...
<node name="prei_reg_ext" descr="" size="0x18.0" >
	...
	<field name="page_data" descr="Table 1282, &quot;PREI - Port Receive Error Injection Register Layout for 28nm,&quot; on page 1602" subnode="prei_reg_28nm_ext" access="RW" offset="0x10.0" size="0x8.0" />
</node>
...
<node name="pter_reg_ext" descr="" size="0x20.0" >
	...
	<field name="page_data" descr="error injection page data: \;Table 1276, &quot;PTER- Port Transmit Errors Register Phy Level Layout,&quot; on page 1598\;Table 1278, &quot;PTER- Port Transmit Errors Register Port Level Fields,&quot; on page 1599" subnode="pter_reg_page_data_auto_ext" access="RW" offset="0x4.0" size="0x1c.0" union_selector="$(parent).error_page" />
</node>
...
<node name="ptys_reg_ext" descr="" size="0x40.0" >
	...
	<field name="eth_proto_lp_valid" descr="If set, indicates that eth_proto_lp_advertise has valid advertisement" access="RO" offset="0x2C.31" size="0x0.1" />
	<field name="eth_proto_lp_advertise" descr="Ethernet port&apos;s link partner advertised protocols according to PTYS.ext_eth_proto_capability mask. Returns the protocols that were advertised by the link partner during auto-negotiation.Valid only if eth_proto_lp_valid filed is set.\;." access="RO" offset="0x30.0" size="0x4.0" />
</node>
...
<node name="qetcr_ext" descr="" size="0x50.0" >
	...
	<field name="tc_configuration" descr="Per-tclass configuration. For details, refer to Table 969, &quot;ETS tcN Configuration Register Layout&quot;." subnode="ets_ext" access="RW" high_bound="7" low_bound="0" offset="0x8.0" size="0x40.0" />
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 971, &quot;ETS Global Configuration Register Layout&quot;.\;Reserved for NICs" subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="qpdpm_ext" descr="" size="0x84.0" >
	<field name="lp_msb" descr="Local port[9:8]" access="INDEX" offset="0x0.12" size="0x0.2" />
	<field name="local_port" descr="Local Port.\;Supported for data packets from CPU port." access="INDEX" offset="0x0.16" size="0x0.8" />
	<field name="dscp" descr="DSCP entry is the DSCP to Switch Priority mapping. For more details refer to Table 965" access="RW" high_bound="63" low_bound="0" offset="0x4.16" size="0x80.0" />
</node>
...
<node name="qshr_ext" descr="" size="0x50.0" >
	...
	<field name="global_configuration" descr="Global configuration. For details, refer to Table 971, &quot;ETS Global Configuration Register Layout&quot;." subnode="ets_global_ext" access="RW" offset="0x48.0" size="0x8.0" />
</node>
...
<node name="sbdcc_ext" descr="" size="0x210.0" >
	...
	<field name="no_buffer_discard_cpu_tclass" descr="Count the number of unicast packets to CPU dropped due to lack of shared buffer resources\;For tclass i\;Range is 0.. cap_max_cpu_ingress_tclass-1\;See Table 1710, &quot;SBDCC - counter Layout,&quot; on page 2060" subnode="uint64" access="RO" high_bound="63" low_bound="0" offset="0x10.0" size="0x200.0" />
</node>
...
<node name="sbhbr_ext" descr="" size="0x1c.0" >
	...
	<field name="hist_type" descr="0x1000: Queue_Depth_Traffic_Class\;See Table 1718, &quot;SBHBR - Histograms Hist-type for queue histograms,&quot; on page 2065" access="RW" offset="0x8.0" size="0x0.16" />
	<field name="hist_parameters" descr="According to hist_type\;See Table 1718, &quot;SBHBR - Histograms Hist-type for queue histograms,&quot; on page 2065" access="RW" offset="0xC.0" size="0x4.0" />
...
<node name="sbhbr_v2_ext" descr="" size="0x1c.0" >
	...
	<field name="hist_type" descr="0x1000: Queue_Depth_Traffic_Class\;0x1002: Queue_Latency\;See Table 1718, &quot;SBHBR - Histograms Hist-type for queue histograms,&quot; on page 2065" access="INDEX" offset="0x8.0" size="0x0.16" />
...
<node name="sbhrr_v2_ext" descr="" size="0x90.0" >
	...
	<field name="bin" descr="Value of bin \;Units according to the units of the hist_type which is used for the hist_id\;Max bins is according to cap_hist_num_bins.\;Bin is saturated at (2^cap_hist_bin_size_type1-1). When any bin is saturated all bins stop incrementing.\;See Table 1729, &quot;SBHRR_V2 - Bin Layout,&quot; on page 2073" subnode="uint64" access="RO" high_bound="9" low_bound="0" offset="0x40.0" size="0x50.0" />
</node>
...
<node name="sbsr_ext" descr="" size="0xfc.0" >
	...
	<field name="shared_buffer_status" descr="Shared Buffer Properties, see Table 1705, &quot;Shared Buffer Status Fields,&quot; on page 2058\;This field is a collection of all the statuses of the requested quotas, while i=0..min{requested quotas, cap_sbsr_stat_size-1}\;The ith status refers a quota as follows;\;The occurrences of the masked ingress quotas are written before the masked egress quotas.\;All the occurrences associated to port are written together from the smallest masked port index. In each port, the occurrences of the masked priority groups/ traffic classes are written from the lowest to the highest." subnode="shared_buffer_status_ext" access="RO" high_bound="19" low_bound="0" offset="0x5C.0" size="0xa0.0" />
</node>
...
<node name="slred_reg_ext" descr="" size="0xa8.0" >
	...
	<field name="page_data" descr="page data for index page_data_sel\;page 0 will contain info page data.\;Table 1530, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for info page,&quot; on page 1883\;the page data 1-7 will contain the err_val for each index in ascending order.\;Table 1532, &quot;SLRED - Serdes Lane Receive Eye Diagram Register Layout for page_data,&quot; on page 1885\;Each err_val[i] represents the bit errors of row floor(i / width_dim)\;and column i mod width_dim.\;Matrix is built starting from the left bottom corner.\;each err_val indicates the number of bit errors for one tick" subnode="slred_reg_page_data_auto_ext" access="RO" offset="0x8.0" size="0xa0.0" />
</node>
...
<node name="slrg_reg_ext" descr="" size="0x28.0" >
	...
	<field name="status" descr="0 - Invalid\;1 - Valid\;" access="RO" offset="0x0.28" size="0x0.4" />
	<field name="page_data" descr="Table 1378, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 40nm and 28nm,&quot; on page 1708\;Table 1380, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 16nm,&quot; on page 1709\;Table 1382, &quot;SLRG - Serdes Lane Receive Grade Register Layout for 7nm,&quot; on page 1711" subnode="slrg_reg_page_data_auto_ext" access="RO" offset="0x4.0" size="0x24.0" />
</node>
...
<node name="sltp_reg_ext" descr="" size="0x4c.0" >
	...
	<field name="page_data" descr="Table 1366, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 28nm and 40nm,&quot; on page 1698\;Table 1368, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 16nm,&quot; on page 1699\;Table 1372, &quot;SLTP - Serdes Lane Transmit Parameters Register Layout for 7nm,&quot; on page 1701" subnode="sltp_reg_page_data_auto_ext" access="RO" offset="0x4.0" size="0x48.0" union_selector="$(parent).version" />
</node>
